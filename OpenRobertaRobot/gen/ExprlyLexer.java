...
public class ExprlyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "MICROBIT_STMT", 
			"EV3_STMT", "IF", "ELSEIF", "ELSE", "STEP", "WHILE", "REPEATFOR", "REPEATFOREACH", 
			"BREAK", "CONTINUE", "WAIT", "ORWAITFOR", "WAITMS", "RETURN", "PRIMITIVETYPE", 
			"NEWLINE", "WS", "FNAME", "FNAMESTMT", "CONST", "NULL", "INT", "FLOAT", 
			"COLOR", "BOOL", "HEX", "MICROBITV2_SENSORSEXPR", "MICROBITV2_SENSORSTMT", 
			"VAR", "FUNCTIONNAME", "STR", "SET", "AND", "OR", "NOT", "EQUAL", "NEQUAL", 
