...
expr         : NULL                                                      # NullConst
             ...
             | PRIMITIVETYPE NAME                                        # ParamsMethod
...
// Specific Expressions for MicrobitV2, the AST be generated in RobotsMbedTextlyVisitor
robotMicrobitv2Expr     : 'microbitv2' '.' microbitv2SensorExpr          # RobotMicrobitv2Expression;
microbitv2SensorExpr    : ACCELEROMETER_SENSOR '(' op=('x' | 'y' | 'z' | 'strength') ')'
...
// Specific Expressions for WeDo,  the AST will be generated in WedoTextlyVisitor
...
stmt:                   FNAMESTMT '(' ( expr (',' expr)* )? ')'                                                                                                                         # StmtFunc
                        ...
                        | REPEATFOR '('PRIMITIVETYPE NAME '=' expr ';' NAME '<'expr ';' (expr op=STEP |NAME '=' NAME op=(ADD | SUB) expr |NAME '=' expr)? ')' '{' statementList '}'     # RepeatFor
                        | WHILE'(' expr ')' '{' statementList '}'                                                                                                                       # RepeatStatement
                        | REPEATFOREACH '(' PRIMITIVETYPE  NAME ':' expr ')' '{' statementList '}'                                                                                      # RepeatForEach
                        ...
                        | PRIMITIVETYPE NAME '(' (expr(',' expr)*)* ')' '{' statementList (op=RETURN (NAME|expr))? '}'                                                                  # FuncUser
...
// Specific Statement for MicrobitV2, the AST will be generated in RobotsMbedTextlyVisitor
...
// Specific Statement for WeDo, the AST will be generated in WeDoTextlyVisitor
...
declaration             : PRIMITIVETYPE NAME ('=' expr)? ';'                                        # VariableDeclaration ;
