...
public class MathOnListFunct<V> extends Function<V> {
    ...
    /**
     * factory method: create read only instance from {@link MathOnListFunct}.<br>
     ...
     * @return read only object of class {@link MathOnListFunct}
     */
    public static <V> MathOnListFunct<V> make(FunctionNames name, List<Expr<V>> param) {
        return new MathOnListFunct<V>(name, param, BlocklyBlockProperties.make("1", "1"), null);
    }
     ...
     * @return read only object of class {@link MathOnListFunct}
     */
    public static <V> MathOnListFunct<V> make(String name, List<Expr<V>> param) {
        return new MathOnListFunct<V>(FunctionNames.get(name), param, BlocklyBlockProperties.make("1", "1"), null);
    }
