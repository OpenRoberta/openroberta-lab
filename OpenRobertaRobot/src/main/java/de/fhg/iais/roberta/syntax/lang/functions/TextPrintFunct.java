...
public class TextPrintFunct<V> extends Function<V> {
    ...
    /**
     * factory method: creates instance of {@link TextPrintFunct}.<br>
     ...
     * @return read only object of class {@link TextPrintFunct}
     */
    public static <V> TextPrintFunct<V> make(List<Expr<V>> param) {
        return new TextPrintFunct<V>(param, BlocklyBlockProperties.make("1", "1"), null);
    }
