...
public class C {
    ...
    public static final String NN_INPUT_NEURONS = "inputs";;
    public static final String NN_OUTPUT_NEURONS = "outputs";;
    public static final String NN_WEIGHTS = "weights";;
    public static final String NN_BIASES = "biases";;
    public static final String NN_NETWORK_SHAPE = "networkShape";;
    public static final String NN_LEARNING_RATE = "learningRate";;
    public static final String NN_REGULARIZATION_RATE = "regularizationRate";;
    public static final String NN_NOISE = "noise";;
    public static final String NN_BATCH_SIZE = "batchSize";;
    public static final String NN_DISCRETIZE = "discretize";;
    public static final String NN_PERCENT_TRAIN_DATA = "percTrainData";;
    public static final String NN_ACTIVATION_KEY = "activationKey";;
    public static final String NN_NUMBER_HIDDEN_LAYERS = "numHiddenLayers";;
