...
public final class MathCastCharFunct<V> extends Function<V> {
    ...
    public MathCastCharFunct(List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2ProgramAst<V> helper) {
        ...
        return new MathCastCharFunct<V>(params, Jaxb2Ast.extractBlockProperties(block), Jaxb2Ast.extractComment(block));
    }
