...
public final class MathCastStringFunct<V> extends Function<V> {
    public final List<Expr<V>> param;

    public MathCastStringFunct(List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2ProgramAst<V> helper) {
        ...
        return new MathCastStringFunct<V>(params, Jaxb2Ast.extractBlockProperties(block), Jaxb2Ast.extractComment(block));
    }
