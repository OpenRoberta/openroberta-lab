...
public final class ListRepeat<V> extends Function<V> {
    ...
    public ListRepeat(BlocklyType typeVar, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2ProgramAst<V> helper) {
        ...
        return new ListRepeat<V>(BlocklyType.get(filename), params, Jaxb2Ast.extractBlockProperties(block), Jaxb2Ast.extractComment(block));
    }
