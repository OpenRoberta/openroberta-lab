...
public class MathNumPropFunct<V> extends Function<V> {
    ...
    /**
     * factory method: create read only instance from {@link MathNumPropFunct}.<br>
     ...
     * @return read only object of class {@link MathNumPropFunct}
     */
    public static <V> MathNumPropFunct<V> make(FunctionNames name, List<Expr<V>> param) {
        return new MathNumPropFunct<V>(name, param, BlocklyBlockProperties.make("1", "1"), null);
    }
     ...
     * @return read only object of class {@link MathNumPropFunct}
     */
    public static <V> MathNumPropFunct<V> make(String name, List<Expr<V>> param) {
        return new MathNumPropFunct<V>(FunctionNames.get(name), param, BlocklyBlockProperties.make("1", "1"), null);
    }
