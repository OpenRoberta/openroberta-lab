...
public abstract class UsedHardwareVisitor extends CheckVisitor implements AstSensorsVisitor<Void>, AstActorMotorVisitor<Void>, AstActorDisplayVisitor<Void>,
    ...
    public UsedHardwareVisitor(Configuration brickConfiguration) {
