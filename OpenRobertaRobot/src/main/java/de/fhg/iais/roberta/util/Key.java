...
public enum Key {
    SERVER_ERROR,
    COMMAND_INVALID,
    INIT_FAIL_MULTIPLE_FRONTENDS_ONE_HTTPSESSION,
    INIT_FAIL_HTTPSESSION_EXPECTED_BUT_NOT_FOUND,
    INIT_FAIL_PING_ERROR,
    INIT_SUCCESS,
    TOKEN_SET_SUCCESS,
    ...
    COMPILERWORKFLOW_ERROR_PROGRAM_GENERATION_FAILED_WITH_PARAMETERS,
    ...
    LIKE_DELETE_SUCCESS,
    RASPBERRY_PROGRAM_UPLOAD_ERROR,
    VORWERK_PROGRAM_UPLOAD_ERROR,
