...
public enum Key {
    ...
    USER_PASSWORD_RECOVERY_GENERATE_TMP_PASSWORD_SUCCESS,
    USER_PASSWORD_RECOVERY_GENERATE_TMP_PASSWORD_USERID_ERROR,
    USER_PASSWORD_RECOVERY_GENERATE_TMP_PASSWORD_USERID_NOT_SAVED_IN_DATABASE,
