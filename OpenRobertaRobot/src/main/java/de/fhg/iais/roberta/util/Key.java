...
public enum Key {
    ...
    ROBOT_PUSH_RUN(true),
    ROBOT_PUSH_STOP_SUCCESS(true),
    ROBOT_PUSH_STOP_ERROR(false),
    ...
    CONFIGURATION_SAVE_AS_ERROR_CONFIGURATION_EXISTS(false),
    ...
    USER_ERROR_EMAIL_INVALID(false),
    ...
    USER_CREATE_SUCCESS_ACTIVATION_MAIL_FAIL(true),
