...
@NepoBasic(sampleValues = {@NepoSampleValue(blocklyFieldName = "MOTION_PRESENCE", sensor = "MOTION", mode = "PRESENCE")}, containerType = "MOTION_SENSING", category = "SENSOR", blocklyNames = {"robSensors_motion_getSample"})
