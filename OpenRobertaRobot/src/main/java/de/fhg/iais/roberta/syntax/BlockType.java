...
public enum BlockType {
    ...
    SENSOR_GET_SAMPLE(
        Category.SENSOR,
        GetSampleSensor.class,
        BlocklyConstants.ROB_SENSOR_GET_SAMPLE,
        BlocklyConstants.SIM_GET_SAMPLE,
        BlocklyConstants.ROB_SENSOR_GET_SAMPLE_ARDU ),
    ...
    MOTOR_ON_ACTION(
        ...
        BlocklyConstants.ROB_ACTIONS_MOTOR_ON_FOR_ARDU,
