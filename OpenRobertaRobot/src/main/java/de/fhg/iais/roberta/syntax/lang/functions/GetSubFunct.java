...
/**
 * This class represents the <b>text_getSubstring</b> and <b>lists_getSublist</b> blocks from Blockly into the AST (abstract syntax tree).<br>
 * <br>
...
public class GetSubFunct<V> extends Function<V> {
    ...
    public static <V> GetSubFunct<V> make(FunctionNames name, List<IMode> strParam, List<Expr<V>> param) {
        return new GetSubFunct<V>(name, strParam, param, BlocklyBlockProperties.make("1", "1"), null);
    }
