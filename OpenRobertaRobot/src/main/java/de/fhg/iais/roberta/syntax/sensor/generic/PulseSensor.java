...
@NepoBasic(sampleValues = {@NepoSampleValue(blocklyFieldName = "PULSE_VALUE", sensor = "PULSE", mode = "VALUE")}, containerType = "PULSE_SENSING", category = "SENSOR", blocklyNames = {"robSensors_pulse_getSample"})
