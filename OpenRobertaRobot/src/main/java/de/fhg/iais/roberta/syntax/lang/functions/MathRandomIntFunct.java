...
public final class MathRandomIntFunct<V> extends Function<V> {
    ...
    public MathRandomIntFunct(List<Expr<V>> param, BlocklyProperties properties) {
        super(properties);
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2ProgramAst<V> helper) {
        ...
        return new MathRandomIntFunct<V>(params, Jaxb2Ast.extractBlocklyProperties(block));
    }
