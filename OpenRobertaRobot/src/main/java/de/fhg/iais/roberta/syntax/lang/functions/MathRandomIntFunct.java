...
public class MathRandomIntFunct<V> extends Function<V> {
    ...
    /**
     * factory method: creates instance of {@link MathRandomIntFunct}.<br>
     ...
     * @return read only object of class {@link MathRandomIntFunct}
     */
    public static <V> MathRandomIntFunct<V> make(List<Expr<V>> param) {
        return new MathRandomIntFunct<V>(param, BlocklyBlockProperties.make("1", "1"), null);
    }
