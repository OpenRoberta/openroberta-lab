...
public class BluetoothCheckConnectAction<V> extends Action<V> {
    ...
    /**
     * factory method: create an AST instance of {@link BluetoothCheckConnectAction}.<br>
     ...
     * @return read only object of class {@link BluetoothCheckConnectAction}
     */
    public static <V> BluetoothCheckConnectAction<V> make(Expr<V> _connection) {
        return new BluetoothCheckConnectAction<V>(_connection, BlocklyBlockProperties.make("1", "1"), null);
    }
