...
public abstract class TypecheckCommonLanguageVisitor extends BaseVisitor<BlocklyType> {
    ...
    public BlocklyType visitStmtExprExprly(StmtExprExprly stmtEvalExpr) {
        BlocklyType expectedType = stmtEvalExpr.getBlocklyType();
        Sig.of(expectedType, expectedType).typeCheckPhrases(stmtEvalExpr, this, stmtEvalExpr.exprAsBlock);
        stmtEvalExpr.elevateNepoInfos();
        return expectedType;
    }
    ...
    public BlocklyType visitAssignStmt(AssignStmt assignStmt) {
        ...
        return Sig.of(BlocklyType.VOID, lhs).typeCheckPhrases(assignStmt, this, assignStmt.expr);
    }
    ...
    public BlocklyType visitGetSubFunct(GetSubFunct getSubFunct) {
        return getSubFunct.functName.signature.typeCheckPhraseList(getSubFunct, this, getSubFunct.param);
    }
    ...
    public BlocklyType visitIndexOfFunct(IndexOfFunct indexOfFunct) {
        return FunctionNames.INDEXOF.signature.typeCheckPhrases(indexOfFunct, this, indexOfFunct.value, indexOfFunct.find);
    }
        ...
        switch ( listGetIndex.mode ) {
            ...
            case GET_REMOVE:
                if ( listGetIndex.location == IndexLocation.FIRST || listGetIndex.location == IndexLocation.LAST ) {
                    return FunctionNames.GETFIRST.signature.typeCheckPhraseList(listGetIndex, this, listGetIndex.param);
                } else {
                    return FunctionNames.GETLISTELEMENT.signature.typeCheckPhraseList(listGetIndex, this, listGetIndex.param);
                }
            case REMOVE:
                if ( listGetIndex.location == IndexLocation.FIRST || listGetIndex.location == IndexLocation.LAST ) {
                    return FunctionNames.REMOVEFIRSTORLAST.signature.typeCheckPhraseList(listGetIndex, this, listGetIndex.param);
                } else {
                    return FunctionNames.REMOVE.signature.typeCheckPhraseList(listGetIndex, this, listGetIndex.param);
                }
        }
        return null;
    }
    ...
    public BlocklyType visitMathConstrainFunct(MathConstrainFunct mathConstrainFunct) {
        return FunctionNames.CONSTRAIN.signature.typeCheckPhrases(mathConstrainFunct, this, mathConstrainFunct.value, mathConstrainFunct.lowerBound, mathConstrainFunct.upperBound);
    }
    ...
    public BlocklyType visitMathRandomIntFunct(MathRandomIntFunct mathRandomIntFunct) {
        return FunctionNames.RANDOMINT.signature.typeCheckPhrases(mathRandomIntFunct, this, mathRandomIntFunct.from, mathRandomIntFunct.to);
    }
    ...
    public BlocklyType visitRgbColor(RgbColor rgbColor) {
        ...
        if ( rgbColor.getParameters().length == 0 ) {
            ...
            return FunctionNames.GETRGB.signature.typeCheckPhrases(rgbColor, this, rgbColor.R, rgbColor.G);
        } else if ( rgbColor.getParameters().length == 4 ) {
            return FunctionNames.GETRGB.signature.typeCheckPhrases(rgbColor, this, rgbColor.R, rgbColor.G, rgbColor.B);
        } else {
    ...
    public BlocklyType visitTextJoinFunct(TextJoinFunct textJoinFunct) {
        return FunctionNames.TEXTJOIN.signature.typeCheckPhraseList(textJoinFunct, this, textJoinFunct.param.el);
    }
