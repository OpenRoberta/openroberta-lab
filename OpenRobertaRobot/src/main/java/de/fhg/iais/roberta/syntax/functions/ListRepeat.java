...
public class ListRepeat<V> extends Function<V> {
    ...
    protected V accept(AstVisitor<V> visitor) {
        return ((AstLanguageVisitor<V>) visitor).visitListRepeat(this);
    }
    ...
    public Block astToBlock() {
        ...
        JaxbTransformerHelper.addField(jaxbDestination, BlocklyConstants.LIST_TYPE, this.typeVar.getBlocklyName());
        JaxbTransformerHelper.addValue(jaxbDestination, BlocklyConstants.ITEM, getParam().get(0));
        JaxbTransformerHelper.addValue(jaxbDestination, BlocklyConstants.NUM, getParam().get(1));
