...
@NepoBasic(sampleValues = {@NepoSampleValue(blocklyFieldName = "HUMIDITY_TEMPERATURE", sensor = "HUMIDITY", mode = "TEMPERATURE"), @NepoSampleValue(blocklyFieldName = "HUMIDITY_HUMIDITY", sensor = "HUMIDITY", mode = "HUMIDITY")}, containerType = "HUMIDITY_SENSING", category = "SENSOR", blocklyNames = {"robSensors_humidity_getSample"})
