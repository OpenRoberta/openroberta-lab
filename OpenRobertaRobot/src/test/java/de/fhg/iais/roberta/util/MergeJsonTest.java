...
public class MergeJsonTest {
    ...
    private static final JSONObject j2override = new JSONObject(Util1.readResourceContent("/json/json-2override.txt"));
    private static final JSONObject j3 = new JSONObject(Util1.readResourceContent("/json/json-3.txt"));
    private static final JSONObject j3override = new JSONObject(Util1.readResourceContent("/json/json-3override.txt"));

    @Test
    public void testO1() {
        JSONObject t = new JSONObject(Util1.readResourceContent("/json/json-1.txt"));
        Util1.mergeJsonIntoFirst("root", t, j2a, false);
    ...
    public void testOverride() {
        JSONObject t = new JSONObject(Util1.readResourceContent("/json/json-1.txt"));
        Util1.mergeJsonIntoFirst("root", t, j2override, true);
    ...
    public void testE1() {
        JSONObject t = new JSONObject(Util1.readResourceContent("/json/json-1.txt"));
        Util1.mergeJsonIntoFirst("root", t, j2e, false);
