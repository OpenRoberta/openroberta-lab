...
public class MethodReturnTest {
    ...
    public void methodReturn5() throws Exception {
        String a =
            "BlockAST [project=[[Location [x=1, y=85], MethodReturn [test, VarDeclaration [NUMERIC, x, EmptyExpr [defVal=class java.lang.Integer], false, false], , BOOL, EmptyExpr [defVal=class de.fhg.iais.roberta.syntax.expr.NullConst]]]]]";
