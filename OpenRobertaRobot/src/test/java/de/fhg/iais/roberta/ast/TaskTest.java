...
public class TaskTest {
    ...
    public void mainTask() throws Exception {
        String a =
            "BlockAST [project=[[Location [x=1, y=7], MainTask [\n"
                ...
                + "exprStmt VarDeclaration [ARRAY_BOOLEAN, item6, ListCreate [BOOLEAN, BoolConst [true], BoolConst [false], EmptyExpr [defVal=class java.util.ArrayList]], true, true]\n"
    ...
    public void reverseTransformatinMainTaskShadow() throws Exception {
        Helper.assertTransformationIsOk("/ast/task/task_mainTaskShadow.xml");
    }
