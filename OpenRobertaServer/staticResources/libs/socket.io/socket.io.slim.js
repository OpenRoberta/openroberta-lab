!function(t, e) {'object' == typeof exports && 'object' == typeof module ? module.exports = e() : 'function' == typeof define && define.amd ? define([], e) : 'object' == typeof exports ? exports.io = e() : t.io = e();}(this, function() {
    return function(t) {
        ...
        function n(t, e) {
            ...
            var r, n = i(t), s = n.source, h = n.id, p = n.path, u = c[h] && p in c[h].nsps, f = e.forceNew || e['force new connection'] || !1 === e.multiplex || u;
            return f ? r = a(s, e) : (c[h] || (c[h] = a(s, e)), r = c[h]), n.query && !e.query && (e.query = n.query), r.socket(n.path, e);
        }
        var o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function(t) {return typeof t;} : function(t) {return t && 'function' == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t;}, i = r(1), s = r(4), a = r(10);
        r(3)('socket.io-client');
        t.exports = e = n;
        var c = e.managers = {};
        e.protocol = s.protocol, e.connect = n, e.Manager = r(10), e.Socket = r(36);
    }, function(t, e, r) {
        (function(e) {
            'use strict';
            function n(t, r) {
        ...
        }, s.prototype.destroy = function() {this.reconstructor && this.reconstructor.finishedReconstruction();}, h.prototype.takeBinaryData = function(t) {
            if (this.buffers.push(t), this.buffers.length === this.reconPack.attachments) {
                var e = l.reconstructPacket(this.reconPack, this.buffers);
                return this.finishedReconstruction(), e;
            }
            return null;
        }, h.prototype.finishedReconstruction = function() {this.reconPack = null, this.buffers = [];};
    }, function(t, e, r) {
        ...
        (function(e) {
            ...
            var o = r(7), i = Object.prototype.toString, s = 'function' == typeof e.Blob || '[object BlobConstructor]' === i.call(e.Blob), a = 'function' == typeof e.File || '[object FileConstructor]' === i.call(e.File);
            t.exports = n;
        }).call(e, function() {return this;}());
    }, function(t, e) {
        var r = {}.toString;
        ...
        (function(t) {
            ...
            var i = r(7), s = r(9), a = Object.prototype.toString, c = 'function' == typeof t.Blob || '[object BlobConstructor]' === a.call(t.Blob), h = 'function' == typeof t.File || '[object FileConstructor]' === a.call(t.File);
        ...
        var o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function(t) {return typeof t;} : function(t) {return t && 'function' == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t;}, i = r(11), s = r(36), a = r(5), c = r(4), h = r(38), p = r(39), u = (r(3)('socket.io-client:manager'), r(34)), f = r(40),
        ...
        t.exports = n, n.prototype.emitAll = function() {
            ...
            if (!1 !== this._timeout) {
                var a = this._timeout, c = setTimeout(function() {o.destroy(), r.close(), r.emit('error', 'timeout'), n.emitAll('connect_timeout', a);}, a);
        ...
        (function(e) {
            ...
            var i = r(14), s = r(5), a = (r(3)('engine.io-client:socket'), r(34)), c = r(20), h = r(2), p = r(35), u = r(28);
            ...
            }, n.prototype.onOpen = function() {if (this.readyState = 'open', n.priorWebsocketSuccess = 'websocket' === this.transport.name, this.emit('open'), this.flush(), 'open' === this.readyState && this.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t]);}, n.prototype.onPacket = function(t) {
            ...
            }, n.prototype.onDrain = function() {this.writeBuffer.splice(0, this.prevBufferLen), this.prevBufferLen = 0, 0 === this.writeBuffer.length ? this.emit('drain') : this.flush();}, n.prototype.flush = function() {'closed' !== this.readyState && this.transport.writable && !this.upgrading && this.writeBuffer.length && (this.transport.send(this.writeBuffer), this.prevBufferLen = this.writeBuffer.length, this.emit('flush'));}, n.prototype.write = n.prototype.send = function(t,
                e, r) {return this.sendPacket('message', t, e, r), this;}, n.prototype.sendPacket = function(t, e, r, n) {
        ...
        (function(t) {
            ...
            var o = r(15), i = r(17), s = r(31), a = r(32);
        ...
        (function(e) {
            ...
            var a = r(15), c = r(18), h = r(5), p = r(29);
            r(3)('engine.io-client:polling-xhr');
            t.exports = o, t.exports.Request = i, p(o, c), o.prototype.supportsBinary = !0, o.prototype.request = function(t) {return t = t || {}, t.uri = this.uri(), t.xd = this.xd, t.xs = this.xs, t.agent = this.agent || !1, t.supportsBinary = this.supportsBinary, t.enablesXDR = this.enablesXDR, t.pfx = this.pfx, t.key = this.key, t.passphrase = this.passphrase, t.cert = this.cert, t.ca = this.ca, t.ciphers = this.ciphers, t.rejectUnauthorized = this.rejectUnauthorized, t.requestTimeout = this.requestTimeout, t.extraHeaders = this.extraHeaders, new i(t);}, o.prototype.doWrite = function(t,
                e) {
        ...
        var o = r(19), i = r(28), s = r(20), a = r(29), c = r(30);
        ...
        a(n, o), n.prototype.name = 'polling', n.prototype.doOpen = function() {this.poll();}, n.prototype.pause = function(t) {
            ...
            var e = this, r = function(t, r, n) {return 'opening' === e.readyState && e.onOpen(), 'close' === t.type ? (e.onClose(), !1) : void e.onPacket(t);};
        ...
        }, n.prototype.open = function() {return 'closed' !== this.readyState && '' !== this.readyState || (this.readyState = 'opening', this.doOpen()), this;}, n.prototype.close = function() {return 'opening' !== this.readyState && 'open' !== this.readyState || (this.doClose(), this.onClose()), this;}, n.prototype.send = function(t) {
        ...
        (function(t) {
            ...
            function i(t, r, n) {
                ...
                return o.onload = function() {t.data = o.result, e.encodePacket(t, r, !0, n);}, o.readAsArrayBuffer(t.data);
            }
            function s(t, r, n) {
                if (!r) return e.encodeBase64Packet(t, n);
                if (g) return i(t, r, n);
            ...
            var h, p = r(21), u = r(6), f = r(22), l = r(23), d = r(24);
            ...
            e.protocol = 3;
            var v = e.packets = { open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6 }, b = p(v), k = { type: 'error', data: 'parser error' }, w = r(27);
        ...
        (function(e) {
            ...
            var o, i = r(19), s = r(20), a = r(28), c = r(29), h = r(30), p = (r(3)('engine.io-client:websocket'), e.WebSocket || e.MozWebSocket);
        ...
        var o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function(t) {return typeof t;} : function(t) {return t && 'function' == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? 'symbol' : typeof t;}, i = r(4), s = r(5), a = r(37), c = r(38), h = r(39), p = (r(3)('socket.io-client:socket'), r(28));
        t.exports = e = n;
        var u = { connect: 1, connect_error: 1, connect_timeout: 1, connecting: 1, disconnect: 1, error: 1, reconnect: 1, reconnect_attempt: 1, reconnect_failed: 1, reconnect_error: 1, reconnecting: 1, ping: 1, pong: 1 }, f = s.prototype.emit;
        ...
        }, n.prototype.open = n.prototype.connect = function() {return this.connected ? this : (this.subEvents(), this.io.open(), 'open' === this.io.readyState && this.onopen(), this.emit('connecting'), this);}, n.prototype.send = function() {
            var t = a(arguments);
        ...
        }, n.prototype.packet = function(t) {t.nsp = this.nsp, this.io.packet(t);}, n.prototype.onopen = function() {
        ...
        }, n.prototype.onclose = function(t) {this.connected = !1, this.disconnected = !0, delete this.id, this.emit('disconnect', t);}, n.prototype.onpacket = function(t) {
        ...
        }, n.prototype.onconnect = function() {this.connected = !0, this.disconnected = !1, this.emit('connect'), this.emitBuffered();}, n.prototype.emitBuffered = function() {
            var t;
        ...
        }, n.prototype.close = n.prototype.disconnect = function() {return this.connected && this.packet({ type: i.DISCONNECT }), this.destroy(), this.connected && this.onclose('io client disconnect'), this;}, n.prototype.compress = function(t) {return this.flags = this.flags || {}, this.flags.compress = t, this;};
    }, function(t, e) {
        function r(t, e) {
            var r = [];
            e = e || 0;
        ...
        t.exports = function(t, e) {
            ...
            return function() {return e.apply(t, n.concat(r.call(arguments)));};
        };
    }, function(t, e) {
