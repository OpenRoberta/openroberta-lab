require.config({
  ...
  paths: {
    ...
    "bootstrap-table":
      "libs/bootstrap/bootstrap-3.3.1-dist/dist/js/bootstrap-table.min",
    "bootstrap-tagsinput":
      "libs/bootstrap/bootstrap-3.3.1-dist/dist/js/bootstrap-tagsinput.min",
    "bootstrap.wysiwyg":
      "libs/bootstrap/bootstrap-3.3.1-dist/dist/js/bootstrap-wysiwyg.min",
    ...
    "configuration.controller":
      "app/roberta/controller/configuration.controller",
    ...
    "sourceCodeEditor.controller":
      "app/roberta/controller/sourceCodeEditor.controller",
    ...
    "simulation.robot.calliope":
      "app/simulation/simulationLogic/robot.calliope",
    "simulation.robot.calliope2016":
      "app/simulation/simulationLogic/robot.calliope2016",
    "simulation.robot.calliope2017":
      "app/simulation/simulationLogic/robot.calliope2017",
    "simulation.robot.mbot": "app/simulation/simulationLogic/robot.mbot",
    "simulation.robot.microbit":
      "app/simulation/simulationLogic/robot.microbit",
    ...
    "interpreter.aRobotBehaviour":
      "app/nepostackmachine/interpreter.aRobotBehaviour",
    "interpreter.robotWeDoBehaviour":
      "app/nepostackmachine/interpreter.robotWeDoBehaviour",
    "interpreter.robotSimBehaviour":
      "app/nepostackmachine/interpreter.robotSimBehaviour",
