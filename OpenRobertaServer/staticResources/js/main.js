...
// Load custom repetition scripts from staticResources/blockly via RequireJS.
require(['blockly_local/repetition_detector','blockly_local/warning_repetition'], function() {
  ...
  (function waitForWorkspace(attemptsLeft){
    ...
    if (ws && window.Blockly && Blockly.RepetitionDetector && typeof Blockly.RepetitionDetector.initWorkspace === 'function') {
      try {
        Blockly.RepetitionDetector.initWorkspace(ws);
