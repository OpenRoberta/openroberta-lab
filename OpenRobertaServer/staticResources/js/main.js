require.config({
    ...
    paths: {
        ...
        'webUsb.controller': 'app/roberta/controller/webConnection/webUsb.controller',
        'webBLE.controller': 'app/roberta/controller/webConnection/webBLE.controller',
...
require([
    ...
    webBLEController = require('webBLE.controller');
