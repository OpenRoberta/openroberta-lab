 ...
 * Display message
 * 
 * @param {messageId} ID of message to be displayed
 * @param {output} where to display the message, "TOAST" or "POPUP"
 * @param {replaceWith} Text to replace an optional '$' in the message-text
 */
 ...
 * Display information
 * 
 * @param {result} Response of a REST-call.
 * @param {successMessage} Toast-message to be displayed if REST-call was ok.
 * @param {result} Popup-message to be displayed if REST-call failed.
 * @param {messageParam} Parameter to be used in the message text.
 */
