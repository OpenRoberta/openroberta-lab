define(["require", "exports", "jquery", "wrap", "log"], function (require, exports, $, WRAP, LOG) {
    ...
    exports.externPost = exports.sendProgramHexToAgent = exports.listRobotsFromAgent = exports.ping = exports.xml = exports.download = exports.json = exports.get = exports.setErrorFn = exports.setInitToken = exports.setErrorNum = exports.errorNum = exports.onNotificationsAvailableCallback = void 0;
    /**
    ...
    function setErrorNum(value) {
        exports.errorNum = value;
    }
    exports.setErrorNum = setErrorNum;
    /**
     * the error fn.
     */
    ...
    function externPost(url, data, successFn, onError) {
        return $.post({
            url: url,
            data: data,
