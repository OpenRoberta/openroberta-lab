    ...
    Scene.prototype.drawRobots = function () {
        ...
        for (var r = 0; r < this.numprogs; r++) {
            ...
            if (SIM.getRobotIndex() === r) {
                ...
                $("#notConstantValue").append('<div><label>Motor left</label><span>' + UTIL.round(this.robots[r].encoder.left * CONSTANTS.ENC, 0) + '°</span></div>');
                $("#notConstantValue").append('<div><label>Motor right</label><span>' + UTIL.round(this.robots[r].encoder.right * CONSTANTS.ENC, 0) + '°</span></div>');
                $("#notConstantValue").append('<div><label>Touch Sensor</label><span>' + UTIL.round(this.robots[r].touchSensor.value, 0) + '</span></div>');
                $("#notConstantValue").append('<div><label>Light Sensor</label><span>' + UTIL.round(this.robots[r].colorSensor.lightValue, 0) + '%</span></div>');
                $("#notConstantValue").append('<div><label>Ultra Sensor</label><span>' + UTIL.round(this.robots[r].ultraSensor.distance / 3.0, 0) + 'cm</span></div>');
                ...
                $("#notConstantValue").append('<div><label>Color Sensor</label><span style="margin-left:6px; width: 20px; background-color:' + this.robots[r].colorSensor.color + '">&nbsp;</span></div>');
            ...
            this.rCtx.restore();
            // ultra
            this.waves[r] += CONSTANTS.WAVE_LENGTH * SIM.getDt();
            this.waves[r] = this.waves[r] % CONSTANTS.WAVE_LENGTH;
            this.rCtx.lineDashOffset = CONSTANTS.WAVE_LENGTH - this.waves[r];
    ...
    Scene.prototype.updateSensorValues = function (running) {
        ...
        for (var r = 0; r < this.numprogs; r++) {
            ...
            if (this.robots[r].colorSensor) {
                ...
                if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.NONE) {
                    this.robots[r].colorSensor.color = 'grey';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.BLACK) {
                    this.robots[r].colorSensor.color = 'black';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.WHITE) {
                    this.robots[r].colorSensor.color = 'white';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.YELLOW) {
                    this.robots[r].colorSensor.color = 'yellow';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.BROWN) {
                    this.robots[r].colorSensor.color = 'brown';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.RED) {
                    this.robots[r].colorSensor.color = 'red';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.BLUE) {
                    this.robots[r].colorSensor.color = 'blue';
                } else if (this.robots[r].colorSensor.colorValue === CONSTANTS.COLOR_ENUM.GREEN) {
            ...
            if (this.robots[r].ultraSensor) {
                ...
                var u3 = {
                    ...
                    x2: this.robots[r].ultraSensor.rx + CONSTANTS.MAXDIAG * Math.cos(this.robots[r].pose.theta),
                    y2: this.robots[r].ultraSensor.ry + CONSTANTS.MAXDIAG * Math.sin(this.robots[r].pose.theta)
                }
                var u1 = {
                    x1: this.robots[r].ultraSensor.rx,
                    y1: this.robots[r].ultraSensor.ry,
                    x2: this.robots[r].ultraSensor.rx + CONSTANTS.MAXDIAG * Math.cos(this.robots[r].pose.theta - Math.PI / 8),
                    y2: this.robots[r].ultraSensor.ry + CONSTANTS.MAXDIAG * Math.sin(this.robots[r].pose.theta - Math.PI / 8)
                }
                var u2 = {
                    x1: this.robots[r].ultraSensor.rx,
                    y1: this.robots[r].ultraSensor.ry,
                    x2: this.robots[r].ultraSensor.rx + CONSTANTS.MAXDIAG * Math.cos(this.robots[r].pose.theta - Math.PI / 16),
                    y2: this.robots[r].ultraSensor.ry + CONSTANTS.MAXDIAG * Math.sin(this.robots[r].pose.theta - Math.PI / 16)
                }
                var u5 = {
                    x1: this.robots[r].ultraSensor.rx,
                    y1: this.robots[r].ultraSensor.ry,
            ...
            if (this.robots[r].encoder) {
                values.encoder = {};
                values.encoder.left = this.robots[r].encoder.left * CONSTANTS.ENC;
                values.encoder.right = this.robots[r].encoder.right * CONSTANTS.ENC;
            }
