define(["require", "exports", "simulation.simulation", "interpreter.constants", "simulation.robot", "guiState.controller"], function (require, exports, SIM, C, simulation_robot_1, GUISTATE_C) {
    ...
    /**
     * Creates a new xNN for a simulation.
     *
     * The xNN is a differential drive robot, similar to the ev3 robots.
     *
     * @class
     */
    function xNN(pose, configuration, num, robotBehaviour) {
    ...
    xNN.prototype = Object.create(simulation_robot_1.default.prototype);
    xNN.prototype.constructor = xNN;
    xNN.prototype.reset = function () {
        this.encoder.left = 0;
     ...
     *
     * @param {Number}
     *            sin the sine from the orientation
     * @param {Number}
     *            cos the cosine from the orientation
     * @param {point}
     *            point to translate
     * @returns the translated point
     *
     */
    xNN.prototype.translate = function (sin, cos, point) {
