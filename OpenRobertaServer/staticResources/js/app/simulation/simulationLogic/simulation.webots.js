...
define(["require", "exports", "jquery", "guiState.controller"], function (require, exports, $, guiStateController) {
    ...
    var SimulationWebots = /** @class */ (function (_super) {
        __extends(SimulationWebots, _super);
        function SimulationWebots(element, webots) {
            var _this = _super.call(this, element, webots) || this;
            _this.connected = false;
            _this.volume = 0.5;
            return _this;
        }
        SimulationWebots.prototype.uploadController = function (sourceCode) {
            var message = {
                name: 'supervisor',
        ...
        SimulationWebots.prototype.start = function (url, sourceCode) {
            var _this = this;
        ...
        SimulationWebots.prototype.reset = function () {
            _super.prototype.sendMessage.call(this, 'reset');
        };
        SimulationWebots.prototype.pause = function () {
            this.view.runOnLoad = false;
            _super.prototype.sendMessage.call(this, 'pause');
        };
        SimulationWebots.prototype.run = function (sourceCode, callback) {
            this.sourceCode = sourceCode;
        ...
        SimulationWebots.prototype.initSpeechSynthesis = function () {
        ...
        SimulationWebots.prototype.sayText = function (data) {
            var text = data[1];
            var speed = data[2];
            var pitch = data[3];
        ...
        SimulationWebots.prototype.initSpeechRecognition = function () {
        ...
        SimulationWebots.prototype.recognizeSpeech = function () {
            if (this.recognition) {
    ...
    var WebotsSimulationController = /** @class */ (function () {
        ...
        WebotsSimulationController.prototype.isInterpreterRunning = function () {
            return this._interpreterRunning;
        };
        Object.defineProperty(WebotsSimulationController.prototype, "interpreterRunning", {
            set: function (value) {
        ...
        WebotsSimulationController.prototype.init = function (result, refresh, callback, robotType) {
            return __awaiter(this, void 0, void 0, function () {
                var webots, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        WebotsSimulationController.prototype.run = function (result, callback) {
        ...
        WebotsSimulationController.prototype.importImage = function () {
            // not supported here
        };
        WebotsSimulationController.prototype.stop = function () {
        ...
        WebotsSimulationController.prepareModuleForWebots = function () {
            ...
            window['Module']['locateFile'] = function (path, prefix) {
                ...
                if (path.endsWith('.data'))
                    return window.location.origin + '/libs/webots/' + path;
    ...
    exports.default = new WebotsSimulationController();
});
