define(['simulation.simulation', 'simulation.robot.mbed'], function(SIM, Mbed) {
    ...
    Calliope.prototype.controle = function() {
        $('#simRobotContent').append('<div id="mbedContent"><form id="mbed-form"><div id="mbedButtons" class="btn-group btn-group-vertical" data-toggle="buttons">' + //
            ...
            '<label for="rangeCompass" style="margin: 8px;margin-top: 12px; margin-left: 0">' + Blockly.Msg.SENSOR_COMPASS
            ...
            '<label for="rangeLight" style="margin: 8px;margin-top: 12px; margin-left: 0">' + Blockly.Msg.SENSOR_LIGHT
            ...
            '<label for="rangeTemperature" style="margin: 8px;margin-top: 12px; margin-left: 0">' + Blockly.Msg.SENSOR_TEMPERATURE
            ...
            '<div style="margin:8px 0; "><input id="slider1" type="range" min="0" max="1023" value="0" step="1" /></div></form></div>'); //
    };
