define([ 'simulation.simulation', 'interpreter.constants', 'simulation.robot', 'guiState.controller' ], function(SIM, C, Robot, GUISTATE_C) {
    ...
    function Ev3(pose, num, robotBehaviour) {
        ...
        this.display = {
            ...
            STEERING : '<image width="178" height="128" alt="steering wheel" xlink:href="data:image/png;base64," />',
            ...
            CHECKMARK : '<image width="178" height="128" alt="checkmark" xlink:href="data:image/png;base64," />'
        };
        this.buttons = {
            escape : false,
            up : false,
