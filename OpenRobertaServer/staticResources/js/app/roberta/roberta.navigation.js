define([ 'exports', 'util', 'message', 'comm', 'rest.robot', 'rest.program', 'rest.configuration', 'roberta.toolbox', 'roberta.robot', 'roberta.user',
        'roberta.brick-configuration', 'roberta.user-state', 'roberta.program', 'roberta.brickly', 'simulation.simulation', 'jquery', 'blocks' ], function(
        exports, UTIL, MSG, COMM, ROBOT, PROGRAM, CONFIGURATION, ROBERTA_TOOLBOX, ROBERTA_ROBOT, ROBERTA_USER, ROBERTA_BRICK_CONFIGURATION, userState,
