define([
  ...
  exports.programToBlocklyWorkspace =
    exports.loadExternalToolbox =
    exports.loadToolbox =
    exports.resetView =
    exports.reloadView =
    exports.reloadProgram =
    exports.getBlocklyWorkspace =
    exports.exportAllXml =
    exports.exportXml =
    exports.linkProgram =
    exports.newProgram =
    exports.initProgramEnvironment =
    exports.showSaveAsModal =
    exports.initProgramForms =
    exports.loadFromGallery =
    exports.saveToServer =
    exports.init =
    exports.password =
    exports.SSID =
      void 0;
  ...
  function initEvents() {
    ...
    blocklyWorkspace.addChangeListener(function (event) {
      if (
        listenToBlocklyEvents &&
        event.type != Blockly.Events.UI &&
        GUISTATE_C.isProgramSaved()
      ) {
  ...
  function saveToServer() {
    ...
    var isNamedConfig =
      !GUISTATE_C.isConfigurationStandard() &&
      !GUISTATE_C.isConfigurationAnonymous();
    var configName = isNamedConfig
      ? GUISTATE_C.getConfigurationName()
      : undefined;
    var xmlConfigText = GUISTATE_C.isConfigurationAnonymous()
    ...
    if ($formSingleModal.valid()) {
      ...
      PROGRAM.saveAsProgramToServer(
        ...
        function (result) {
          if (result.rc === "ok") {
            LOG.info(
              "saved program " + GUISTATE_C.getProgramName() + " as " + progName
            );
  ...
  function loadFromGallery(program) {
    ...
    function loadProgramFromGallery() {
      PROGRAM.loadProgramFromListing(
        programName,
        owner,
        user,
        function (result) {
          if (result.rc === "ok") {
            ...
            if (result.configName === undefined) {
              if (result.confXML === undefined) {
                ...
                GUISTATE_C.setConfigurationXML(
                  GUISTATE_C.getConfigurationConf()
                );
              } else {
                GUISTATE_C.setConfigurationName("");
                GUISTATE_C.setConfigurationXML(result.confXML);
  ...
  function bindControl() {
    Blockly.bindEvent_(
      blocklyWorkspace.robControls.saveProgram,
      "mousedown",
      null,
      function (e) {
  ...
  function programToBlocklyWorkspace(xml, opt_fromShowSource) {
    ...
    if (
      typeof blocklyWorkspace.description === "string" &&
      blocklyWorkspace.description.length
    ) {
