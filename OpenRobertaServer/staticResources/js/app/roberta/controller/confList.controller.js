define(["require", "exports", "require", "log", "util.roberta", "comm", "confList.model", "configuration.model", "blockly", "jquery", "bootstrap-table"], function (require, exports, require, LOG, UTIL, COMM, CONFLIST, CONFIGURATION, Blockly, $) {
