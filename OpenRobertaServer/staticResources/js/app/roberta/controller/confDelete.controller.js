define(["require", "exports", "require", "log", "util.roberta", "message", "comm", "configuration.model", "blockly", "jquery", "bootstrap-table"], function (require, exports, require, LOG, UTIL, MSG, COMM, CONFIGURATION, Blockly, $) {
