...
define(["require", "exports", "dapjs"], function (require, exports, dapjs_1) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.upload = exports.selectDevice = exports.init = exports.device = void 0;
    function init() { }
    exports.init = init;
    function selectDevice(robot, generatedCode) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // @ts-ignore
                        exports.device = _a.sent();
                        return [4 /*yield*/, upload(generatedCode)];
    ...
    function upload(generatedCode) {
        return __awaiter(this, void 0, void 0, function () {
            var transport, target, buffer, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        transport = new dapjs_1.WebUSB(exports.device);
