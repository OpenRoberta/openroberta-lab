define(["require", "exports", "log", "jquery", "guiState.controller", "blockly"], function (require, exports, LOG, $, GUISTATE_C, Blockly) {
    ...
    function translate($domElement) {
        ...
        $domElement.find('[lkey]').each(function (index) {
            ...
            if (lkey === 'Blockly.Msg.SOURCE_CODE_EDITOR_PLACEHOLDER') {
                ...
                $('#goto-sim').attr('data-bs-original-title', value).tooltip({ placement: 'top' });
                $('#explore-goto-sim').attr('data-bs-original-title', value).tooltip({ placement: 'top' });
                $('#learn-goto-sim').attr('data-bs-original-title', value).tooltip({ placement: 'top' });
            }
