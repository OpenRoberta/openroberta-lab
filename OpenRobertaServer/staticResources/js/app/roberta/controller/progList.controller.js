define(["require", "exports", "log", "util", "message", "progList.model", "userGroup.model", "program.model", "configuration.controller", "program.controller", "guiState.controller", "blockly", "jquery", "bootstrap-table"], function (require, exports, LOG, UTIL, MSG, PROGLIST, USERGROUP, PROGRAM, CONFIGURATION_C, PROGRAM_C, GUISTATE_C, Blockly, $) {
    ...
    function initProgListEvents() {
        ...
        $programNameTable.onWrap('check-all.bs.table', function () {
        ...
        $programNameTable.onWrap('check.bs.table', function () {
    ...
    function update(result) {
        ...
        $programNameTable
            .find('.gallery')
            .attr('data-bs-original-title', Blockly.Msg.PROGLIST_SHARE_WITH_GALLERY_TOOLTIP || 'Click here to upload your program to the gallery hence share it with all other users.');
        $programNameTable
            .find('.load')
    ...
    var titleActions = '<a href="#" id="deleteSomeProg" class="deleteSomeProgHeader disabled" rel="tooltip" lkey="Blockly.Msg.PROGLIST_DELETE_ALL_TOOLTIP" data-bs-original-title="" data-container="body" title="">' +
