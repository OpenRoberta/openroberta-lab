...
define(["require", "exports", "./neuralnetwork.nn", "./neuralnetwork.state", "log", "d3"], function (require, exports, nn, neuralnetwork_state_1, LOG, d3) {
    ...
    function drawNetwork(network) {
        ...
        for (var layerIdx = 1; layerIdx < numLayers - 1; layerIdx++) {
            ...
            maxY = Math.max(maxY, nodeIndexScale(numNodes_1));
            ...
            for (var i = 0; i < numNodes_1; i++) {
                ...
                var numNodes_2 = network[layerIdx].length;
    ...
    function makeNetworkFromState() {
        ...
        var allOutputs = state.outputs.concat(state.outputsWoVar);
    ...
    exports.makeNetworkFromState = makeNetworkFromState;
    function makeNetworkWeightsFromState(network, weightsAllLayers) {
    ...
    function makeNetworkBiasFromState(network, biasesAllLayers) {
     ...
     */
    function changeWeight(from, to, change, value) {
        var fromNode = getNeuronById(from);
        if (fromNode != null) {
     ...
     */
    function changeBias(id, change, value) {
        var node = getNeuronById(id);
        if (node != null) {
    ...
    exports.changeBias = changeBias;
    function getOutputNeuronVal(id) {
        var node = getNeuronById(id);
        return node != null ? node.output : 0;
    }
    exports.getOutputNeuronVal = getOutputNeuronVal;
