...
Blockly.Msg.POPUP_ABOUT_TEXT = "O Open Roberta Lab é um ambiente gráfico de programação baseado na nuvem que permite a crianças e jovens programar robôs e microcontroladores sem barreiras técnicas. A plataforma é de código aberto: o seu código-fonte está disponível publicamente, e as contribuições e sugestões da comunidade são bem-vindas.";
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "A Roberta Education gGmbH opera o Open Roberta Lab em servidores localizados na Alemanha e desenvolve continuamente a plataforma. As alterações ao código-fonte são revistas e testadas antes de serem publicadas.";
