...
Blockly.Msg.NAO_NAOMARK_TOOLTIP = "Tries to deetect and identify a NAO Mark in the current camera picture. If a NAO Mark is detected it will be identified and the block returns the corresponding. For a list of the NAO Mark and the corresponding numbers refer to the wiki.";  // untranslated
