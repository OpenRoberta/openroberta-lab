...
Blockly.Msg.AMBIENTLIGHT_TOOLTIP = "Represents an ambientlight sensor.";  // untranslated
...
Blockly.Msg.HINT_USER_ACCOUNT = "todo";  // untranslated
Blockly.Msg.HINT_USER_AGE = "todo";  // untranslated
Blockly.Msg.HINT_USER_EMAIL = "todo";  // untranslated
Blockly.Msg.HINT_USER_NAME = "todo";  // untranslated
Blockly.Msg.HINT_USER_PASSWORT = "todo";  // untranslated
Blockly.Msg.HINT_USER_PASSWORT_CONFIRM = "todo";  // untranslated
...
Blockly.Msg.LED_MATRIX_TOOLTIP = "Represents an LED matrix";  // untranslated
...
Blockly.Msg.LED_TOOLTIP = "Represents an external LED.";  // untranslated
...
Blockly.Msg.MAKEBLOCKBRICK_TOOLTIP = "Represents the MakeBlock brick with connected actors and sensors. There are also inbuilt actors and sensors available, e.g. buttons, display ...";  // untranslated
...
Blockly.Msg.MOTOR_GEARED_TOOLTIP = "Represents a geared motor.";  // untranslated
...
Blockly.Msg.NAO_AUTONOMOUS_TOOLTIP = "Toggle the state of Autonomous life. Turn Autonomous life off to gain more control over NAOs behaviour.";  // untranslated
...
Blockly.Msg.NAO_RECOGNIZEWORD = "recognize word from";  // untranslated
Blockly.Msg.NAO_RECOGNIZEWORDOR = "or recognize word";  // untranslated
Blockly.Msg.NAO_RECOGNIZEWORD_TOOLTIP = "Make NAO recognize a word or a phrase from the provided list";  // untranslated
...
Blockly.Msg.PIRMOTION_TOOLTIP = "Represents an PIR motion sensor.";  // untranslated
