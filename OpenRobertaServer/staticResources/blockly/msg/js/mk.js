...
Blockly.Msg.POPUP_ABOUT_TEXT = "Open Roberta Lab е графичка програмска средина базирана на облак, која им овозможува на децата и младите да програмираат роботи и микроконтролери без технички пречки. Платформата е со отворен код: нејзиниот изворен код е јавно достапен, а придонесите и предлозите од заедницата се добредојдени.";
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "Roberta Education gGmbH го управува Open Roberta Lab на сервери во Германија и континуирано ја развива платформата. Промените во изворниот код се прегледуваат и тестираат пред да бидат објавени.";
