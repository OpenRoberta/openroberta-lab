...
Blockly.Msg.POPUP_ABOUT_TEXT = "Open Roberta Lab is a cloud-based graphical programming environment that enables children and young people to program robots and microcontrollers without technical barriers. The platform is open source: Its source code is publicly available, and contributions and suggestions from the community are welcome.";  // untranslated
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "Roberta Education gGmbH operates the Open Roberta Lab on servers in Germany and continuously develops the platform. Changes to the source code are reviewed and tested before they are released.";  // untranslated
