...
Blockly.Msg.POPUP_TEXT_STARTUP_MESSAGE = "Das musst du über Open Roberta Lab wissen:<ul class='icon'><li class='document-text'>hier kann man EV3 Roboter programmieren</li><li class='Roberta'>dein Roboter braucht ein spezielles Betriebssystem <a target='_blank' href='https://mp-devel.iais.fraunhofer.de/wiki/x/RIAd'>check!</a></li><li class='wi-fi'>dein Roboter braucht WLAN oder das USB-Programm</li><li class='arrow-right-thick'>Schau in die Hilfe wenn du nicht weißt, ob dein Roboter das alles schon kann ... <a target='_blank' href='https://mp-devel.iais.fraunhofer.de/wiki/x/A4AM'>mehr</a></li></ul><br /><p>Was alles neu ist:</p>Version beta 1.2.0<ul class='NonIcon' style='font-size:small'><li>Blöcke um Nachrichten zu senden und zu empfangen</li><li>Verbinden des Roboters über USB</li><li>Motor drehen rückwärts mit negativem Tempo</li><li>weitere kleinere Fehler behoben</li></ul>";
...
Blockly.Msg.RECIVED_DATA = "Empfange Nachricht";
