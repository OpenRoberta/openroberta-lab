...
Blockly.Msg.HINT_TOOLBOX = "Werkzeugkasten";
...
Blockly.Msg.MENU_CONNECTION = "Verbindung";
Blockly.Msg.MENU_DEFAULT_CONFIGURATION = "Standardkonfiguration";
Blockly.Msg.MENU_DELETE = "löschen ...";
Blockly.Msg.MENU_DELETE_USER = "Benutzer löschen ...";
Blockly.Msg.MENU_DIVIDE = "teilen ...";
Blockly.Msg.MENU_EXPERT = "Experte";
Blockly.Msg.MENU_HELP = "Hilfe";
Blockly.Msg.MENU_LOGGING = "Logging";
Blockly.Msg.MENU_LOGIN = "Anmeldung";
Blockly.Msg.MENU_LOG_IN = "anmelden ...";
Blockly.Msg.MENU_LOG_OUT = "abmelden";
Blockly.Msg.MENU_NEPO = "Nepo";
Blockly.Msg.MENU_NEW = "neu ...";
Blockly.Msg.MENU_OPEN = "öffnen ...";
Blockly.Msg.MENU_PROGRAM = "Programm";
...
Blockly.Msg.MESSAGE_LOGIN_ERROR = "Du hast beim einloggen einen Fehler gemacht.";
Blockly.Msg.MESSAGE_LOGOUT_ERROR = "Beim ausloggen ist ein Fehler passiert.";
Blockly.Msg.MESSAGE_NAME_ERROR = "Du musst einen anderen Namen nehmen.";
Blockly.Msg.MESSAGE_PASSWORD_ERROR = "Du hast beim eingeben der beiden Passworte etwas falsch gemacht.";
Blockly.Msg.MESSAGE_PROGRAM_NOT_CHECKABLE = "Dein Programm kann zur Zeit noch nicht geprüft werden.";
Blockly.Msg.MESSAGE_SET_TOKEN = "Du musst die Roboter-Kennung eingeben.";
Blockly.Msg.MESSAGE_SET_TOKEN_ERROR = "Das Einstellen der Roboter-Kennung hat nicht funktioniert.";
Blockly.Msg.MESSAGE_USER_CREATED = "Du hast erfolgreich einen neuen Nutzer angelegt.";
Blockly.Msg.MESSAGE_USER_DELETED = "Der Nutzer wurde gelöscht.";
Blockly.Msg.MESSAGE_USER_DELETE_ERROR = "Der Nutzer konnte nicht gelöscht werden.";
Blockly.Msg.MESSAGE_USER_EXISTS = "Dieser Nutzer existiert bereits. Du musst einen anderen Account-Namen wählen.";
