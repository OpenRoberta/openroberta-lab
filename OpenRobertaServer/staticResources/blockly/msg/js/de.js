...
Blockly.Msg.MENU_SHORTCUT_EDITOR = "Ctrl + Shift + Z: Quellcode-Editor";
Blockly.Msg.MENU_SHORTCUT_EXPORT = "Ctrl + E: Programm exportieren";
Blockly.Msg.MENU_SHORTCUT_IMPORT = "Ctrl + I: Programm importieren";
Blockly.Msg.MENU_SHORTCUT_MULTISIM = "Ctrl + Shift + G: Mehrfachrobotersimulation";
Blockly.Msg.MENU_SHORTCUT_OPEN_SIM = "Ctrl + G: Simulationsansicht";
Blockly.Msg.MENU_SHORTCUT_RUN = "Ctrl + R: Auf Roboter laufen";
Blockly.Msg.MENU_SHORTCUT_SAVE = "Ctrl + S: Speichern";
Blockly.Msg.MENU_SHORTCUT_SAVEAS = "Ctrl + Shift + S: Speichern als";
...
Blockly.Msg.SHORTCUT_ASSERT = "Ctrl + 3: Behauptung und Ausdruck";
Blockly.Msg.SHORTCUT_EDITOR = "Shift + Z: Zeigen Sie den Quellcode-Editor an";
Blockly.Msg.SHORTCUT_EVALUATE = "Ctrl + 4: Ausdruck auswerten";
Blockly.Msg.SHORTCUT_EXPORT = "Ctrl + E: Exportieren Sie das Programm";
Blockly.Msg.SHORTCUT_GYROSENSOR_READING = "Ctrl + 5: Ruft den Gyrosensor ab";
Blockly.Msg.SHORTCUT_IMPORT = "Ctrl + I: Importieren Sie das Programm";
Blockly.Msg.SHORTCUT_IMPORTNEPO = "Ctrl + 1: Importieren Sie den zu kompilierenden Nepo-Code";
Blockly.Msg.SHORTCUT_INITIATE_DEBUGGER = "Ctrl + 2: Debugger einleiten";
Blockly.Msg.SHORTCUT_MULTISIM = "Shift + G: Mehrfachrobotersimulation";
Blockly.Msg.SHORTCUT_OPEN_SIM = "Ctrl + G: Öffnen Sie das Simulationsfenster";
Blockly.Msg.SHORTCUT_RUN = "Ctrl + R: Führen Sie das Programm aus";
Blockly.Msg.SHORTCUT_SAVE = "Ctrl + S: Speichern Sie das Programm in der Datenbank auf dem Server";
Blockly.Msg.SHORTCUT_SAVEAS = "Shift + S: Speichern Sie das Programm oder die Konfiguration unter einem neuen Namen auf dem Server";
Blockly.Msg.SHORTCUT_SOURCE_CODE = "Ctrl + Z: Zeige den Quellcode";
Blockly.Msg.SHORTCUT_VIEW_PROGRAM = "Ctrl + M: Alle Programme anzeigen";
