...
Blockly.Msg.LOGIC_COLOUR_COMPARE_TOOLTIP = "Dieser Block vergleicht zwei Farben auf der Grundlage ihrer Farbtonwerte unter Berücksichtigung des angegebenen Toleranzbereichs [0°-360°].";
...
Blockly.Msg.SENSOR_CAMERA_BALL_GETSAMPLE_TOOLTIP = "Gibt eine Liste [x, y, Durchmesser] zurück, die Informationen über einen Ball liefert, der der in der Konfiguration festgelegten Farbe entspricht. Wenn kein Ball gefunden wird, wird eine Liste von [-1, -1, -1] zurückgegeben.";
Blockly.Msg.SENSOR_CAMERA_COLOUR_GETSAMPLE_TOOLTIP = "Gibt die durchschnittliche Farbe des angegebenen Kamerabereichs (Konfiguration) zurück.";
...
Blockly.Msg.SENSOR_CAMERA_MOTION_GETSAMPLE_TOOLTIP = "Gibt einen booleschen Wert (wahr oder falsch) zurück, der angibt, ob eine festgelegte Anzahl von Pixeländerungen, wie in der Konfiguration definiert, aufgetreten ist.";
Blockly.Msg.SENSOR_CAMERA_NUMBERLINES_GETSAMPLE_TOOLTIP = "Gibt die Anzahl der von der Kamera erkannten Linien zurück (bis zu 4).";
...
Blockly.Msg.SENSOR_IMU_TOOLTIP = "Block für die Inertiale Messeinheit (IMU)";
