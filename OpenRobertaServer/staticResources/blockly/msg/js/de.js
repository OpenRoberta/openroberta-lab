...
Blockly.Msg.ACTIVITY_TOOLTIP = "XXX";
...
Blockly.Msg.KEY_ISPRESSEDANDRELEASED_TOOLTIP = "Is the specific key (button of the brick) pressed and released?";  // untranslated
Blockly.Msg.KEY_ISPRESSED_TOOLTIP = "Is the specific key (button of the brick) pressed?";  // untranslated
...
Blockly.Msg.MOTORDIFF_TURN_FOR_TOOLTIP = "XXX";
...
Blockly.Msg.MOTOR_ON_FOR_TOOLTIP = "Startet Motor und stoppt Motor nach Ausführung von Drehungen (kompletten oder nach Gradangaben).";
...
Blockly.Msg.START_ACTIVITY_TOOLTIP = "XXX";
...
Blockly.Msg.WAIT_FOR_TOOLTIP = "Block wartet auf Sensorwerte.";
Blockly.Msg.WAIT_OR = "oder warte bis";
Blockly.Msg.WAIT_TOOLTIP = "Block wartet bis eine Bedingung wahr wird.";
Blockly.Msg.YES = "ja";
