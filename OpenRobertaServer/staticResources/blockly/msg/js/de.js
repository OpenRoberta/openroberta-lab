...
Blockly.Msg.MESSAGE_PROGRAM_COMPILING = "Das Programm wird kompiliert";
Blockly.Msg.MESSAGE_PROGRAM_DELETED = "Du hast das Programm »$« gelöscht.";
Blockly.Msg.MESSAGE_PROGRAM_FLASHED = "Das Programm ist geflasht";
Blockly.Msg.MESSAGE_PROGRAM_FLASHING = "Das Programm wird geflasht, warten Sie bitte";
...
Blockly.Msg.NAO_ACCELEROMETER_TOOLTIP = "Erhalte den aktuellen Wert des Accelerometers.";
Blockly.Msg.NAO_ANIMATION_TOOLTIP = "Führe die ausgewählte Animation aus.";
Blockly.Msg.NAO_ANSWER = "Antwort";
Blockly.Msg.NAO_APPLYPOSTURE = "Bewege zu Haltung";
Blockly.Msg.NAO_APPLYPOSTURE_TOOLTIP = "Der Roboter nimmt die ausgewählte Haltung ein.";
...
Blockly.Msg.NAO_DETECTFACE_TOOLTIP = "Erkenne ein Gesicht, das vorher gelernt wurde.";
...
Blockly.Msg.NAO_FORGETFACE_TOOLTIP = "Vergesse ein vorher gelerntes Gesicht.";
...
Blockly.Msg.NAO_FSR_TOOLTIP = "Erhalten den aktuellen Wert der Kraftsensoren.";
Blockly.Msg.NAO_GETCURRENT_TOOLTIP = "Erhalte den elektrischen Strom der durch das ausgewählte Gelenk fließt.";
Blockly.Msg.NAO_GETLANGUAGE = "gib Sprache";
Blockly.Msg.NAO_GETLANGUAGE_TOOLTIP = "Erhalte die eingestellte Sprache.";
Blockly.Msg.NAO_GETVOLUME_TOOLTIP = "Erhalte die Lautstärke.";
Blockly.Msg.NAO_GYROMETER = "Gyroskop";
Blockly.Msg.NAO_GYROMETER_TOOLTIP = "Erhalte den aktuellen Wert des Gyrometers.";
Blockly.Msg.NAO_HAND = "Hand";
Blockly.Msg.NAO_HAND_TOOLTIP = "Öffne/Schließe eine Hand.";
...
Blockly.Msg.NAO_LEARNFACE_TOOLTIP = "Lerne und speichere ein Gesicht unter dem angegebenen Namen.";
Blockly.Msg.NAO_LED = "LED";
Blockly.Msg.NAO_LEDOFF_TOOLTIP = "Schalte die LEDs aus.";
Blockly.Msg.NAO_LEDRESET_TOOLTIP = "Setze die LEDs zurück.";
...
Blockly.Msg.NAO_LED_TOOLTIP = "Setze die Farbe von einer Gruppe von LEDs.";
Blockly.Msg.NAO_LOOKAT = "Schaue auf";
Blockly.Msg.NAO_MODE_ACTIVE = "aktiv";
Blockly.Msg.NAO_MODE_REST = "ruhend";
Blockly.Msg.NAO_MODE_SIT = "sitzen";
Blockly.Msg.NAO_MODE_TOOLTIP = "Aktiviert die Motoren des Roboters und lässt ihn aufstehen, oder lässt den Roboter hinsetzen und schaltet die Motoren ab.";
Blockly.Msg.NAO_MOVE = "Bewege";
Blockly.Msg.NAO_MOVEJOINT_TOOLTIP = "Bewege ein einzelnes Gelenk.";
Blockly.Msg.NAO_NAOMARK = "Detektiere NAO Marker";
Blockly.Msg.NAO_NAOMARK_TOOLTIP = "Erhalte die Nummer einer erkannten NAOMark.";
...
Blockly.Msg.NAO_PLAYFILE_TOOLTIP = "Spiele eine Audiodatei vom Roboter ab.";
Blockly.Msg.NAO_PLAY_FILE = "Spiele Datei";
Blockly.Msg.NAO_POINTAT = "Zeige auf";
Blockly.Msg.NAO_POINTLOOKAT_TOOLTIP = "Der Roboter zeigt oder schaut zu der angegebenen Position.";
...
Blockly.Msg.NAO_RANDOMEYES_TOOLTIP = "Die Farbe der Augen wird zufällig für die angegebene Zeit geändert.";
Blockly.Msg.NAO_RASTA = "rasta";
Blockly.Msg.NAO_RASTA_TOOLTIP = "Die Farbe der Augen wird abwechselnd grün, gelb und rot gefärbt.";
Blockly.Msg.NAO_RECOGNIZEDWORD = "erkanntes Wort";
Blockly.Msg.NAO_RECOGNIZEDWORD_TOOLTIP = "Erhalte das letzte Wort, das der Roboter verstanden hat.";
Blockly.Msg.NAO_RECOGNIZEWORDOR = "or recognize word";  // untranslated
Blockly.Msg.NAO_RECORDVIDEO = "Nehme Video auf mit";
Blockly.Msg.NAO_RECORDVIDEO_TOOLTIP = "Nehme ein Video auf und speichere es auf dem Roboter.";
Blockly.Msg.NAO_RELATIVE = "relativ";
Blockly.Msg.NAO_RESOLUTION = "Auflösung";
Blockly.Msg.NAO_SAY = "Sage";
Blockly.Msg.NAO_SAY_TOOLTIP = "NAO sagt den eingegebenen Text.";
Blockly.Msg.NAO_SETINTENSITY_TOOLTIP = "Bestimme die Intensität einer Gruppe von LEDs.";
Blockly.Msg.NAO_SETLANGUAGE = "Setze Sprache";
Blockly.Msg.NAO_SETLANGUAGE_TOOLTIP = "Setze die Sprache.";
Blockly.Msg.NAO_SETVOLUME_TOOLTIP = "Setze die Lautstärke.";
Blockly.Msg.NAO_STIFFNESS = "Steifigkeit von";
Blockly.Msg.NAO_STIFFNESS_TOOLTIP = "Die Steifigkeit des gewählten Körperteils ein- oder ausschalten.";
Blockly.Msg.NAO_STOP = "Stoppe Bewegung";
Blockly.Msg.NAO_STOP_TOOLTIP = "Jegliche Bewegung des Roboters wird gestoppt.";
Blockly.Msg.NAO_TAI_CHI = "Tai Chi";
Blockly.Msg.NAO_TAKEPICTURE = "Mache Foto mit";
Blockly.Msg.NAO_TAKEPICTURE_TOOLTIP = "Mache ein Bild und speichere es auf dem NAO.";
Blockly.Msg.NAO_TOUCHSENSOR_TOOLTIP = "Wird wahr, wenn der Berührungssensor berührt wird.";
...
Blockly.Msg.NAO_TURN_TOOLTIP = "Der NAO dreht sich um die angegebene Gradzahl.";
Blockly.Msg.NAO_VGA = "640*480";
Blockly.Msg.NAO_WALK = "Gehe";
Blockly.Msg.NAO_WALKTO = "Gehe zu";
Blockly.Msg.NAO_WALKTO_TOOLTIP = "NAO geht zu der angegebenen Position.";
Blockly.Msg.NAO_WALK_TOOLTIP = "NAO geht eine bestimmte Distanz.";
