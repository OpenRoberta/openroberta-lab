...
Blockly.Msg.POPUP_TEXT_STARTUP_MESSAGE = "Das musst du über Open Roberta Lab wissen:<ul class='icon'><li class='document-text'>hier kann man EV3 Roboter programmieren</li><li class='Roberta'>dein Roboter braucht ein spezielles Betriebssystem</li><li class='wi-fi'>dein Roboter braucht WLAN</li><li class='arrow-right-thick'>Schau in die Hilfe wenn du nicht weißt, ob dein Roboter das alles schon kann ... <a target='_blank' href='https://mp-devel.iais.fraunhofer.de/wiki/display/ORInfo/Open+Roberta+Hilfe'>mehr</a></li></ul><br /><p>Wen es interessiert:</p>Version beta 1.1.0<ul class='NonIcon'><li>Funktionen und Variablen neu</li><li>beliebig konfigurierbarer EV3 Roboter</li><li>Update der Firmware des Roboters über die Anwendung</li></ul>";
