...
Blockly.Msg.POPUP_ABOUT_TEXT = "Open Roberta Lab — это облачная графическая среда программирования, которая позволяет детям и молодым людям программировать роботов и микроконтроллеры без технических барьеров. Платформа имеет открытый исходный код: её исходный код общедоступен, а вклад и предложения сообщества приветствуются.";
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "Roberta Education gGmbH управляет Open Roberta Lab на серверах в Германии и непрерывно развивает платформу. Изменения исходного кода проходят проверку и тестирование перед публикацией.";
