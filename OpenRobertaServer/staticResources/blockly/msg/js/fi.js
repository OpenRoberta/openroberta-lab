...
Blockly.Msg.DATATABLE_RELATIONS = "relations";  // untranslated
...
Blockly.Msg.MOTORDIFF_ON_FOR_HELP = "The robot drives forwards until it covers the given distance. The speed can be set in the field speed.";  // untranslated
...
Blockly.Msg.MOTORDIFF_TURN_FOR_HELP = "The robot will rotate untl it reaches the degrees set by the user.";  // untranslated
...
Blockly.Msg.MOTORDIFF_TURN_HELP = "The robot will rotate until it is not stopped or it is used different block for driving. The speed can be set in the field speed.";  // untranslated
