...
Blockly.Msg.POPUP_ABOUT_TEXT = "Open Roberta Lab on pilvipohjainen graafinen ohjelmointiympäristö, jossa lapset ja nuoret voivat ohjelmoida robotteja ja mikrokontrollereita ilman teknisiä esteitä. Alusta on avointa lähdekoodia: sen lähdekoodi on julkisesti saatavilla, ja yhteisön osallistuminen ja ehdotukset ovat tervetulleita.";
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "Roberta Education gGmbH ylläpitää Open Roberta Labia Saksassa sijaitsevilla palvelimilla ja kehittää alustaa jatkuvasti. Lähdekoodin muutokset tarkistetaan ja testataan ennen niiden julkaisemista.";
