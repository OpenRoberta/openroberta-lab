...
Blockly.Msg.POPUP_ABOUT_TEXT = "Open Roberta Lab je cloudové grafické programovací prostředí, které umožňuje dětem a mladým lidem programovat roboty a mikrokontroléry bez technických překážek. Platforma je open source: její zdrojový kód je veřejně dostupný a příspěvky a podněty komunity jsou vítány.";
Blockly.Msg.POPUP_ABOUT_TEXT_EDUCATION = "Společnost Roberta Education gGmbH provozuje Open Roberta Lab na serverech v Německu a platformu průběžně rozvíjí. Změny zdrojového kódu jsou před vydáním kontrolovány a testovány.";
