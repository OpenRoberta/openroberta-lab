...
Blockly.Msg.ORA_ROBOT_PUSH_STOP_ERROR = "An error occured while terminating your program »$«.";
Blockly.Msg.ORA_ROBOT_PUSH_STOP_SUCCESS = "Your program »$« will be terminated.";
...
Blockly.Msg.SENSOR_DETECTMARK_GETSAMPLE_TOOLTIP_NAO = "Returns one or an array of IDs (number) of the last detected NAO Mark(s). If no marks are detected, -1 or an array consisting of 1 element with value -1 is returned. For a list of NAO marks with corresponding numbers refer to the wiki.";
