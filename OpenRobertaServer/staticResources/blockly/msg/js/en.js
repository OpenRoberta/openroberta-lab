...
Blockly.Msg.SENSOR_CAMERA_BALL_GETSAMPLE_TOOLTIP = "Returns a list [x, y, diameter] representing information about a ball matching the color set in the configuration. If no ball is found, returns a list of [-1, -1, -1].";
Blockly.Msg.SENSOR_CAMERA_COLOUR_GETSAMPLE_TOOLTIP = "Returns the average color of the specified camera area (configuration).";
...
Blockly.Msg.SENSOR_CAMERA_MOTION_GETSAMPLE_TOOLTIP = "Returns a boolean (true or false) indicating whether a specified amount of pixel change, as defined by the sensitivity in the configuration, has occurred.";
Blockly.Msg.SENSOR_CAMERA_NUMBERLINES_GETSAMPLE_TOOLTIP = "Returns the number of lines detected by the camera (up to 4).";
...
Blockly.Msg.SENSOR_IMU_TOOLTIP = "Represents an Inertial Measurement Unit (IMU)";
...
Blockly.Msg.SENSOR_LOGOTOUCH = "logo sensor";
