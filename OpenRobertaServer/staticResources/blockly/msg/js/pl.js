...
Blockly.Msg.SHORTCUT_ASSERT = "Ctrl + 3: Assert and expression";  // untranslated
Blockly.Msg.SHORTCUT_EDITOR = "Shift + Z: Show the source code editor";  // untranslated
Blockly.Msg.SHORTCUT_EVALUATE = "Ctrl + 4: Evaluate expression";  // untranslated
Blockly.Msg.SHORTCUT_EXPORT = "Ctrl + E: Export the program";  // untranslated
Blockly.Msg.SHORTCUT_GYROSENSOR_READING = "Ctrl + 5: Gets gyrosensor reading";  // untranslated
Blockly.Msg.SHORTCUT_IMPORT = "Ctrl + I: Import the program";  // untranslated
Blockly.Msg.SHORTCUT_IMPORTNEPO = "Ctrl + 1: Import Nepo code to compile";  // untranslated
Blockly.Msg.SHORTCUT_INITIATE_DEBUGGER = "Ctrl + 2: Initiate Debugger";  // untranslated
Blockly.Msg.SHORTCUT_MULTISIM = "Shift + G: Multiple robot simulation";  // untranslated
Blockly.Msg.SHORTCUT_OPEN_SIM = "Ctrl + G: Open the simulation window";  // untranslated
Blockly.Msg.SHORTCUT_RUN = "Ctrl + R: Run the program";  // untranslated
Blockly.Msg.SHORTCUT_SAVE = "Ctrl + S: Save the program in the database on server";  // untranslated
Blockly.Msg.SHORTCUT_SAVEAS = "Shift + S: Save the program or configuration in the server with a new name";  // untranslated
Blockly.Msg.SHORTCUT_SOURCE_CODE = "Ctrl + Z: Show the source code";  // untranslated
Blockly.Msg.SHORTCUT_VIEW_PROGRAM = "Ctrl + M: Viewing all programs";  // untranslated
