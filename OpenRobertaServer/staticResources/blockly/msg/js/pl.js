...
Blockly.Msg.ORA_GROUP_ADD_MEMBER_ERROR_LIMIT_REACHED = "You reached the member limit of the user group. You can not have more than 99 members in one user group.";  // untranslated
Blockly.Msg.ORA_GROUP_ADD_MEMBER_ERROR_SMALLER_THAN_ONE = "You must enter a number that is bigger or equals 1.";  // untranslated
...
Blockly.Msg.USERGROUP_ADD_MEMBERS_COUNT = "Number of additional members";  // untranslated
Blockly.Msg.USERGROUP_CREATE = "Create new user group";  // untranslated
Blockly.Msg.USERGROUP_CREATE_INITIAL_MEMBERS = "Number of initial members";  // untranslated
