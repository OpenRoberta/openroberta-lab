...
Blockly.Msg.MOTOR_BIG_HELP = 'The big motor is a so-called servomotor. With it you can control the rotational speed and the acceleration, since it has a built-in rotation sensor. For programming with the »driving« blocks it is important to know how it is mounted on the robot.';
...
Blockly.Msg.MOTOR_MIDDLE_HELP = 'The middle motor is a so-called servomotor. With it you can control the rotational speed and the acceleration, since it has a built-in rotation sensor. For the programming blocks it is important to know it which direction it should rotate.';
...
Blockly.Msg.DATATABLE_SHARED_FOR = 'Right';
...
Blockly.Msg.DATATABLE_RELATIONS = 'relations';
