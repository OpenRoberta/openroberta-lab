...
Blockly.Msg.POPUP_TEXT_STARTUP_MESSAGE = 'Three things you should know before starting:<ul class="icon"><li class="document-text">here you can program EV3 robots </li><li class="Roberta">your robot needs a special system <a target="_blank" href="https://mp-devel.iais.fraunhofer.de/wiki/x/RIAd">check!</a></li><li class="wi-fi">your robot needs wi-fi or a USB program</li><li class="arrow-right-thick">if you are not sure, please have a look at the help pages ... <a target="_blank" href="https://mp-devel.iais.fraunhofer.de/wiki/x/A4AM">more</a></li></ul><br /><p>What is new?</p>Version beta 1.2.0<ul class="NonIcon" style="font-size:small"><li>blocks to send and receive messages</li><li>connect your robot via USB</li><li>rotate motors backwards with negative speed</li><li>fixed many more bugs</li></ul>'
