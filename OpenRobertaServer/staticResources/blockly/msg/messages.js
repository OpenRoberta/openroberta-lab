...
Blockly.Msg.POPUP_TEXT_STARTUP_MESSAGE = 'Three things you should know before starting:<ul class="icon"><li class="document-text">here you can program EV3 robots </li><li class="Roberta">your robot needs a special system</li><li class="wi-fi">your robot needs wi-fi</li><li class="arrow-right-thick">if you are not sure, please have a look at the help pages ... <a target="_blank" href="https://mp-devel.iais.fraunhofer.de/wiki/display/ORInfo/Open+Roberta+Hilfe">more</a></li></ul><br /><p>If you are interested:</p>Version beta 1.1.0<ul class="NonIcon"><li>Functions and variables</li><li>free EV3 robot configuration</li><li>Update firmware via Open Roberta Lab</li></ul>'
