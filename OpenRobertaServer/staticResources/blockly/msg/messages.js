...
Blockly.Msg.MOTORDIFF_ON_FOR_HELP = "The robot drives forwards as long as it isn't stopped by another driving block. The speed can be set in the Speed field. When the program ends the motors will stop automatically.";
...
Blockly.Msg.MOTORDIFF_TURN_HELP = "Your robot turns as long as it isn't stopped by another driving block. The speed can be set in the Speed field.";
...
Blockly.Msg.ORA_TOOLBOX_LOAD_ERROR_NOT_FOUND = "The selected NEPO-Blocks couldn't be found in the database.";
Blockly.Msg.ORA_TOOLBOX_ERROR_ID_INVALID = 'Toolbox name is not a valid identifier.';
Blockly.Msg.ORA_TOOLBOX_GET_ONE_ERROR_NOT_FOUND = "The toolbox couldn't be found in the database.";
...
Blockly.Msg.ORA_CONFIGURATION_GET_ONE_ERROR_NOT_FOUND = "The robot configuration couldn't be found in the database.";
...
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_NOT_FOUND = "The program couldn't be transformed into the robots programming language.";
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_CONFIGURATION_NOT_FOUND = "The robot configuration couldn't be found on the server.";
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_TRANSFORM_FAILED = "The program couldn't be transformed into the robots programming language.";
...
Blockly.Msg.ORA_OWNER_DOES_NOT_EXIST = "The owner doesn't exist.";
Blockly.Msg.ORA_PROGRAM_TO_SHARE_DOES_NOT_EXIST = 'The program that you would like to share does not exist.';
Blockly.Msg.ORA_USER_TO_SHARE_DOES_NOT_EXIST = "The user with which you would like to share the program doesn't exist. <br />Try it again!";
