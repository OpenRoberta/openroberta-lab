...
Blockly.Msg.MENU_PROGRAM = 'Program';
...
Blockly.Msg.MENU_NEPO = 'Nepo';
Blockly.Msg.MENU_BEGINNER = 'Beginner';
Blockly.Msg.MENU_EXPERT = 'Expert';
Blockly.Msg.MENU_ROBOT = 'Robot';
Blockly.Msg.MENU_DEFAULT_CONFIGURATION = 'default configuration';
Blockly.Msg.MENU_CONNECTION = 'Connection';
...
Blockly.Msg.MESSAGE_USER_CREATED = 'The user was successfully created';
...
Blockly.Msg.MESSAGE_SET_TOKEN_ERROR = 'The token for the roboter could not be set.';
Blockly.Msg.MESSAGE_SET_TOKEN = 'You have to fill in the token.';
Blockly.Msg.MESSAGE_NAME_ERROR = 'You have to choose another name.';
Blockly.Msg.MESSAGE_EMPTY_NAME = 'Please fill in a name.';
Blockly.Msg.MESSAGE_PROGRAM_NOT_CHECKABLE = 'Your program can not be checked.';
...
Blockly.Msg.HINT_TOOLBOX = 'Toolbox';
