...
Blockly.Msg.SENSOR_KEY = 'brick button';
...
Blockly.Msg.MENU_START_PROGRAMMING = 'start programming';
...
Blockly.Msg.POPUP_DO_LOGIN = 'Login';
Blockly.Msg.POPUP_REGISTER_USER = 'Register user';
Blockly.Msg.POPUP_NAME = 'Name';
Blockly.Msg.POPUP_EMAIL = 'E-Mail';
Blockly.Msg.POPUP_DELETE_USER = 'Delete user';
Blockly.Msg.POPUP_ATTACH_PROGRAM = 'Attach program';
Blockly.Msg.POPUP_SAVE_PROGRAM = 'Save program';
Blockly.Msg.POPUP_SHARE = 'Share';
Blockly.Msg.POPUP_SHARE_WITH = 'Share with';
Blockly.Msg.POPUP_SAVE_CONFIGURATION = 'Save configuration';
Blockly.Msg.POPUP_SET_TOKEN = 'Set token';
...
Blockly.Msg.COMMAND_INVALID = 'Invalid Javascript-command';
Blockly.Msg.CONFIGURATION_ERROR_ID_INVALID = 'Configuration name is not a valid identifier.';
Blockly.Msg.CONFIGURATION_GET_ONE_ERROR_NOT_FOUND = 'Configuration not loaded.';
Blockly.Msg.CONFIGURATION_GET_ONE_SUCCESS = 'Configuration loaded';
Blockly.Msg.CONFIGURATION_SAVE_SUCCESS = 'Configuration saved';
Blockly.Msg.CONFIGURATION_SAVE_ERROR_NOT_SAVED_TO_DB = 'Error while saving the configuration.';
Blockly.Msg.CONFIGURATION_GET_ALL_SUCCESS = 'Configuration loaded';
Blockly.Msg.CONFIGURATION_DELETE_SUCCESS = 'Configuration deleted';
Blockly.Msg.CONFIGURATION_DELETE_ERROR = 'Error while deleting the configuration.';
Blockly.Msg.PROGRAM_ERROR_ID_INVALID = 'Program name is not a valid identifier.';
Blockly.Msg.PROGRAM_GET_ONE_ERROR_NOT_FOUND = 'Program not found.';
Blockly.Msg.PROGRAM_GET_ONE_ERROR_NOT_LOGGED_IN = 'User not logged in.';
...
Blockly.Msg.PROGRAM_GET_ALL_SUCCESS = 'Programs loaded';
...
Blockly.Msg.USER_DELETE_SUCCESS = 'The user was successfully deleted';
Blockly.Msg.USER_DELETE_ERROR_NOT_DELETED_IN_DB = 'Error while deleting user in database.';
Blockly.Msg.USER_DELETE_ERROR_ID_NOT_FOUND = 'Error while deleting user.';
Blockly.Msg.USER_GET_ALL_SUCCESS = 'Users loaded';
Blockly.Msg.COMPILERWORKFLOW_ERROR_PROGRAM_NOT_FOUND = 'The program was nort found.';
Blockly.Msg.COMPILERWORKFLOW_ERROR_CONFIGURATION_NOT_FOUND = 'The configuration was nort found.';
Blockly.Msg.COMPILERWORKFLOW_ERROR_PROGRAM_TRANSFORM_FAILED = 'The program could not be tranformed.';
Blockly.Msg.COMPILERWORKFLOW_ERROR_CONFIGURATION_TRANSFORM_FAILED = 'The configuration could not be tranformed.';
Blockly.Msg.COMPILERWORKFLOW_ERROR_PROGRAM_STORE_FAILED = 'The program could not be saved.';
Blockly.Msg.COMPILERWORKFLOW_ERROR_PROGRAM_COMPILE_FAILED = 'The program could not be compiled.';
Blockly.Msg.ROBOT_NOT_WAITING = 'Robot doent wait for a run command.';
Blockly.Msg.ROBOT_PUSH_RUN = 'Robot waited and now the jar is pushed to the robot';
Blockly.Msg.HINT_LANGUAGE_GERMAN = 'German';
Blockly.Msg.HINT_LANGUAGE_ENGLISH = 'English';
Blockly.Msg.HINT_ROBOT_STATE = 'Robot state';
Blockly.Msg.HINT_USER = 'User';
Blockly.Msg.HINT_PROGRAM = 'Program';
Blockly.Msg.HINT_CONFIGURATION = 'Configuration';
...
Blockly.Msg.ROBOT_NOT_WAITING = 'Robot not waiting';     
Blockly.Msg.ROBOT_WAITING = 'Robot waiting'; 
