...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            var c = 0 == h[1].length ? 0 : parseInt(h[1], 10), n = 0 == k[1].length ? 0 : parseInt(k[1], 10),
...
goog.math.Rect.difference = function (a, b) {
    ...
    var c = [], d = a.top, e = a.height, f = a.left + a.width, g = a.top + a.height, h = b.left + b.width,
        k = b.top + b.height;
...
goog.events.handleBrowserEvent_ = function (a, b) {
    ...
    if (!goog.events.BrowserFeature.HAS_W3C_EVENT_SUPPORT) {
        var d = b || goog.getObjectByName("window.event"), e = new goog.events.BrowserEvent(d, this), f = !0;
...
goog.ui.ControlRenderer.prototype.decorate = function (a, b) {
    ...
    g && h && !m && !k || goog.dom.classlist.set(b, n.join(" "));
    return b
};
...
goog.iter.permutations = function (a, b) {
    var c = goog.iter.toArray(a), d = goog.isNumber(b) ? b : c.length, c = goog.array.repeat(c, d),
...
goog.iter.combinations = function (a, b) {
    ...
    var d = goog.iter.toArray(a), e = goog.iter.range(d.length), e = goog.iter.permutations(e, b),
...
goog.iter.combinationsWithReplacement = function (a, b) {
    ...
    var d = goog.iter.toArray(a), e = goog.array.range(d.length), e = goog.array.repeat(e, b),
        e = goog.iter.product.apply(void 0, e), f = goog.iter.filter(e, function (a) {
            return goog.array.isSorted(a)
        }), e = new goog.iter.Iterator;
    e.next = function () {
        return goog.array.map(f.next(), c)
...
goog.ui.tree.BaseNode.prototype.toSafeHtml = function () {
    var a = this.getTree(),
        ...
        a = this.getExpanded() && this.hasChildren(), b = {"class": b, style: this.getLineStyle()}, c = [];
...
goog.structs.Trie.prototype.remove = function (a) {
    ...
    a = c.value_;
    for (delete c.value_; 0 < d.length;)if (b = d.pop(), c = b[0], b = b[1], c.childNodes_[b].isEmpty()) delete c.childNodes_[b]; else break;
    return a
};
...
Blockly.Workspace = function (a) {
    ...
    this.description = this.version = this.device = "";
    this.topBlocks_ = [];
    this.listeners_ = [];
    this.undoStack_ = [];
    this.redoStack_ = [];
...
Blockly.Workspace.prototype.removeChangeListener = function (a) {
    a = this.listeners_.indexOf(a);
    -1 != a && this.listeners_.splice(a, 1)
};
...
Blockly.Workspace.prototype.setDevice = function (a) {
    this.device = a;
    this.toolbox_ && (this.toolbox_.flyout_.workspace_.device = a);
    this.flyout_ && (this.flyout_.workspace_.device = a)
};
Blockly.Workspace.prototype.setVersion = function (a) {
    this.version = a
};
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    b ? (this.resizeGroup_ = Blockly.createSvgElement("g", {"class": Blockly.RTL ? "blocklyResizeSW" : "blocklyResizeSE"}), Blockly.createSvgElement("rect",
        {
            x: -15,
            y: -15,
            width: 27,
            height: 27,
            "fill-opacity": 0
        }, this.resizeGroup_), Blockly.createSvgElement("path", {
        ...
        this.resizeGroup_), this.bubbleGroup_.appendChild(this.resizeGroup_)) : this.resizeGroup_ = null;
...
Blockly.Bubble.prototype.bubbleMouseDown_ = function (a) {
    ...
    Blockly.isRightButton(a) ? a.stopPropagation() : Blockly.isTargetInput_(a) || (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED), this.workspace_.startDrag(a, new goog.math.Coordinate(this.workspace_.RTL ? -this.relativeLeft_ : this.relativeLeft_, this.relativeTop_)), Blockly.Bubble.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", this, Blockly.Bubble.unbindDragEvents_), Blockly.Bubble.onMouseMoveWrapper_ =
            Blockly.bindEvent_(document, "mousemove", this, this.bubbleMouseMove_), Blockly.hideChaff(), a.stopPropagation())
};
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), n = Math.cos(h), m = this.getBubbleSize(),
            h = (m.width + m.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, m.width, m.height) / 2,
            m = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b +
                m * d, e = c + m * e, m = b + h * n, l = c + h * k, b = b - h * n, c = c - h * k,
...
Blockly.Icon.prototype.createIcon = function () {
    this.iconGroup_ || (this.iconGroup_ = Blockly.createSvgElement("g", {"class": "blocklyIconGroup"}, null), this.drawIcon_(this.iconGroup_), this.block_.getSvgRoot().appendChild(this.iconGroup_), Blockly.bindEvent_(this.iconGroup_, "mouseup", this, this.iconClick_), this.updateEditable())
};
...
Blockly.Icon.prototype.computeIconLocation = function () {
    var a = this.block_.getRelativeToSurfaceXY(), b = Blockly.getRelativeXY_(this.iconGroup_),
...
Blockly.Comment.prototype.drawIcon_ = function (a) {
    ...
    Blockly.createSvgElement("path", {
            ...
            d: "M19 6h-13c-1.65 0-3 1.35-3 3v7c0 1.65 1.35 3 3 3h1v3l3-3h9c1.65 0 3-1.35 3-3v-7c0-1.65-1.35-3-3-3zm1 10c0 .542-.458 1-1 1h-13c-.542 0-1-.458-1-1v-7c0-.542.458-1 1-1h13c.542 0 1 .458 1 1v7zM7 14.5c-1.104 0-2-.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0 -1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1zM11.5 14.5c-1.104 0-2 -.896-2-2s.896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1zM16 14.5c-1.104 0-2-.896-2-2s .896-2 2-2 2 .896 2 2-.896 2-2 2zm0-3c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1z",
...
Blockly.Comment.prototype.createEditor_ = function () {
    ...
    Blockly.bindEvent_(b,
        "mouseup", this, this.textareaFocus_);
...
Blockly.Connection.prototype.connect_ = function (a) {
    ...
    if (b.isConnected()) {
        ...
        if (e.isShadow()) f = Blockly.Xml.blockToDom(e), e.dispose(), e = null; else if (b.type == Blockly.INPUT_VALUE) {
            ...
            for (g = d; g.nextConnection;)if (g.nextConnection.isConnected()) g = g.getNextBlock(); else {
...
Blockly.Connection.prototype.respawnShadow_ = function () {
    ...
    if (a.workspace && b && Blockly.Events.recordUndo) {
        ...
        if (a.outputConnection) this.connect(a.outputConnection); else if (a.previousConnection) this.connect(a.previousConnection); else throw"Child block does not have output or previous statement.";
        return a
    }
    return null
};
...
Blockly.Connection.prototype.checkType_ = function (a) {
    if (!this.check_ || !a.check_)return "declaration_only" == this.check_ && !a.check_ || !this.check_ && "declaration_only" == a.check_ || "ardu" == this.check_ && !a.check_ || !this.check_ && "ardu" == a.check_ ? !1 : !0;
...
Blockly.Connection.prototype.setCheck = function (a) {
    a ? (goog.isArray(a) || (a = [a]), this.check_ = a, this.isConnected() && !this.checkType_(this.targetConnection) && ((this.isSuperior() ? this.targetBlock() : this.sourceBlock_).unplug(), this.sourceBlock_.bumpNeighbours_()), this.sourceBlock_.rendered && this.sourceBlock_.render()) : this.check_ = null;
    return this
};
...
Blockly.Tooltip.wrap_ = function (a, b) {
    ...
    do {
        var f = d;
        var g = a;
        for (var h = [], k = c.length / e, n = 1, d = 0; d < c.length - 1; d++)n < (d + 1.5) / k ? (n++, h[d] = !0) : h[d] = !1;
...
Blockly.Options = function (a) {
    ...
    l = "end" === l ? !1 : !0;
    l = m ? l ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : l ==
    ...
    this.languageTree = h;
    this.gridOptions =
        Blockly.Options.parseGridOptions_(a);
    this.zoomOptions = Blockly.Options.parseZoomOptions_(a);
    this.toolboxPosition = l;
    this.checkInTask = a.checkInTask || !1;
    this.variableDeclaration = !!a.variableDeclaration;
    this.robControls = !!a.robControls
};
...
Blockly.ScrollbarPair.prototype.set = function (a, b) {
    var c = {}, d = a * this.hScroll.ratio_, e = b * this.vScroll.ratio_,
...
Blockly.Scrollbar.prototype.onMouseDownBar_ = function (a) {
    ...
    if (Blockly.isRightButton(a)) a.stopPropagation(); else {
        var b = Blockly.mouseToSvg(a, this.workspace_.getParentSvg()), b = this.horizontal_ ? b.x : b.y,
            c = Blockly.getSvgXY_(this.svgKnob_, this.workspace_), c = this.horizontal_ ? c.x : c.y,
            d = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "width" : "height")),
            e = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "x" : "y")), f = .95 * d;
        b <= c ? e -= f : b >= c + d && (e += f);
...
Blockly.Scrollbar.prototype.constrainKnob_ = function (a) {
    if (0 >= a || isNaN(a)) a = 0; else {
        var b = this.horizontal_ ? "width" : "height", c = parseFloat(this.svgBackground_.getAttribute(b)),
...
Blockly.Scrollbar.prototype.onScroll_ = function () {
    var a = parseFloat(this.svgKnob_.getAttribute(this.horizontal_ ? "x" : "y")),
        b = parseFloat(this.svgBackground_.getAttribute(this.horizontal_ ? "width" : "height")), a = a / b;
    if (isNaN(a) || !b) a = 0;
    b = {};
...
Blockly.Trashcan.prototype.createDom = function () {
    this.svgGroup_ = Blockly.createSvgElement("g", {"class": "blocklyButtons", id: "blocklyTrashcan"}, null);
    Blockly.createSvgElement("rect", {
    ...
    this.svgBody_ = Blockly.createSvgElement("path", {"class": "blocklyButtonPath"}, this.svgGroup_);
    ...
    this.svgLid_ = Blockly.createSvgElement("path", {"class": "blocklyButtonPath"}, this.svgGroup_);
...
Blockly.Trashcan.prototype.position = function () {
    var a = this.workspace_.getMetrics();
    a && (this.workspace_.RTL ? (this.left_ = this.MARGIN_SIDE_, a.toolboxPosition == Blockly.TOOLBOX_AT_LEFT && (this.left_ += a.flyoutWidth, this.workspace_.toolbox_ && (this.left_ += a.absoluteLeft))) : (this.left_ = a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_, a.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (this.left_ -= a.flyoutWidth)), this.top_ = a.viewHeight + a.absoluteTop - (this.BODY_HEIGHT_ + this.LID_HEIGHT_) - this.MARGIN_BOTTOM_,
    a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM && (this.top_ -= a.flyoutHeight), this.svgGroup_.setAttribute("transform", "translate(" + this.left_ + "," + this.top_ + ")"))
};
...
Blockly.Trashcan.prototype.animateLid_ = function () {
    ...
    a = goog.math.lerp(.25, .75, this.lidOpen_);
...
Blockly.RobControls = function (a, b) {
    this.workspace_ = a;
    this.zoom_ = b
};
...
Blockly.RobControls.prototype.createDom = function () {
    ...
    if (this.zoom_) {
        this.zoomVisible_ = !1;
        var c = this.createButton_(this.PATH_ZOOM_, 2, 0, "MENU_ZOOM"),
            d = this.createButton_(this.PATH_ZOOMIN_, 2, 0, "MENU_ZOOM_IN"),
            e = this.createButton_(this.PATH_ZOOMRESET_, 2, 1, "MENU_ZOOM_RESET"),
            f = this.createButton_(this.PATH_ZOOMOUT_, 2, 2, "MENU_ZOOM_OUT");
        d.setAttribute("class", "robButtonHidden");
        f.setAttribute("class", "robButtonHidden");
        e.setAttribute("class", "robButtonHidden");
        Blockly.bindEvent_(e, "mousedown", a, function (c) {
            a.setScale(1);
            a.scrollCenter();
            c.stopPropagation();
            c.preventDefault();
        ...
        Blockly.bindEvent_(f, "mousedown", null, function (b) {
            a.zoomCenter(-1);
            b.stopPropagation();
            b.preventDefault()
        });
        Blockly.bindEvent_(c, "mousedown", null, function (a) {
            b.showZoom(!0);
            a.stopPropagation()
        });
        this.zoominSvg = d;
...
Blockly.RobControls.prototype.createButton_ = function (a, b, c, d) {
    b = Blockly.createSvgElement("g", {
        "class": "robButton",
        transform: "translate(" + 50 * b + "," + -50 * c + ")"
    }, this.svgGroup_);
    c = Blockly.createSvgElement("rect", {
        "class": "blocklyButtonBack",
        y: "0",
        rx: "2",
        ry: "2",
    ...
    b.tooltip = d;
    c.tooltip = Blockly.Msg[d];
    Blockly.Tooltip.bindMouseEvents(c);
    b.appendChild(c);
    a = Blockly.createSvgElement("path", {
        "class": "blocklyButtonPath", d: a, transform: "scale(1.5)", "fill-rule": "evenodd", "stroke-width": "0px",
        fill: "#333"
    });
...
Blockly.RobControls.prototype.position = function () {
    var a = this.workspace_.getMetrics();
    a && (this.left_ = this.workspace_.RTL ? this.MARGIN_SIDE_ + Blockly.Scrollbar.scrollbarThickness : a.viewWidth + a.absoluteLeft - this.WIDTH_ - this.MARGIN_SIDE_, this.simVisible_ && (this.left_ += 159), this.top_ = a.viewHeight + a.absoluteTop - this.HEIGHT_ - this.MARGIN_BOTTOM_, this.svgGroup_.setAttribute("transform", "translate(" + this.left_ + "," + this.top_ + ")"))
};
Blockly.RobControls.prototype.disable = function (a) {
    this[a].setAttribute("class", "robButton disabled")
};
Blockly.RobControls.prototype.enable = function (a) {
    this[a].setAttribute("class", "robButton")
};
Blockly.RobControls.prototype.refreshTooltips = function (a) {
    for (var b = 0; b < this.buttons.length; b++) {
        var c = Blockly.Msg[this.buttons[b].tooltip];
        0 <= c.indexOf("$") && (c = c.replace("$", a));
...
Blockly.RobControls.prototype.showZoom = function (a) {
    this.zoom_ && this.zoomVisible_ !== a && (a ? (this.zoom.setAttribute("class", "robButtonHidden"), this.zoominSvg.setAttribute("class", "robButton"), this.zoomoutSvg.setAttribute("class", "robButton"), this.zoomresetSvg.setAttribute("class", "robButton")) : (this.zoom.setAttribute("class", "robButton"), this.zoominSvg.setAttribute("class", "robButtonHidden"), this.zoomoutSvg.setAttribute("class", "robButtonHidden"), this.zoomresetSvg.setAttribute("class", "robButtonHidden")),
        this.zoomVisible_ = a)
};
Blockly.RobControls.prototype.toogleSim = function () {
    this.simVisible_ ? (this.runInSim.setAttribute("class", "robButton runInSim"), this.simStop.setAttribute("class", "robButtonHidden"), this.simVisible_ = !1) : (this.runInSim.setAttribute("class", "robButtonHidden "), this.simStop.setAttribute("class", "robButton simStop"), this.simVisible_ = !0)
};
Blockly.RobControls.prototype.setSimForward = function (a) {
    this.simForwardVisible_ !== a && (this.simForwardVisible_ = a)
};
Blockly.RobControls.prototype.setSimStart = function (a) {
    this.simStartVisible_ !== a && (a ? (this.runInSim.setAttribute("class", "robButton runInSim"), this.simStop.setAttribute("class", "robButtonHidden"), this.simStartVisible_ = !0) : (this.runInSim.setAttribute("class", "robButtonHidden"), this.simStop.setAttribute("class", "robButton simStop"), this.simStartVisible_ = !1))
};
Blockly.RobControls.prototype.dispose = function () {
    this.svgGroup_ && (goog.dom.removeNode(this.svgGroup_), this.svgGroup_ = null);
    this.workspace_ = null
...
Blockly.Xml.workspaceToDom = function (a) {
    for (var b = goog.dom.createDom("block_set"), c = a.getTopBlocks(!0), d = 0, e; e = c[d]; d++) {
        var f = goog.dom.createDom("instance");
        Blockly.Xml.appendlistToDom(f, e);
        e = e.getRelativeToSurfaceXY();
        f.setAttribute("x", Math.round(a.RTL ? width - e.x : e.x));
        f.setAttribute("y", Math.round(e.y));
        b.appendChild(f)
    }
    b.setAttribute("robottype", a.device);
    b.setAttribute("xmlversion", a.version);
    b.setAttribute("description", a.description);
    return b
};
...
Blockly.Xml.blockToDom = function (a, b) {
    var c, d, e = goog.dom.createDom(a.isShadow() ? "shadow" : "block"), f = goog.dom.createDom("repetitions"), g = !1;
    b.push(e);
    e.setAttribute("type", a.type);
    e.setAttribute("id", a.id);
    a.mutationToDom && (d = a.mutationToDom()) && (d.hasChildNodes() || d.hasAttributes()) && (e.appendChild(d), void 0 === d || null == d || -1 === a.type.indexOf("Controls_if") && -1 === a.type.indexOf("Controls_wait_for") && -1 === a.type.indexOf("Controls_wait") || (e.appendChild(f), g = !0));
    d = 0;
    for (var h; h = a.inputList[d]; d++) {
        var k =
            0;
        for (var n; n = h.fieldRow[k]; k++)if (n.name && n.EDITABLE) {
            var m = n.getValue(), l = n.getValue().replace(/,/g, ".");
            isNaN(l) || (m = String(l));
            m = goog.dom.createDom("field", null, m);
            m.setAttribute("name", n.name);
            e.appendChild(m)
        }
    }
    a.mutationToDom && (d = a.mutationToDom()) && void 0 !== d && null != d && "robProcedures_defreturn" == a.type && (e.appendChild(f), g = !0);
    if (d = a.getCommentText()) d = goog.dom.createDom("comment", null, d), "object" == typeof a.comment && (d.setAttribute("pinned", a.comment.isVisible()), h = a.comment.getBubbleSize(),
        d.setAttribute("h", h.height), d.setAttribute("w", h.width)), e.appendChild(d);
    a.data && (d = goog.dom.createDom("data", null, a.data), e.appendChild(d));
    for (d = 0; h = a.inputList[d]; d++)n = !0, h.type != Blockly.DUMMY_INPUT && (m = h.connection.targetBlock(), h.type == Blockly.INPUT_VALUE ? c = goog.dom.createDom("value") : h.type == Blockly.NEXT_STATEMENT && (c = goog.dom.createDom("statement")), k = h.connection.getShadowDom(), !k || m && m.isShadow() || c.appendChild(Blockly.Xml.cloneShadow_(k)), m && (Blockly.Xml.appendlistToDom(c, m), n = !1), c.setAttribute("name",
        h.name), n || (g ? f.appendChild(c) : e.appendChild(c)));
    a.inputsInlineDefault != a.inputsInline && e.setAttribute("inline", a.inputsInline);
    a.isCollapsed() && e.setAttribute("collapsed", !0);
    a.disabled && e.setAttribute("disabled", !0);
    a.inTask ? e.setAttribute("intask", !0) : e.setAttribute("intask", !1);
    a.isDeletable() || a.isShadow() || e.setAttribute("deletable", !1);
    a.isMovable() || a.isShadow() || e.setAttribute("movable", !1);
    a.isEditable() || e.setAttribute("editable", !1);
    (f = a.getNextBlock()) && Blockly.Xml.blockToDom(f, b);
    k =
        a.nextConnection && a.nextConnection.getShadowDom();
    !k || f && f.isShadow() || c.appendChild(Blockly.Xml.cloneShadow_(k));
    return e
};
Blockly.Xml.appendlistToDom = function (a, b) {
    var c = [];
    Blockly.Xml.blockToDom(b, c);
    for (var d = 0; d < c.length; d++)a.appendChild(c[d])
};
...
Blockly.Xml.domToText = function (a) {
    ...
    return a = a.replace("http://www.w3.org/1999/xhtml", "http://de.fhg.iais.roberta.blockly")
};
Blockly.Xml.domToPrettyText = function (a) {
    ...
    a = a.join("\n");
    a = a.replace(/(<(\w+)\b[^>]*>[^\n]*)\n *<\/\2>/g, "$1</$2>");
    a = a.replace("http://www.w3.org/1999/xhtml", "http://de.fhg.iais.roberta.blockly");
    return a.replace(/^\n/, "")
};
Blockly.Xml.textToDom = function (a) {
    a = (new DOMParser).parseFromString(a, "text/xml");
    if (!a || !a.firstChild || "block_set" != a.firstChild.nodeName.toLowerCase() && "toolbox_set" != a.firstChild.nodeName.toLowerCase() || a.firstChild !== a.lastChild)throw"Blockly.Xml.textToDom did not obtain a valid XML tree.";
    return a.firstChild
};
Blockly.Xml.domToWorkspace = function (a, b) {
    ...
    var f = a.childNodes.length, g = Blockly.Events.getGroup();
    g || Blockly.Events.setGroup(!0);
    a.getAttribute("description") ? b.description = a.getAttribute("description") : b.description = "";
    for (var h = 0; h < f; h++) {
        var k = a.childNodes[h];
        if ("instance" == k.nodeName.toLowerCase()) {
            var n =
                [], m = parseInt(k.getAttribute("x"), 10), l = parseInt(k.getAttribute("y"), 10);
            d.push({x: m, y: l});
            if (k.childNodes)for (m = 0; m < k.childNodes.length; m++)l = k.childNodes[m].nodeName.toLowerCase(), "block" != l && "shadow" != l || n.push(k.childNodes[m]);
            c.push(n)
        }
    }
    for (h = 0; h < c.length; h++)if (-1 !== c[h][0].getAttribute("type").indexOf("Controls_start")) {
        c[h] = c.splice(0, 1, c[h])[0];
        d[h] = d.splice(0, 1, d[h])[0];
        break
    }
    for (h = 0; h < c.length; h++)f = Blockly.Xml.domToBlock(c[h], b), isNaN(d[h].x) || isNaN(d[h].y) || f.moveBy(Blockly.RTL ? e - d[h].x :
        d[h].x, d[h].y);
    g || Blockly.Events.setGroup(!1);
...
Blockly.Xml.domToBlockHeadless_ = function (a, b) {
    var c = a.constructor === Array ? a[0] : a;
    var d = c.getAttribute("type");
    if (!d)throw"Block type unspecified: \n" + c.outerHTML;
    var e = c.getAttribute("id");
    d = b.newBlock(d, e);
    for (var e = 0, f; f = c.childNodes[e]; e++)if (3 != f.nodeType)if ("repetitions" != f.nodeName) Blockly.Xml.childToBlock(b, d, f); else for (var g = 0, h; h = f.childNodes[g]; g++)3 != h.nodeType && Blockly.Xml.childToBlock(b, d, h);
    (e = c.getAttribute("inline")) && d.setInputsInline("true" == e);
    (e = c.getAttribute("disabled")) && d.setDisabled("true" ==
        e);
    (e = c.getAttribute("intask")) && d.setInTask("true" == e);
    (e = c.getAttribute("deletable")) && d.setDeletable("true" == e);
    (e = c.getAttribute("movable")) && d.setMovable("true" == e);
    (e = c.getAttribute("editable")) && d.setEditable("true" == e);
    (e = c.getAttribute("collapsed")) && d.setCollapsed("true" == e);
    "shadow" == c.nodeName.toLowerCase() && d.setShadow(!0);
    d.validate && d.validate();
    if (a.constructor === Array && (c = a.slice(1, a.length), 0 != c.length)) {
        ...
        c = Blockly.Xml.domToBlockHeadless_(c, b);
        if (!c.previousConnection)throw"Next block does not have previous statement.";
        d.nextConnection.connect(c.previousConnection)
    }
    return d
};
Blockly.Xml.childToBlock = function (a, b, c) {
    for (var d = null, e = null, f = null, f = [], g = 0, h; h = c.childNodes[g]; g++)1 == h.nodeType && f.push(h);
    for (g = 0; g < f.length; g++)0 < f.length && ("block" == f[g].nodeName.toLowerCase() ? d = f[g] : "shadow" == f[g].nodeName.toLowerCase() && (e = f[g]));
    !d && e && (d = e);
    g = c.getAttribute("name");
    switch (c.nodeName.toLowerCase()) {
        case "mutation":
            b.domToMutation && (b.domToMutation(c), b.initSvg && b.initSvg());
            break;
        case "comment":
            b.setCommentText(c.textContent);
            var k = c.getAttribute("pinned");
            k && setTimeout(function () {
                b.comment &&
                b.comment.setVisible && b.comment.setVisible("true" == k)
            }, 1);
            a = parseInt(c.getAttribute("w"), 10);
            c = parseInt(c.getAttribute("h"), 10);
            !isNaN(a) && !isNaN(c) && b.comment && b.comment.setVisible && b.comment.setBubbleSize(a, c);
            break;
        case "warning":
            b.setWarningText(Blockly.Msg[c.textContent]);
            (k = c.getAttribute("pinned")) && setTimeout(function () {
                b.warning && b.warning.setVisible && b.warning.setVisible("true" == k)
            }, 1);
            a = parseInt(c.getAttribute("w"), 10);
            c = parseInt(c.getAttribute("h"), 10);
            !isNaN(a) && !isNaN(c) && b.warning &&
            b.warning.isVisible() && b.warning.bubble_.setBubbleSize(a, c);
            break;
        case "error":
            b.setErrorText(Blockly.Msg[c.textContent]);
            (k = c.getAttribute("pinned")) && setTimeout(function () {
                b.error && b.error.setVisible && b.error.setVisible("true" == k)
            }, 10);
            a = parseInt(c.getAttribute("w"), 10);
            c = parseInt(c.getAttribute("h"), 10);
            !isNaN(a) && !isNaN(c) && b.error && b.error.isVisible() && b.error.bubble_.setBubbleSize(a, c);
            break;
        case "data":
            b.data = c.textContent;
            break;
        case "title":
        case "field":
            a = b.getField(g);
            if (!a) {
                console.warn("Ignoring non-existent field " +
                    g + " in block " + prototypeName);
                break
            }
            a.setValue(c.textContent);
            break;
        case "value":
        case "statement":
            c = b.getInput(g);
            if (!c) {
                console.warn("Ignoring non-existent input " + g + " in block " + prototypeName);
                break
            }
            e && c.connection.setShadowDom(e);
            if (d)if (f = e ? Blockly.Xml.domToBlockHeadless_(d, a) : Blockly.Xml.domToBlockHeadless_(f, a), f.outputConnection) c.connection.connect(f.outputConnection); else if (f.previousConnection) c.connection.connect(f.previousConnection); else throw"Child block does not have output or previous statement.";
            break;
        case "next":
            e && b.nextConnection && b.nextConnection.setShadowDom(e);
            if (d) {
                if (!b.nextConnection)throw"Next statement does not exist.";
                if (b.nextConnection.targetConnection)throw"Next statement is already connected.";
                f = Blockly.Xml.domToBlockHeadless_(d, a);
                if (!f.previousConnection)throw"Next block does not have previous statement.";
                b.nextConnection.connect(f.previousConnection)
            }
            break;
        case "repetitions":
            break;
        default:
            console.warn("Ignoring unknown tag: " + c.nodeName)
    }
};
...
Blockly.WorkspaceSvg.prototype.createDom = function (a) {
    ...
    this.options.robControls && this.options.zoomOptions && this.options.zoomOptions.controls ? this.addRobControls_(this.options.zoomOptions.controls) : this.options.zoomOptions && this.options.zoomOptions.controls && (a = this.addZoomControls_(a));
...
Blockly.WorkspaceSvg.prototype.dispose = function () {
    ...
    this.robControls && (this.robControls.dispose(), this.robControls = null);
...
Blockly.WorkspaceSvg.prototype.addRobControls_ = function (a) {
    this.robControls = new Blockly.RobControls(this, a);
    a = this.robControls.createDom();
...
Blockly.WorkspaceSvg.prototype.resize = function () {
    ...
    this.robControls ? this.robControls.position() : this.zoomControls_ && this.zoomControls_.position();
...
Blockly.WorkspaceSvg.prototype.paste = function (a) {
    if (this.rendered && !(a.getElementsByTagName("block").length >= this.remainingCapacity())) {
        ...
        if (!isNaN(c) && !isNaN(d)) {
            ...
            do {
                a = !1;
                for (var e = this.getAllBlocks(), f = 0, g; g = e[f]; f++)if (g = g.getRelativeToSurfaceXY(), 1 >= Math.abs(c - g.x) && 1 >= Math.abs(d - g.y)) {
                    a = !0;
                    break
                }
                if (!a)for (e = b.getConnections_(!1),
                                f = 0; g = e[f]; f++)if (g.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
                    a = !0;
                    break
                }
...
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function (a) {
    this.robControls && this.robControls.showZoom && this.robControls.showZoom(!1);
    this.markFocused();
    if (!Blockly.isTargetInput_(a)) {
        ...
        if (Blockly.isRightButton(a)) this.showContextMenu_(a); else {
            for (var b = this.getAllBlocks(),
                     c = 0; c < b.length; c++)for (var d = b[c].getIcons(), e = 0; e < d.length; e++)if (d[e].bubble_) {
                var f = d[e].block_;
                d[e].block_.error ? (f.error.dispose(), f.render()) : d[e].block_.warning ? (f.warning.dispose(), f.render()) : d[e].setVisible(!1)
            }
            this.scrollbar && (this.isScrolling = !0, this.startDragMouseX = a.clientX, this.startDragMouseY = a.clientY, this.startDragMetrics = this.getMetrics(), this.startScrollX = this.scrollX, this.startScrollY = this.scrollY, "mouseup" in Blockly.bindEvent_.TOUCH_MAP && (Blockly.onTouchUpWrapper_ = Blockly.onTouchUpWrapper_ ||
                [], Blockly.onTouchUpWrapper_ = Blockly.onTouchUpWrapper_.concat(Blockly.bindEvent_(document, "mouseup", null, Blockly.onMouseUp_))), Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_ || [], Blockly.onMouseMoveWrapper_ = Blockly.onMouseMoveWrapper_.concat(Blockly.bindEvent_(document, "mousemove", null, Blockly.onMouseMove_)))
        }
        a.stopPropagation();
        a.preventDefault()
    }
...
Blockly.WorkspaceSvg.prototype.onMouseWheel_ = function (a) {
    Blockly.terminateDrag_();
    var b = 0 < a.deltaY ? -1 : 1, c = Blockly.mouseToSvg(a, this.getParentSvg());
    this.zoom(c.x, c.y, b);
    a.preventDefault()
};
...
Blockly.WorkspaceSvg.prototype.showContextMenu_ = function (a) {
    ...
    if (!this.options.readOnly && !this.isFlyout) {
        ...
        if (this.options.collapse) {
            for (var h = g = !1, k = 0; k < e.length; k++)for (var n = e[k]; n;)n.isCollapsed() ? g = !0 : h = !0, n = n.getNextBlock();
            var m = function (a) {
...
Blockly.WorkspaceSvg.prototype.updateRobControls = function () {
    this.robControls && (this.robControls.dispose(), this.options.robControls && this.options.zoomOptions && this.options.zoomOptions.controls && this.addRobControls_(this.options.zoomOptions.controls))
};
...
Blockly.WorkspaceSvg.prototype.updateGridPattern_ = function () {
    if (this.options.gridPattern) {
        ...
        var a = Math.floor(this.options.gridOptions.spacing / 2) + .5, b = a - this.options.gridOptions.length / 2,
            c = a + this.options.gridOptions.length / 2, d = this.options.gridPattern.firstChild,
            e = d && d.nextSibling, a = a * this.scale, b = b * this.scale, c = c * this.scale;
...
Blockly.Mutator.prototype.createEditor_ = function () {
    ...
    if (this.quarkNames_.length) {
        ...
        for (var b = 0, c; c = this.quarkNames_[b]; b++)a.appendChild(goog.dom.createDom("block", {type: c}))
    } else a = null;
    a = {
        languageTree: a,
...
Blockly.Mutator.prototype.workspaceChanged_ = function () {
    var a;
    if (Blockly.dragMode_ == Blockly.DRAG_NONE)for (var b = this.workspace_.getTopBlocks(!1), c = 0; a = b[c]; c++) {
        var d = a.getRelativeToSurfaceXY(), e = a.getHeightWidth();
    ...
    if (this.rootBlock_.workspace == this.workspace_) {
        ...
        a.initSvg();
        c = (c = a.mutationToDom()) &&
            Blockly.Xml.domToText(c);
        if (b != c) {
            Blockly.Events.fire(new Blockly.Events.Change(a, "mutation", null, b, c));
...
Blockly.MutatorPlus.prototype.iconClick_ = function (a) {
    this.block_.isEditable() && 2 != Blockly.dragMode_ && this.block_.updateShape_(1)
};
Blockly.MutatorPlus.prototype.clicked_ = !1;
Blockly.MutatorMinus = function (a) {
    Blockly.MutatorMinus.superClass_.constructor.call(this, null)
};
goog.inherits(Blockly.MutatorMinus, Blockly.Mutator);
Blockly.MutatorMinus.prototype.drawIcon_ = function (a) {
    Blockly.createSvgElement("rect", {
        "class": "blocklyIconShape",
        height: "16",
        width: "16",
...
Blockly.MutatorMinus.prototype.iconClick_ = function (a) {
    this.block_.isEditable() && 2 != Blockly.dragMode_ && this.block_.updateShape_(-1)
};
Blockly.MutatorMinus.prototype.clicked_ = !1;
...
Blockly.Warning.textToDom_ = function (a) {
    ...
    for (var c = 0; c < a.length; c++) {
        var d = Blockly.createSvgElement("tspan", {dy: "1em", x: Blockly.Bubble.BORDER_WIDTH}, b),
...
Blockly.Error = function (a) {
    Blockly.Error.superClass_.constructor.call(this, a);
    this.createIcon();
    this.text_ = {}
};
goog.inherits(Blockly.Error, Blockly.Icon);
Blockly.Error.prototype.collapseHidden = !1;
Blockly.Error.prototype.drawIcon_ = function (a) {
    Blockly.createSvgElement("rect", {
        "class": "blocklyIconShape",
        height: "16",
        width: "16",
...
Blockly.Error.textToDom_ = function (a) {
    var b = Blockly.createSvgElement("text", {
        "class": "blocklyText blocklyBubbleText",
        y: Blockly.Bubble.BORDER_WIDTH
    }, null);
...
Blockly.Error.prototype.setVisible = function (a) {
    if (a != this.isVisible())if (a) {
        a = Blockly.Error.textToDom_(this.getText());
        this.bubble_ = new Blockly.Bubble(this.block_.workspace, a, this.block_.svgPath_, this.iconXY_, null, null);
        if (this.block_.RTL)for (var b = a.getBBox().width, c = 0, d; d = a.childNodes[c]; c++)d.setAttribute("text-anchor", "end"), d.setAttribute("x", b + Blockly.Bubble.BORDER_WIDTH);
        this.updateColour();
        a = this.bubble_.getBubbleSize();
...
Blockly.Error.prototype.bodyFocus_ = function (a) {
    this.bubble_.promote_()
};
Blockly.Error.prototype.setText = function (a, b) {
    this.text_[b] != a && (a ? this.text_[b] = a : delete this.text_[b], this.isVisible() && (this.setVisible(!1), this.setVisible(!0)))
};
...
Blockly.Block.prototype.setConnectionsHidden = function (a) {
    var b;
    if (!a && this.isCollapsed()) this.outputConnection && this.outputConnection.setHidden(a), this.previousConnection && this.previousConnection.setHidden(a), this.nextConnection && (this.nextConnection.setHidden(a), (b = this.nextConnection.targetBlock()) && b.setConnectionsHidden(a)); else for (var c = this.getConnections_(!0), d = 0; b = c[d]; d++)b.setHidden(a), b.isSuperior() && (b = b.targetBlock()) && b.setConnectionsHidden(a)
};
...
Blockly.Block.prototype.setInTask = function (a) {
    this.inTask = a
};
...
Blockly.Block.prototype.toString = function (a) {
    var b = [];
    if (this.collapsed_) b.push(this.getInput("_TEMP_COLLAPSED_INPUT").fieldRow[0].text_); else for (var c = 0, d; d = this.inputList[c]; c++) {
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
    ...
    !a.length || "string" != typeof a[a.length - 1] && 0 != a[a.length -
    1].type.indexOf("field_") || (g = {type: "input_dummy"}, c && (g.align = c), a.push(g));
    c = {LEFT: Blockly.ALIGN_LEFT, RIGHT: Blockly.ALIGN_RIGHT, CENTRE: Blockly.ALIGN_CENTRE};
    b = [];
    for (g = 0; g < a.length; g++)if (f = a[g], "string" == typeof f) b.push([f, void 0]); else {
        d = h = null;
        do switch (e = !1, f.type) {
            case "input_value":
            ...
            case "input_dummy":
                ...
                break;
            case "field_label":
                h = new Blockly.FieldLabel(f.text,
                    f["class"]);
                break;
            case "field_input":
                h = new Blockly.FieldTextInput(f.text);
                "boolean" == typeof f.spellcheck && h.setSpellcheck(f.spellcheck);
                break;
            case "field_angle":
                h = new Blockly.FieldAngle(f.angle);
                break;
            case "field_note":
                h = new Blockly.FieldNote(f.note);
                break;
            case "field_checkbox":
            ...
            case "field_colour":
                ...
                break;
            case "field_variable":
                h = new Blockly.FieldVariable(f.variable);
                break;
            case "field_dropdown":
                h = new Blockly.FieldDropdown(f.options);
                break;
            case "field_dropdownImage":
                h = new Blockly.FieldDropdownImage(f.options);
                break;
            case "field_image":
                h = new Blockly.FieldImage(f.src, f.width, f.height, f.alt);
                break;
            case "field_number":
                h = new Blockly.FieldNumber(f.text);
                break;
            case "field_date":
        ...
        if (h) b.push([h, f.name]); else if (d) {
...
Blockly.Block.prototype.setErrorText = function (a) {
};
Blockly.Block.prototype.setMutator = function (a) {
};
Blockly.Block.prototype.setMutatorPlus = function (a) {
};
Blockly.Block.prototype.setMutatorMinus = function (a) {
};
...
Blockly.RenderedConnection.prototype.highlight = function () {
    var a = this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? "M -1, 4.6 l-4.892 -0.446l-0.561 1.8c-1.109 3.66 -1.01 6.28 0.32 8.021c0.972 1.289 1.758 2.015 5.132 2.015 z" : this.sourceBlock_.RTL ? "m 20,0 h -5 " + Blockly.BlockSvg.NOTCH_PATH_RIGHT + " h -5" : "m -20,0 h 5 " + Blockly.BlockSvg.NOTCH_PATH_LEFT + " h 5";
...
Blockly.BlockSvg.prototype.getIcons = function () {
    ...
    this.mutatorPlus && a.push(this.mutatorPlus);
    this.mutatorMinus && a.push(this.mutatorMinus);
    this.comment && a.push(this.comment);
    this.warning && a.push(this.warning);
    this.error && a.push(this.error);
    return a
};
...
Blockly.BlockSvg.prototype.getRelativeToSurfaceXY = function () {
    ...
    if (c) {
        do var d = Blockly.getRelativeXY_(c), a = a + d.x, b = b + d.y,
...
Blockly.BlockSvg.prototype.snapToGrid = function () {
    if (this.workspace && Blockly.dragMode_ == Blockly.DRAG_NONE && !this.getParent() && !this.isInFlyout && this.workspace.options.gridOptions && this.workspace.options.gridOptions.snap) {
        var a = this.workspace.options.gridOptions.spacing, b = a / 2, c = this.getRelativeToSurfaceXY(),
            d = Math.round((c.x - b) / a) * a + b - c.x, a = Math.round((c.y - b) / a) * a + b - c.y, d = Math.round(d),
            a = Math.round(a);
...
Blockly.BlockSvg.prototype.onMouseDown_ = function (a) {
    if (!this.workspace.options.readOnly)if (this.isInFlyout) a.stopPropagation(); else {
        this.workspace.robControls && this.workspace.robControls.showZoom(!1);
        ...
        if (Blockly.isRightButton(a)) this.showContextMenu_(a); else if (this.isMovable()) {
...
Blockly.BlockSvg.prototype.onMouseUp_ = function (a) {
    ...
    this.workspace.trashcan.close()) : !this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), Blockly.selected.dispose(!1, !0), Blockly.asyncSvgResize(this.workspace));
    if (Blockly.getMainWorkspace().checkInTask && Blockly.selected) {
        var b = this.getRootBlock();
        a = !1;
        for (var c = Blockly.getMainWorkspace().checkInTask, d = 0; d < c.length; d++)if (0 <= b.type.indexOf(c[d])) {
            a = !0;
            break
        }
        b = b.getDescendants();
        for (c = 0; c < b.length; c++)b[c].setInTask(a)
    }
    Blockly.highlightedConnection_ &&
    (Blockly.highlightedConnection_.unhighlight(), Blockly.highlightedConnection_ = null);
    Blockly.Css.setCursor(Blockly.Css.Cursor.OPEN);
...
Blockly.BlockSvg.prototype.showContextMenu_ = function (a) {
    if (!this.workspace.options.readOnly && this.contextMenu) {
        ...
        this.helpUrl = function () {
            ...
            a && !a.classList.contains("rightActive") && (a = document.getElementById("progHelp")) && a.click()
        };
        d = {enabled: !!this.helpUrl};
...
Blockly.BlockSvg.prototype.onMouseMove_ = function (a) {
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation(); else {
        ...
        if (Blockly.dragMode_ ==
            ...
            for (d = 0; d < this.draggedBubbles_.length; d++)c = this.draggedBubbles_[d], c.bubble.setIconLocation(goog.math.Coordinate.sum(c, b));
            c = this.getConnections_(!1);
            (d = this.lastConnectionInStack_()) && d != this.nextConnection && c.push(d);
            var e = null, f = null, g = Blockly.SNAP_RADIUS;
            for (d = 0; d < c.length; d++) {
                var h = c[d], k = h.closest(g, b);
                k.connection &&
...
Blockly.BlockSvg.prototype.updateDisabled = function () {
    ...
    this.disabled || this.getInheritedDisabled() || !this.inTask ? a || (Blockly.addClass_(this.svgGroup_, "blocklyDisabled"), this.svgPath_.setAttribute("stroke", "#000000")) : a && (Blockly.removeClass_(this.svgGroup_, "blocklyDisabled"), this.svgPath_.setAttribute("stroke", "none"), this.updateColour());
...
Blockly.BlockSvg.prototype.setErrorText = function (a, b) {
    this.setErrorText.pid_ || (this.setErrorText.pid_ = Object.create(null));
    var c = b || "";
    if (c) this.setErrorText.pid_[c] && (clearTimeout(this.setErrorText.pid_[c]), delete this.setErrorText.pid_[c]); else for (var d in this.setErrorText.pid_)clearTimeout(this.setErrorText.pid_[d]), delete this.setErrorText.pid_[d];
    if (2 == Blockly.dragMode_) {
        var e = this;
        this.setErrorText.pid_[c] = setTimeout(function () {
            e.workspace && (delete e.setErrorText.pid_[c], e.setErrorText(a,
                c))
        }, 100)
    } else {
        this.isInFlyout && (a = null);
        d = this.getSurroundParent();
        for (var f = null; d;)d.isCollapsed() && (f = d), d = d.getSurroundParent();
        f && f.setErrorText(a, "collapsed " + this.id + " " + c);
        d = !1;
        goog.isString(a) ? (this.error || (this.error = new Blockly.Error(this), d = !0), this.error.setText(a, c)) : this.error && !c ? (this.error.dispose(), d = !0) : this.error && (d = this.error.getText(), this.error.setText("", c), (f = this.error.getText()) || this.error.dispose(), d = d == f);
...
Blockly.BlockSvg.prototype.setMutatorPlus = function (a) {
    this.mutatorPlus && this.mutatorPlus !== a && this.mutatorPlus.dispose();
    a && (a.block_ = this, this.mutatorPlus = a, this.rendered && this.mutatorPlus.createIcon())
};
Blockly.BlockSvg.prototype.setMutatorMinus = function (a) {
    this.mutatorMinus && this.mutatorMinus !== a && this.mutatorMinus.dispose();
    a && (a.block_ = this, this.mutatorMinus = a, this.rendered && this.mutatorMinus.createIcon())
};
...
Blockly.BlockSvg.prototype.setInTask = function (a) {
    this.inTask != a && (Blockly.BlockSvg.superClass_.setInTask.call(this, a), this.rendered && this.updateDisabled())
};
...
Blockly.BlockSvg.TAB_PATH_DOWN_INNER = "v 4.1 l-5.154 -0.469c0 0 -1.096 3.125 -1.33 4.656s-0.25 3.703 0.406 5.078s 1.984 2.688 3.484 2.953s2.375 0.203 2.594 0.219 v 3.5";
Blockly.BlockSvg.TAB_PATH_DOWN_OUTER = "v -5 c-4.217 0.097 -4.471 -0.54 -5.281 -1.609c-1.109 -1.46 -1.159 -3.82 -0.159 -7.12l0.33 -1.061l5.11 0.44 v -5.2";
...
Blockly.BlockSvg.INNER_TOP_LEFT_CORNER = Blockly.BlockSvg.NOTCH_PATH_RIGHT + " h -" + (Blockly.BlockSvg.NOTCH_WIDTH - 15 + 1 - Blockly.BlockSvg.CORNER_RADIUS) + " a " + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + " 0 0,0 -" + Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS;
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), m = 0, l; l = b[m]; m++)if (l.isVisible()) {
        if (n && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT)var p = c[c.length - 1]; else k = l.type, p = [], p.type = n &&
        l.type != Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : l.type, p.height = 0, c.push(p);
        p.push(l);
        ...
        n || m != b.length - 1 ? !n && l.type == Blockly.INPUT_VALUE && b[m + 1] && b[m + 1].type ==
            Blockly.NEXT_STATEMENT && l.renderHeight-- : l.renderHeight--;
        p.height = Math.max(p.height, l.renderHeight);
        l.fieldWidth = 0;
        1 == c.length && (l.fieldWidth += this.RTL ? -a : a);
        for (var q = !1, r = 0, t; t = l.fieldRow[r]; r++) {
            0 != r && (l.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
            var u = t.getSize();
            t.renderWidth = u.width;
            t.renderSep = q && t.EDITABLE ? Blockly.BlockSvg.SEP_SPACE_X : 0;
            l.fieldWidth += t.renderWidth + t.renderSep;
            p.height = Math.max(p.height, u.height);
            q = t.EDITABLE
        }
        p.type != Blockly.BlockSvg.INLINE && (p.type == Blockly.NEXT_STATEMENT ?
            (g = !0, e = Math.max(e, l.fieldWidth)) : (p.type == Blockly.INPUT_VALUE ? f = !0 : p.type == Blockly.DUMMY_INPUT && (h = !0), d = Math.max(d, l.fieldWidth)))
    }
    for (a = 0; p = c[a]; a++)if (p.thicker = !1, p.type == Blockly.BlockSvg.INLINE)for (b = 0; l = p[b]; b++)if (l.type == Blockly.INPUT_VALUE) {
...
Blockly.BlockSvg.prototype.renderDraw_ = function (a, b) {
    ...
    var c = this.getRelativeToSurfaceXY(), d = [], e = [], f = [];
    this.renderDrawTop_(d, f, c, b.rightEdge);
    var g = this.renderDrawRight_(d, f, e, [], c, b, a);
    this.renderDrawBottom_(d, f, c, g);
    this.renderDrawLeft_(d, f, c, g);
    c = d.join(" ") + "\n" + e.join(" ");
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
    var h;
    for (d = 0; d < this.svgPathInput_.length; d++)this.svgGroup_.removeChild(this.svgPathInput_[d]);
    this.svgPathInput_ = [];
    for (var k = 0, n, m = 0, l; l = f[m]; m++) {
        var p = Blockly.BlockSvg.SEP_SPACE_X;
        0 == m && (p += this.RTL ? -g : g);
        if (this.isCollapsed()) {
            d = l[0];
            var q = p;
            p = k;
            this.renderFields_(d.fieldRow, q, p);
            a.push(Blockly.BlockSvg.JAGGED_TEETH);
            a.push("v", l.height - Blockly.BlockSvg.JAGGED_TEETH_HEIGHT);
            this.width += Blockly.BlockSvg.JAGGED_TEETH_WIDTH
        } else if (l.type ==
            Blockly.BlockSvg.INLINE) {
            for (h = 0; d = l[h]; h++)q = p, p = k, l.thicker && (p += Blockly.BlockSvg.INLINE_PADDING_Y), p = this.renderFields_(d.fieldRow, q, p), d.type != Blockly.DUMMY_INPUT && (p += d.renderWidth + Blockly.BlockSvg.SEP_SPACE_X), d.type == Blockly.INPUT_VALUE && (c.push("M", p - Blockly.BlockSvg.SEP_SPACE_X + "," + (k + Blockly.BlockSvg.INLINE_PADDING_Y)), c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - d.renderWidth), c.push("v", "1"), c.push(Blockly.BlockSvg.TAB_PATH_DOWN_INNER), this.drawInputType_(d, m, p - Blockly.BlockSvg.SEP_SPACE_X +
                Blockly.BlockSvg.TAB_WIDTH - 2 - d.renderWidth, k + Blockly.BlockSvg.INLINE_PADDING_Y + 1), c.push("v", d.renderHeight - Blockly.BlockSvg.TAB_HEIGHT), c.push("h", d.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH), c.push("z"), q = this.RTL ? e.x - p - Blockly.BlockSvg.TAB_WIDTH + Blockly.BlockSvg.SEP_SPACE_X + d.renderWidth + 1 : e.x + p + Blockly.BlockSvg.TAB_WIDTH - Blockly.BlockSvg.SEP_SPACE_X - d.renderWidth - 1, n = e.y + k + Blockly.BlockSvg.INLINE_PADDING_Y + 1, d.connection.moveTo(q, n), d.connection.isConnected() && d.connection.tighten_());
            p = Math.max(p,
                f.rightEdge);
            this.width = Math.max(this.width, p);
            a.push("H", p);
            a.push("v", l.height)
        } else l.type == Blockly.INPUT_VALUE ? (d = l[0], q = p, p = k, d.align != Blockly.ALIGN_LEFT && (h = f.rightEdge - d.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, d.align == Blockly.ALIGN_RIGHT ? q += h : d.align == Blockly.ALIGN_CENTRE && (q += h / 2)), this.renderFields_(d.fieldRow, q, p), a.push(Blockly.BlockSvg.TAB_PATH_DOWN_INNER), this.drawInputType_(d, m, f.rightEdge, k), a.push("v", l.height - Blockly.BlockSvg.TAB_HEIGHT), q = e.x + (this.RTL ?
                -f.rightEdge - 1 : f.rightEdge + 1), n = e.y + k, d.connection.moveTo(q, n), d.connection.isConnected() && (d.connection.tighten_(), this.width = Math.max(this.width, f.rightEdge + d.connection.targetBlock().getHeightWidth().width - Blockly.BlockSvg.TAB_WIDTH + 1))) : l.type == Blockly.DUMMY_INPUT ? (d = l[0], q = p, p = k, d.align != Blockly.ALIGN_LEFT && (h = f.rightEdge - d.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, f.hasValue && (h -= Blockly.BlockSvg.TAB_WIDTH), d.align == Blockly.ALIGN_RIGHT ? q += h : d.align == Blockly.ALIGN_CENTRE && (q += h / 2)), this.renderFields_(d.fieldRow,
            q, p), a.push("v", l.height), this.RTL && b.push("v", l.height - 1)) : l.type == Blockly.NEXT_STATEMENT && (d = l[0], 0 == m && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1), k += Blockly.BlockSvg.SEP_SPACE_Y), q = p, p = k, d.align != Blockly.ALIGN_LEFT && (h = f.statementEdge - d.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, d.align == Blockly.ALIGN_RIGHT ? q += h : d.align == Blockly.ALIGN_CENTRE && (q += h / 2)), this.renderFields_(d.fieldRow, q, p), p = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H",
                p + 1), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", l.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", f.rightEdge), q = e.x + (this.RTL ? -p : p + 1), n = e.y + k + 1, d.connection.moveTo(q, n), d.connection.isConnected() && (d.connection.tighten_(), this.width = Math.max(this.width, f.statementEdge + d.connection.targetBlock().getHeightWidth().width)), m == f.length - 1 || f[m + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y), k += Blockly.BlockSvg.SEP_SPACE_Y);
        k += l.height
    }
    f.length || (k = Blockly.BlockSvg.MIN_BLOCK_Y, a.push("V", k));
    return k
};
Blockly.BlockSvg.prototype.renderDrawBottom_ = function (a, b, c, d) {
    this.height += d + 1;
    this.nextConnection && (a.push("H", Blockly.BlockSvg.NOTCH_WIDTH + " " + Blockly.BlockSvg.NOTCH_PATH_RIGHT), this.nextConnection.moveTo(this.RTL ? c.x - Blockly.BlockSvg.NOTCH_WIDTH : c.x + Blockly.BlockSvg.NOTCH_WIDTH, c.y + d + 1), this.nextConnection.isConnected() && this.nextConnection.tighten_(), this.height += 4);
    this.squareBottomLeftCorner_ ? a.push("H 0") : (a.push("H", Blockly.BlockSvg.CORNER_RADIUS), a.push("a", Blockly.BlockSvg.CORNER_RADIUS +
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function (a, b, c, d) {
    this.svgPathOutput_ && this.svgPathOutput_.parentNode && this.svgPathOutput_.parentNode.removeChild(this.svgPathOutput_);
    this.outputConnection && (this.outputConnection.moveTo(c.x, c.y), a.push("V", Blockly.BlockSvg.TAB_HEIGHT), this.outputConnection.check_ ? (this.svgPathOutput_ = Blockly.createSvgElement("path", {
            d: "M 0," + Blockly.BlockSvg.TAB_HEIGHT + Blockly.BlockSvg.TAB_PATH_DOWN_OUTER + "z",
            fill: Blockly.DATA_TYPE[this.outputConnection.check_[0]],
            "class": "outputType"
        },
        null), this.svgGroup_.insertBefore(this.svgPathOutput_, this.svgPathSelected_), this.width += Blockly.BlockSvg.TAB_WIDTH) : a.push(Blockly.BlockSvg.TAB_PATH_DOWN_OUTER));
    a.push("z")
};
Blockly.BlockSvg.prototype.drawInputType_ = function (a, b, c, d) {
    a.connection.check_ && !a.connection.targetConnection && 1 == a.connection.check_.length && (a = Blockly.createSvgElement("path", {
        d: "M " + c + "," + (d + 2.6) + "l-6.188 -0.547c0 0 -1.781 4.781 -1.938 7.281s0.578 4.594 0.984 5.281s1.719 2.234 3.016 2.797s3.172 0.641 4.125 0.641",
        fill: "none",
        stroke: Blockly.DATA_TYPE[a.connection.check_[0]],
        "stroke-width": "3px"
    }, null), this.svgPathInput_.push(a), this.svgGroup_.insertBefore(this.svgPathInput_[this.svgPathInput_.length -
    1], this.svgPathSelected_))
};
Blockly.Events = {};
...
Blockly.Events.Abstract.prototype.toJson = function () {
    var a = {type: this.type, blockId: this.blockId};
...
Blockly.FieldTextInput.nonnegativeNumberValidator = function (a) {
    if (null === a)return null;
    a = String(a);
    a = a.replace(/O/ig, "0");
    a = a.replace(/,/g, ".");
    a = a.replace(/\.(?=.*?\.)/g, "");
    a = parseFloat(a || 0);
    return isNaN(a) ? null : String(Math.abs(a))
};
...
Blockly.FieldAngle.prototype.setValidator = function (a) {
    Blockly.FieldAngle.superClass_.setValidator.call(this, a ? function (b) {
        var c = a.call(this, b);
        if (null === c)var d = c; else void 0 === c && (c = b), d = Blockly.FieldAngle.angleValidator.call(this, c), void 0 === d && (d = c);
        return d === b ? void 0 : d
...
Blockly.FieldAngle.prototype.updateGraph_ = function () {
    if (this.gauge_) {
        var a = Number(this.getText()) + Blockly.FieldAngle.OFFSET, b = goog.math.toRadians(a),
            a = ["M ", Blockly.FieldAngle.HALF, ",", Blockly.FieldAngle.HALF], c = Blockly.FieldAngle.HALF,
...
Blockly.FieldNote = function (a, b) {
    Blockly.FieldNote.superClass_.constructor.call(this, a, b)
};
...
Blockly.FieldNote.prototype.dispose_ = function () {
    var a = this;
    return function () {
        Blockly.FieldNote.superClass_.dispose_.call(a)();
        a.clickWrapper_ && Blockly.unbindEvent_(a.clickWrapper_);
        a.clickWrapper1_ && Blockly.unbindEvent_(a.clickWrapper1_)
    }
};
Blockly.FieldNote.prototype.showEditor_ = function () {
    Blockly.FieldNote.superClass_.showEditor_.call(this, goog.userAgent.MOBILE || goog.userAgent.ANDROID || goog.userAgent.IPAD);
    Blockly.FieldTextInput.htmlInput_.setAttribute("disabled", "true");
    var a = Blockly.WidgetDiv.DIV;
    if (a.firstChild) {
        for (var a = Blockly.createSvgElement("svg", {
            xmlns: "http://www.w3.org/2000/svg",
            "xmlns:html": "http://www.w3.org/1999/xhtml",
            "xmlns:xlink": "http://www.w3.org/1999/xlink",
            version: "1.1",
            ...
            width: 22 *
            Blockly.FieldNote.WIDTH + "px"
        }, a), b = [1, 3, 6, 8, 10], c = 0, d = 28; 64 > d; d++) {
            var e = (d - 4) % 12;
            if (-1 == b.indexOf(e)) {
                e = Math.round(44E4 * Math.pow(2, (d - 49) / 12)) / 1E3;
                var f = e != this.getValue() ? "#ffffff" : Blockly.CAT_ACTION_RGB;
                f = Blockly.createSvgElement("rect", {
                    x: c * Blockly.FieldNote.WIDTH,
                    y: 0,
                ...
                Blockly.bindEvent_(f, "mouseover", this, this.onMouseHover);
                Blockly.bindEvent_(f, "touchstart", this, this.onTouch);
                Blockly.bindEvent_(f,
                    "touchmove", this, this.onTouch);
                c++;
                e == this.getValue() && (this.selected_ = f)
            }
        }
        c = 0;
        for (d = 28; 64 > d; d++)e = (d - 4) % 12, 0 <= b.indexOf(e) ? (e = Math.round(44E4 * Math.pow(2, (d - 49) / 12)) / 1E3, f = e != this.getValue() ? "#000000" : Blockly.CAT_ACTION_RGB, f = Blockly.createSvgElement("rect", {
            x: c * Blockly.FieldNote.WIDTH - 5,
            y: 0,
            width: Blockly.FieldNote.WIDTH - 5,
            height: Blockly.FieldNote.HEIGHT - 20,
            fill: f,
            id: "black" + e
        }, a), Blockly.bindEvent_(f, "mouseover", this, this.onMouseHover), Blockly.bindEvent_(f, "touchstart", this, this.onTouch), Blockly.bindEvent_(f,
            "touchmove", this, this.onTouch), e == this.getValue() && (this.selected_ = f)) : c++;
        this.clickWrapper_ = Blockly.bindEvent_(a, "click", this, Blockly.WidgetDiv.hide);
        this.clickWrapper1_ = Blockly.bindEvent_(a, "touchend", this, Blockly.WidgetDiv.hide)
    }
};
Blockly.FieldNote.prototype.onMouseHover = function (a) {
    this.selected_ && (-1 != this.selected_.id.indexOf("white") ? this.selected_.setAttribute("fill", "#ffffff") : this.selected_.setAttribute("fill", "#000000"));
    a.target.setAttribute("fill", Blockly.CAT_ACTION_RGB);
    var b = a.target.id.replace(/white|black/, "");
    this.selected_ = a.target;
    this.setValue(b);
    this.resizeEditor_()
};
...
Blockly.FieldNote.prototype.setValue = function (a) {
    if (null !== a) {
        var b = this.getValue();
        b != a && (this.sourceBlock_ && Blockly.Events.isEnabled() && Blockly.Events.fire(new Blockly.Events.Change(this.sourceBlock_, "field", this.name, b, a)), this.value_ = a, Blockly.FieldNote.NOTENAMES[a] ? this.setText(Blockly.FieldNote.NOTENAMES[a]) : this.setText(a), Blockly.FieldTextInput.htmlInput_ && (Blockly.FieldTextInput.htmlInput_.value = Blockly.FieldNote.NOTENAMES[a]))
    }
};
Blockly.FieldNote.prototype.onTouch = function (a) {
    a.preventDefault();
    if (!(1 < a.touches.length || "touchend" == a.type && 0 < a.touches.length)) {
        a = a.touches[0];
        a = document.elementFromPoint(a.clientX, a.clientY);
        var b = document.createEvent("SVGEvents");
...
Blockly.FieldColour.prototype.showEditor_ = function () {
    ...
    var b = goog.dom.getViewportSize(), c = goog.style.getViewportPageOffset(document), d = this.getAbsoluteXY_(),
...
Blockly.FieldDropdownImage = function (a, b, c, d, e) {
    this.height_ = Number(d);
    this.width_ = Number(c);
    this.type_ = "." + (e || "png");
    this.menuGenerator_ = a;
    this.trimOptions_();
    this.pathToMedia_ = Blockly.Css.mediaPath_ + b;
...
Blockly.FieldDropdownImage.prototype.init = function () {
    if (!this.fieldGroup_) {
        this.fieldGroup_ = Blockly.createSvgElement("g", {cursor: "default"}, null);
        ...
        var a = (this.rectElement_ = Blockly.createSvgElement("rect", {
                height: this.height_ +
                "px", width: this.width_ + 15 + "px", "fill-opacity": 0, cursor: "default"
            }, this.fieldGroup_)) || this.imageElement_;
        a.tooltip = this.sourceBlock_;
        Blockly.Tooltip.bindMouseEvents(a);
        this.arrow_ = Blockly.createSvgElement("tspan", {}, null);
        this.arrow_.appendChild(document.createTextNode(this.sourceBlock_.RTL ? Blockly.FieldDropdownImage.ARROW_CHAR + " " : " " + Blockly.FieldDropdownImage.ARROW_CHAR));
        this.textElement_ = Blockly.createSvgElement("text", {
            "class": "blocklyText",
            y: this.size_.height / 2,
            x: this.size_.width - 6
        }, this.fieldGroup_);
        this.sourceBlock_ && this.arrow_ && (this.arrow_.style.fill = "#ffffff");
...
Blockly.FieldDropdownImage.prototype.showEditor_ = function () {
    ...
    b.setRightToLeft(this.sourceBlock_.RTL);
    for (var c = this.getOptions_(), d = 0; d < c.length; d++) {
        var e = c[d][0], f = c[d][1], g = goog.dom.createDom("img");
        goog.dom.setProperties(g, {
            src: this.pathToMedia_ + f + this.type_,
            alt: e,
            width: this.width_,
            height: this.height_
        });
        e = new goog.ui.MenuItem(g);
        e.setRightToLeft(this.sourceBlock_.RTL);
        e.addClassName("dropdownImage");
        e.setValue(f);
        e.setCheckable(!0);
        b.addChild(e, !0);
    ...
    c = goog.dom.getViewportSize();
    d = goog.style.getViewportPageOffset(document);
    f = goog.style.getPageOffset(this.imageElement_);
    e = this.getScaledBBox_();
    b.render(Blockly.WidgetDiv.DIV);
    g = b.getElement();
    Blockly.addClass_(g, "blocklyDropdownMenu");
    ...
    this.sourceBlock_.RTL ? (f.x += e.width, f.x += Blockly.FieldDropdownImage.CHECKMARK_OVERHANG, f.x < d.x + h.width && (f.x = d.x + h.width)) : (f.x -= Blockly.FieldDropdownImage.CHECKMARK_OVERHANG,
    f.x > c.width + d.x - h.width && (f.x = c.width + d.x - h.width));
    Blockly.WidgetDiv.position(f.x - 3, f.y, c, d, this.sourceBlock_.RTL);
    b.setAllowAutoFocus(!0);
    g.focus()
};
...
Blockly.FieldDropdownImage.prototype.onMouseUp_ = function (a) {
    if (!goog.userAgent.IPHONE && !goog.userAgent.IPAD || goog.userAgent.isVersionOrHigher("537.51.2") || 0 === a.layerX || 0 === a.layerY) Blockly.isRightButton(a) || Blockly.dragMode_ != Blockly.DRAG_FREE && this.sourceBlock_.isEditable() && this.showEditor_()
};
Blockly.FieldDropdownImage.prototype.setValue = function (a) {
    null !== a && a !== this.value_ && (this.value_ = a, this.src_ = this.pathToMedia_ + a + ".png", this.imageElement_ && this.imageElement_.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", goog.isString(this.src_) ? this.src_ : ""))
};
Blockly.FieldDropdownImage.prototype.getScaledBBox_ = function () {
    var a = this.imageElement_.getBBox();
    return new goog.math.Size(a.width * this.sourceBlock_.workspace.scale, a.height * this.sourceBlock_.workspace.scale)
};
...
Blockly.Variables.allVariables = function (a) {
    if (a.getDescendants)var b = a.getDescendants(); else if (a.getAllBlocks) b = a.getAllBlocks(); else throw"Not Block or Workspace: " + a;
...
Blockly.Variables.robRenameVariable = function (a) {
    var b = this.sourceBlock_, c = b.getFieldValue("VAR");
    a = a.replace(/[\s\xa0]+/g, "").replace(/^ | $/g, "");
    if ("" === a || !a.match(/^[a-zA-Z][a-zA-Z_$0-9]*$/))return null;
    a = Blockly.Variables.findLegalName(a, b);
    for (var b = Blockly.mainWorkspace.getAllBlocks(), d = 0; d < b.length; d++) {
        var e = b[d].renameVar;
        e && e.call(b[d], c, a)
    }
    return a
...
Blockly.Variables.flyoutCategory = function (a) {
    var b = [];
    if (a.options.variableDeclaration) {
        a = Blockly.Variables.allGlobalVariables();
        a.sort(goog.string.caseInsensitiveCompare);
        var c = Blockly.Variables.allLocalVariables();
        c.sort(goog.string.caseInsensitiveCompare);
        var d = Blockly.Variables.allLoopVariables();
        d.sort(goog.string.caseInsensitiveCompare);
        0 < a.length && (b = b.concat(a), b.push("devider"));
        0 < c.length && (b = b.concat(c), b.push("devider"));
        0 < d.length && (b = b.concat(d))
    } else b = Blockly.Variables.allVariables(a),
        b.sort(goog.string.caseInsensitiveCompare), goog.array.remove(b, Blockly.Msg.VARIABLES_DEFAULT_NAME), b.unshift(Blockly.Msg.VARIABLES_DEFAULT_NAME);
    c = [];
    for (d = 0; d < b.length; d++)if ("devider" !== b[d]) {
        if (Blockly.Blocks.variables_set) {
            a = goog.dom.createDom("block");
            a.setAttribute("type", "variables_set");
            Blockly.Blocks.variables_get && a.setAttribute("gap", 8);
            var e = goog.dom.createDom("field", null, b[d]);
            e.setAttribute("name", "VAR");
            a.appendChild(e);
            e = goog.dom.createDom("mutation");
            a.appendChild(e);
            c.push(a)
        }
        Blockly.Blocks.variables_get &&
        (a = goog.dom.createDom("block"), a.setAttribute("type", "variables_get"), Blockly.Blocks.variables_set && a.setAttribute("gap", 24), e = goog.dom.createDom("field", null, b[d]), e.setAttribute("name", "VAR"), a.appendChild(e), e = goog.dom.createDom("mutation"), a.appendChild(e), c.push(a))
    } else 0 < c.length && c[c.length - 1].setAttribute("gap", 36);
    return c
};
...
Blockly.Variables.findLegalName = function (a, b) {
    for (; !Blockly.Variables.isLegalName(a, b) || Blockly.Variables.isReservedName(a, b);) {
        var c = a.match(/^(.*?)(\d+)$/);
        a = c ? c[1] + (parseInt(c[2], 10) + 1) : a + "2"
    }
    return a
};
Blockly.Variables.isLegalName = function (a, b) {
    for (var c = Blockly.mainWorkspace.getAllBlocks(), d = 0; d < c.length; d++)if (c[d] != b) {
        var e = c[d].getVarDecl;
        if (e && (e = e.call(c[d]), Blockly.Names.equals(a, e[0])))return !1
    }
    return !0
};
Blockly.Variables.isReservedName = function (a, b) {
    return Blockly[b.workspace.device] ? 0 <= Blockly[b.workspace.device].indexOf(a) : !1
};
Blockly.Variables.updateType = function (a, b) {
    for (var c = Blockly.mainWorkspace.getAllBlocks(), d = 0; d < c.length; d++) {
        var e = c[d].setType;
        e && c[d].getFieldValue("VAR") === a && e.call(c[d], a, b)
    }
};
Blockly.Variables.deleteAll = function (a) {
    for (var b = Blockly.mainWorkspace.getAllBlocks(), c = 0; c < b.length; c++)b[c].setType && b[c].getFieldValue("VAR") === a && b[c].dispose(!0, !0, !1)
};
Blockly.Variables.getVariableType = function (a) {
    for (var b = Blockly.mainWorkspace.getAllBlocks(), c = 0; c < b.length; c++) {
        var d = b[c].getVars;
        if (d && (d = d.call(b[c]), d[0] && Blockly.Names.equals(a, d[0]))) {
            d = b[c].getSurroundParent();
            if ("controls_for" == b[c].type || "controls_forEach" == b[c].type)return {loop: b[c].id};
            if ("robProcedures_defnoreturn" == b[c].type || "robProcedures_defreturn" == b[c].type)return {local: b[c].getFieldValue("NAME")};
            if (d && ("robProcedures_defnoreturn" == d.type || "robProcedures_defreturn" == d.type))return {local: d.getFieldValue("NAME")};
            if (d && -1 !== d.type.indexOf("Controls_start"))return {global: "global"}
        }
    }
    return null
};
Blockly.Variables.getProcedureName = function (a) {
    for (var b = Blockly.mainWorkspace.getAllBlocks(), c = 0; c < b.length; c++)if (b[c].getVarDecl && Blockly.Names.equals(a, b[c].getFieldValue("VAR"))) {
        if ("robControls_for" == b[c].type || "robControls_forEach" == b[c].type)return b[c].id;
        var d = b[c].getSurroundParent();
        if (d && ("robProcedures_defnoreturn" == d.type || "robProcedures_defreturn" == d.type))return d.getFieldValue("NAME");
        if (d && ("robControls_start" == d.type || "robControls_start_ardu" == d.type))return "global"
    }
    return null
};
Blockly.Variables.getType = function (a) {
    for (var b = Blockly.mainWorkspace.getAllBlocks(), c = 0; c < b.length; c++) {
        var d = b[c].getType;
        if (d && b[c].getFieldValue("VAR") === a)return d.call(b[c])
    }
    return null
};
Blockly.Variables.allVariables = function (a) {
    if (a.getDescendants)var b = a.getDescendants(); else if (a.getAllBlocks) b = a.getAllBlocks(); else throw"Not Block or Workspace: " + a;
    a = Object.create(null);
    for (var c = 0; c < b.length; c++)if (b[c].getVars)for (var d = b[c].getVars(), e = 0; e < d.length; e++) {
        var f = d[e];
        f && (a[f.toLowerCase()] = f)
    }
    b = [];
...
Blockly.Variables.allGlobalVariables = function () {
    for (var a = Blockly.getMainWorkspace().getTopBlocks(!0), b = [], c = 0; c < a.length; c++) {
        var d = a[c];
        if (-1 !== d.type.indexOf("Controls_start") && (d = d.getDescendants()))a:for (c = 1; c < d.length; c++)if (d[c].getVarDecl && "robGlobalVariables_declare" === d[c].type) b.push(d[c].getVarDecl()[0]); else if (!d[c].getParent())break a
    }
    return b
};
Blockly.Variables.allLocalVariables = function () {
    for (var a = Blockly.getMainWorkspace().getTopBlocks(!0), b = [], c = 0; c < a.length; c++) {
        var d = a[c];
        if (d.getProcedureDef && (d = d.getDescendants()))for (var e = 1; e < d.length; e++)d[e].getVarDecl && "robLocalVariables_declare" == d[e].type && b.push(d[e].getVarDecl()[0])
    }
    return b
};
Blockly.Variables.allLoopVariables = function () {
    for (var a = Blockly.mainWorkspace.getAllBlocks(), b = [], c = 0; c < a.length; c++) {
        var d = a[c];
        "robControls_for" != d.type && "robControls_forEach" != d.type || !d.getVarDecl || b.push(d.getVarDecl()[0])
    }
    return b
};
...
Blockly.FieldVariable.prototype.setValidator = function (a) {
    Blockly.FieldVariable.superClass_.setValidator.call(this, a ? function (b) {
        var c = a.call(this, b);
        if (null === c)var d = c; else void 0 === c && (c = b), d = Blockly.FieldVariable.dropdownChange.call(this, c), void 0 === d && (d = c);
        return d === b ? void 0 : d
...
Blockly.FieldVariable.dropdownCreate = function () {
    ...
    a.sort(goog.string.caseInsensitiveCompare);
    (b = this.sourceBlock_) && !b.variableDeclaration ? (a.push(Blockly.Msg.RENAME_VARIABLE), a.push(Blockly.Msg.NEW_VARIABLE)) : 0 === a.length && a.push("dummy");
...
Blockly.FieldVariable.dropdownChange = function (a) {
    ...
    if (c.variableDeclaration) this.sourceBlock_.setType(this.getText(), Blockly.Variables.getType(a)); else {
        if (a == Blockly.Msg.RENAME_VARIABLE) {
            var d = this.getText();
            (a = b(Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", d), d)) && Blockly.Variables.renameVariable(d,
                a, c);
            return null
        }
...
Blockly.Procedures.findLegalName = function (a, b) {
    ...
    for (; !Blockly.Procedures.isLegalName(a, b.workspace, b) || Blockly.Variables.isReservedName(a, b);) {
        var c = a.match(/^(.*?)(\d+)$/);
        a = c ? c[1] + (parseInt(c[2], 10) + 1) : a + "2"
    }
    return a
...
Blockly.Procedures.robRename = function (a) {
    a = a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "");
    a = a.substring(0, 1).toLowerCase() + a.substring(1);
    if ("" === a || !a.match(/^[a-z][a-zA-Z0-9_]*$/))return null;
    a = Blockly.Procedures.findLegalName(a, this.sourceBlock_);
    for (var b = this.sourceBlock_.workspace.getAllBlocks(), c = 0; c < b.length; c++)b[c].renameProcedure && b[c].renameProcedure(this.nameOld, a);
    return this.nameOld = a
};
Blockly.Procedures.flyoutCategory = function (a) {
    function b(b, d) {
        for (var e, f = 0; f < b.length; f++) {
            e = b[f][0];
            var k = b[f][1], n = goog.dom.createDom("block");
            n.setAttribute("type", d);
            n.setAttribute("gap", 16);
            var m = goog.dom.createDom("mutation");
            m.setAttribute("name", e);
            n.appendChild(m);
            if (a.variableDeclaration) {
                if (k = b[f][1].getDescendants())for (l = 0; l < k.length; l++)if (!k[l].getProcedureDef)if (k[l].getVarDecl) e = goog.dom.createDom("arg"), e.setAttribute("name", k[l].getVarDecl()[0]), e.setAttribute("type", k[l].getType()),
                    m.appendChild(e); else break;
                "robProcedures_callreturn" === d && (e = b[f][1].returnType_) && m.setAttribute("output_type", e)
            } else for (var l = 0; l < k.length; l++)e = goog.dom.createDom("arg"), e.setAttribute("name", k[l]), m.appendChild(e);
            c.push(n)
        }
    }
    ...
    if (a.variableDeclaration) {
        if (Blockly.Blocks.robProcedures_defnoreturn) {
            ...
            d.setAttribute("type", "robProcedures_defnoreturn");
            d.setAttribute("gap", 16);
            c.push(d)
        }
        Blockly.Blocks.robProcedures_defreturn && (d = goog.dom.createDom("block"),
            d.setAttribute("type", "robProcedures_defreturn"), d.setAttribute("gap", 16), c.push(d));
        Blockly.Blocks.robProcedures_ifreturn && (d = goog.dom.createDom("block"), d.setAttribute("type", "robProcedures_ifreturn"), d.setAttribute("gap", 16), c.push(d))
    } else Blockly.Blocks.procedures_defnoreturn && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_defnoreturn"), d.setAttribute("gap", 16), c.push(d)), Blockly.Blocks.procedures_defreturn && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_defreturn"),
        d.setAttribute("gap", 16), c.push(d)), Blockly.Blocks.procedures_ifreturn && (d = goog.dom.createDom("block"), d.setAttribute("type", "procedures_ifreturn"), d.setAttribute("gap", 16), c.push(d));
    c.length && c[c.length - 1].setAttribute("gap", 24);
    d = Blockly.Procedures.allProcedures(a);
    a.variableDeclaration ? (b(d[0], "robProcedures_callnoreturn"), b(d[1], "robProcedures_callreturn")) : (b(d[0], "procedures_callnoreturn"), b(d[1], "procedures_callreturn"));
    return c
};
Blockly.Procedures.getCallers = function (a, b) {
    for (var c = [], d = b.getAllBlocks(), e = 0; e < d.length; e++)if (d[e].getProcedureCall) {
        ...
        f && (Blockly.Names.equals(f, a) || "robProcedures_ifreturn" === f) && c.push(d[e])
    }
    return c
};
...
Blockly.Procedures.updateCallers = function (a, b, c, d, e) {
    if (e = e || Blockly.Variables.getProcedureName(a))for (c = Blockly.Procedures.getCallers(e, c), e = 0; e < c.length; e++)c[e].updateProcedureParameters(a, b, d)
};
...
Blockly.Flyout.prototype.wheel_ = function (a) {
    ...
    if (b) {
        ...
        var c = this.getMetrics_(), b = this.horizontalLayout_ ? c.viewLeft + b : c.viewTop + b,
...
Blockly.Flyout.prototype.show = function (a, b) {
    this.hide();
    ...
    b && this.svgBackground_.setAttribute("fill", b);
    for (var c = [], d = [], e = this.permanentlyDisabled_.length = 0, f; f = a[e]; e++)if (f.tagName && "BLOCK" == f.tagName.toUpperCase()) {
        var g = Blockly.Xml.domToBlock(f,
            this.workspace_);
        g.disabled && this.permanentlyDisabled_.push(g);
        c.push(g);
        f = parseInt(f.getAttribute("gap"), 10);
        d.push(isNaN(f) ? 3 * this.MARGIN : f)
    }
    this.layoutBlocks_(c, d);
...
Blockly.Flyout.prototype.layoutBlocks_ = function (a, b) {
    for (var c = this.MARGIN * this.workspace_.scale, d = this.RTL ? c : c + Blockly.BlockSvg.TAB_WIDTH, e = 0, f; f = a[e]; e++) {
        ...
        h = Blockly.createSvgElement("rect", {"fill-opacity": 0},
            null);
        h.tooltip = f;
...
Blockly.Flyout.prototype.reflowVertical = function (a) {
    ...
    if (this.width_ != b) {
        for (c = 0; d = a[c]; c++) {
            e = d.getHeightWidth();
            if (this.RTL) {
                var f = d.getRelativeToSurfaceXY().x, g = b - this.MARGIN, g = g / this.workspace_.scale,
...
Blockly.Flyout.prototype.offsetHorizontalRtlBlocks = function (a) {
    if (this.horizontalLayout_ && this.RTL) {
        ...
        try {
            ...
            b = {height: 0, y: 0, width: 0, x: 0}
        }
        b = Math.max(-b.x + this.MARGIN, this.width_ / this.workspace_.scale);
        for (var c = 0, d; d = a[c]; c++)d.moveBy(b, 0), d.flyoutRect_ && d.flyoutRect_.setAttribute("x", b + Number(d.flyoutRect_.getAttribute("x")))
    }
};
...
Blockly.Toolbox.prototype.init = function () {
    ...
    a.svgGroup_.parentNode.parentNode.appendChild(this.HtmlDiv);
...
Blockly.Toolbox.prototype.position = function () {
    var a = this.HtmlDiv;
    if (a) {
        var b = this.workspace_.getParentSvg(), c = goog.style.getPageOffset(b), b = Blockly.svgSize(b);
        ...
        c = goog.dom.getElementByClass("blocklyTreeRoot");
        0 < a.clientHeight - c.clientHeight ? goog.dom.classlist.remove(a, "scroll") : goog.dom.classlist.add(a, "scroll");
        c = this.HtmlDiv.parentElement.clientWidth || this.HtmlDiv.parentElement.parentNode.clientWidth;
        767 < c || 767 < c ? goog.dom.classlist.remove(a, "small") : goog.dom.classlist.add(a, "small");
        this.flyout_.position()
    }
};
Blockly.Toolbox.prototype.populate_ = function (a) {
    function b(a, h, k) {
        for (var g, m = null, l = 0, p; p = a.childNodes[l]; l++)if (p.tagName)switch (p.tagName.toUpperCase()) {
            case "CATEGORY":
                ...
                m.blocks = [];
                h.add(m);
                (g = p.getAttribute("custom")) ? m.blocks = g : b(p, m, k);
                g = p.getAttribute("colour");
                goog.isString(g) ? (g.match(/^#[0-9a-fA-F]{6}$/) ? m.hexColour = g : m.hexColour = Blockly.hueToRgb(g), e = !0) : m.hexColour = "";
                p.getAttribute("svg") && (g = "CAT_" + p.getAttribute("name").toUpperCase().replace("TOOLBOX_",
                        "") + "_RGB", g = Blockly[g], m.hexColour = g ? g : "#57e", f = !0);
                "true" == p.getAttribute("expanded") ? (m.blocks.length && c.setSelectedItem(m), m.setExpanded(!0)) : m.setExpanded(!1);
                m = p;
                break;
            case "SEP":
                m && ("CATEGORY" == m.tagName.toUpperCase() ? h.add(new Blockly.Toolbox.TreeSeparator(d.treeSeparatorConfig_)) : (p = parseFloat(p.getAttribute("gap")), isNaN(p) || (g = parseFloat(m.getAttribute("gap")), p = isNaN(g) ? p : g + p, m.setAttribute("gap", p))));
                break;
            case "BLOCK":
            case "SHADOW":
                h.blocks.push(p), m = p
...
Blockly.Toolbox.prototype.addColour_ = function (a, b) {
    for (var c, d = a || this.tree_, e = d.hexColour, d = d.getChildren(), f = 0, g; g = d[f]; f++) {
        var h = g.getRowElement();
        h && (this.hasColours_ ? c = "8px solid " + (g.hexColour || "#ddd") : (this.hasSvg_ && "blocklyTreeRow" === h.className && (b && (g.hexColour = e, g.getLabelElement().className += " blocklyTreeSub"), c = Blockly.CAT_ICON[g.name], g.setIconClass("toolboxIcon typcn typcn-" + c), g.setExpandedIconClass("toolboxIcon typcn typcn-" + c), h.style["background-color"] = g.hexColour, this.workspace_.RTL ?
            (g.getAfterLabelElement().style["float"] = "left", h.style["padding-right"] = "0", b && (h.style["margin-right"] = "20px")) : (g.getAfterLabelElement().style["float"] = "right", h.style["padding-left"] = "0", b && (h.style["margin-left"] = "20px"))), c = "none"), this.workspace_.RTL ? h.style.borderRight = c : h.style.borderLeft = c);
        this.addColour_(g, !0)
    }
};
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function (a) {
    ...
    if (a != this.selectedItem_ && a != b.tree_) {
        ...
        if (b.lastCategory_)if (this.toolbox_.hasSvg_) {
            var c = b.lastCategory_.getAfterLabelHtml().replace("blocklyConSelected", "blocklyCon");
            b.lastCategory_.setAfterLabelSafeHtml(goog.html.SafeHtml.from(c))
        } else b.lastCategory_.getRowElement().style.backgroundColor = "";
        a && (this.toolbox_.hasSvg_ ? a.blocks && a.blocks.length && (a.getRowElement().className +=
                " selected") : (c = a.hexColour || "#57e", a.getRowElement().style.backgroundColor = c), b.addColour_(a, !0));
        c = this.getSelectedItem();
        a && a.blocks && a.blocks.length ? (b.flyout_.show(a.blocks, this.toolbox_.hasSvg_ ? a.hexColour : null), b.lastCategory_ != a && b.flyout_.scrollToStart()) : b.flyout_.hide();
...
Blockly.Css.CONTENT = [".blocklySvg {", "outline: none;", "overflow: hidden;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 999;", "}", ".blocklyTooltipDiv {", "background-color: #333;", "border-radius: 2px;", "color: #fff;", "display: none;", "font-family: sans-serif;", "font-size: 9pt;", "opacity: 0.9;", "padding: 5px;", "position: absolute;", "z-index: 1000;", "}", ".blocklyResizeSE {", "cursor: se-resize;", "fill: #aaa;", "}", ".blocklyResizeSW {", "cursor: sw-resize;", "fill: #aaa;", "}",
    ".blocklyResizeLine {", "stroke: #888;", "stroke-width: 1;", "}", ".blocklyHighlightedConnectionPath {", "fill: #FFDC00;", "stroke: #FFDC00;", "stroke-width: 4px;", "}", ".blocklyPathLight {", "fill: none;", "stroke-linecap: round;", "stroke-width: 1;", "}", ".blocklySelected>.blocklyPath {", "stroke: #FFDC00;", "stroke-width: 3px;", "}", ".blocklySelected>.blocklyPathLight {", "display: none;", "}", ".blocklyDragging>.blocklyPath,", ".blocklyDragging>.blocklyPathLight {", "fill-opacity: .8;", "stroke-opacity: .8;", "}",
    ".blocklyDragging>.blocklyPathDark {", "display: none;", "}", ".blocklyDisabled>.blocklyPath {", "fill-opacity: .3;", "stroke-opacity: .3;", "}", ".blocklyDisabled>.blocklyPathLight,", ".blocklyDisabled>.blocklyPathDark {", "display: none;", "}", ".blocklyText {", "cursor: default;", "fill: #fff;", "font-family: sans-serif;", "font-size: 11pt;", "}", ".blocklyText.brick_label {", "fill: #000;", "font-weight: bold;", "font-size: 14pt;", "}", ".blocklyNonEditableText>text {", "pointer-events: none;", "}", ".blocklyNonEditableText>rect,",
    ".blocklyEditableText>rect {", "fill: #fff;", "fill-opacity: .6;", "}", ".blocklyNonEditableText>text,", ".blocklyEditableText>text {", "fill: #000;", "}", ".blocklyEditableText:hover>rect {", "stroke: #fff;", "stroke-width: 2;", "}", ".blocklyBubbleText {", "fill: #000;", "}", ".blocklySvg text {", "user-select: none;", "-moz-user-select: none;", "-webkit-user-select: none;", "cursor: inherit;", "}", ".blocklyHidden {", "display: none;", "}", ".blocklyFieldDropdown:not(.blocklyHidden) {", "display: block;", "}", ".blocklyIconGroup {",
    "cursor: default;", "}", ".blocklyIconGroup:not(:hover),", ".blocklyIconGroupReadonly {", "opacity: .6;", "}", ".blocklyIconShape {", "fill: #00f;", "stroke: #fff;", "stroke-width: 1px;", "}", ".blocklyIconSymbol {", "fill: #fff;", "}", ".blocklyIconMarkWarningError {", "fill: #000;", "}", 'g .blocklyIconGroup:hover path[class="blocklyIconMarkWarningError"] {', "fill: #fff;", "cursor: pointer", "}", 'g .blocklyIconGroup:hover circle[class="blocklyIconMarkWarningError"] {', "fill: #fff;", "cursor: pointer", "}", ".blocklyIconMarkWarningError:hover {",
    ...
    "}", ".blocklyContextMenu {", "border-radius: 4px;", "}", ".blocklyDropdownMenu {", "padding: 0 !important;", "}", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,", ".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {", "background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;", "}", ".blocklyToolboxDiv {", "background-color: #eee;", "overflow-x: hidden;", "overflow-y: visible;", "position: absolute;", "}", ".blocklyTreeRoot {", "padding: 10px 0;", "}", ".blocklyTreeRoot:focus {",
    "outline: none;", "}", ".blocklyTreeRow {", "height: 40px;", "line-height: 0;", "margin-bottom: 6px;", "}", ".blocklyToolboxDiv.small .blocklyTreeRow {", "width: 55px;", "}", ".blocklyToolboxDiv.scroll.small .blocklyTreeRow {", "width: 70px;", "}", ".blocklyHorizontalTree {", "float: left;", "margin: 1px 5px 8px 0;", "}", ".blocklyHorizontalTreeRtl {", "float: right;", "margin: 1px 0 8px 5px;", "}", ".blocklyTreeRow:hover {", "cursor: pointer", "}", ".blocklyTreeRow:not(.blocklyTreeSelected):hover {", "background-color: #e4e4e4;",
    "cursor: pointer", "}", ".toolboxIcon {", "display: inline-block;", "position: relative;", "top: 20px;", "left: 8px;", "font-size: 24px;", "color: #fff;", "float: left;", "height: 0;", "visibility: hidden", "}", ".blocklyToolboxDiv.small .toolboxIcon {", "visibility: visible", "}", ".blocklyTreeSeparator {", "border-bottom: solid #e5e5e5 1px;", "height: 0;", "margin: 5px 0;", "}", ".blocklyTreeSeparatorHorizontal {", "border-right: solid #e5e5e5 1px;", "width: 0;", "padding: 5px 0;", "margin: 0 5px;", "}", ".blocklyTreeIcon {",
    "background-image: url(<<<PATH>>>/sprites.png);", "height: 16px;", "vertical-align: middle;", "width: 16px;", "}", ".toolboxIcon.typcn:before {", "line-height:0", "}", ".blocklyTreeIconClosedLtr {", "background-position: -32px -1px;", "}", ".blocklyTreeIconClosedRtl {", "background-position: 0px -1px;", "}", ".blocklyTreeIconOpen {", "background-position: -16px -1px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedLtr {", "background-position: -32px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconClosedRtl {",
    "background-position: 0px -17px;", "}", ".blocklyTreeSelected>.blocklyTreeIconOpen {", "background-position: -16px -17px;", "}", ".blocklyTreeIconNone,", ".blocklyTreeSelected>.blocklyTreeIconNone {", "background-position: -48px -1px;", "}", ".blocklyTreeLabel {", "font-family: sans-serif;", "position: relative;", "top: 20px;", "float: left;", "font-size: 16pt;", "color: #fff;", "padding: 0 0 0 3px;", "}", ".blocklyTreeSub {", "  font-size: 10pt;", "}", ".blocklyToolboxDiv.small  .blocklyTreeLabel {", "visibility: hidden",
    "}", ".blocklyTreeRow::after {", 'background-image: url(\'data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg"><g><path class="blocklyConSelected" fill="%23eee" d="M1,41 v-11 l7.8,0.5 l2.5-5.5 c3-10.7,0.3-16.3-10.3-15.7 v-10 h30v41h-30z"></path><path class="blocklyToolboxBackground" stroke="%23eee" stroke-width="2" fill="none" d="M1,40 v-10 l7.8,0.5 l2.5-5.5 c3-10.7,0.3-16.3-10.3-15.7 v-10"></path></g></svg>\');', 'content: "";', "width: 15px;", "height: 40px;", "float: right;", "display: inline-block;",
    "}", ".blocklyTreeRow.selected::after {", 'background-image: url(\'data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg"><g><path class="blocklyConSelected" fill-opacity="0.7" fill="%23eee" d="M1,41 v-11 l7.8,0.5 l2.5-5.5 c3-10.7,0.3-16.3-10.3-15.7 v-10 h30v41h-30z"></path><path class="blocklyToolboxBackground" stroke="%23eee" stroke-width="2" fill="none" d="M1,40 v-10 l7.8,0.5 l2.5-5.5 c3-10.7,0.3-16.3-10.3-15.7 v-10"></path></g></svg>\');', "}", '.blocklyToolboxDiv[dir="RTL"] .blocklyTreeRow .blocklyTreeLabel {',
    "float: right;", "padding: 0 3px 0 6px;", "}", ".blocklyToolboxDiv.scroll .blocklyTreeRow::after {", "width: 15px;", "}", ".blocklyToolboxDiv.scroll.small .blocklyTreeRow::after {", "width: 30px;", "}", ".blocklyToolboxDiv.scroll.small .blocklyTreeLabel {", "padding: 0 17px 0 3px;", "}", ".blocklyTreeSelected .blocklyTreeLabel {", "color: #fff;", "}", ".blocklyWidgetDiv .goog-palette {", "outline: none;", "cursor: default;", "}", ".blocklyWidgetDiv .goog-palette-table {", "border: 1px solid #666;", "border-collapse: collapse;",
...
Blockly.WidgetDiv.position = function (a, b, c, d, e) {
    ...
    Blockly.WidgetDiv.DIV.style.height = c.height - b + d.y - 2 + "px"
};
Blockly.constants = {};
...
Blockly.inject = function (a, b) {
    ...
    var c = new Blockly.Options(b || {}), d = Blockly.createDom_(a, c), c = Blockly.createMainWorkspace_(d, c);
    Blockly.init_(c);
    c.markFocused();
...
Blockly.parseOptions_ = function (a) {
    var b, c, d, e, f = !!a.readOnly;
    if (f) {
        var g = null;
        var h = b = c = d = e = !1
    } else {
        g = Blockly.parseToolboxTree_(a.toolbox);
        e = !(!g || !g.getElementsByTagName("category").length);
        d = a.trashcan;
        void 0 === d && (d = e);
        var k = a.collapse;
        void 0 === k && (k = e);
    ...
    void 0 === m && (m = !0);
    var l = a.grid || {}, p = {};
    p.spacing = parseFloat(l.spacing) || 0;
    p.colour = l.colour || "#888";
    p.length =
        parseFloat(l.length) || 1;
    p.snap = 0 < p.spacing && !!l.snap;
    l = "https://blockly-demo.appspot.com/static/media/";
    a.media ? l = a.media : a.path && (l = a.path + "media/");
    var q = a.zoom || {}, r = {};
    r.controls = void 0 === q.controls ? !1 : !!q.controls;
    r.wheel = void 0 === q.wheel ? !1 : !!q.wheel;
    r.startScale = void 0 === q.startScale ? 1 : parseFloat(q.startScale);
    r.maxScale = void 0 === q.maxScale ? 3 : parseFloat(q.maxScale);
    r.minScale = void 0 === q.minScale ? .3 : parseFloat(q.minScale);
    r.scaleSpeed = void 0 === q.scaleSpeed ? 1.2 : parseFloat(q.scaleSpeed);
    q = !!a.realtime;
    return {
        RTL: !!a.rtl,
        collapse: k,
        ...
        zoomOptions: r,
        enableRealtime: q,
        realtimeOptions: q ? a.realtimeOptions : void 0,
        checkInTask: a.checkInTask || !1,
        variableDeclaration: !!a.variableDeclaration,
        robControls: !!a.robControls
    }
};
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.createSvgElement("svg", {
            ...
            version: "1.1",
            "class": "blocklySvg"
        }, a), d = Blockly.createSvgElement("defs", {}, c), e = String(Math.random()).substring(2),
        f = Blockly.createSvgElement("filter", {id: "blocklyEmbossFilter" + e}, d);
...
Blockly.createMainWorkspace_ = function (a, b) {
    ...
    b.readOnly || b.hasScrollbars || c.addChangeListener(function () {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop <
                f || a.contentTop + a.contentHeight > a.viewHeight + f || a.contentLeft < (b.RTL ? a.viewLeft : e) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + e))for (var g = c.getTopBlocks(!1), h = 0, k; k = g[h]; h++) {
                var n = k.getRelativeToSurfaceXY(), m = k.getHeightWidth(), l = f + 25 - m.height - n.y;
                0 < l && k.moveBy(0, l);
                l = f + a.viewHeight - 25 - n.y;
                0 > l && k.moveBy(0, l);
                l = 25 + e - n.x - (b.RTL ? 0 : m.width);
                0 < l && k.moveBy(l, 0);
                n = e + a.viewWidth - 25 - n.x + (b.RTL ? m.width : 0);
                0 > n && k.moveBy(n, 0)
            }
        }
    });
...
Blockly.mouseToSvg = function (a, b) {
    ...
    c.x = a.clientX;
    c.y = a.clientY;
    var d = b.getScreenCTM(), d = d.inverse();
...
Blockly.onMouseMove_ = function (a) {
    if (!(a.touches && 2 <= a.touches.length)) {
        ...
        if (b.isScrolling) {
            var c = a.clientX - b.startDragMouseX, d = a.clientY - b.startDragMouseY, e = b.startDragMetrics,
                f = b.startScrollX + c, g = b.startScrollY + d, f = Math.min(f, -e.contentLeft),
                g = Math.min(g, -e.contentTop), f = Math.max(f, e.viewWidth - e.contentLeft - e.contentWidth),
...
Blockly.getMainWorkspaceMetrics_ = function () {
    ...
    var f = e.width *
        this.scale;
    var g = e.height * this.scale, h = e.x * this.scale, k = e.y * this.scale;
