...
Blockly.Blocks.robSensors_battery_voltage={init:function(){this.setColour(Blockly.CAT_SENSOR_RGB);this.appendDummyInput().appendField(Blockly.Msg.GET).appendField(Blockly.Msg.SENSOR_BATTERY);this.setOutput(!0,"Number");this.setTooltip(Blockly.Msg.BATTERY_GETSAMPLE_TOOLTIP);this.sensorMode_="COLOUR"}};
// Copyright 2012 Google Inc.  Apache License 2.0
<<<<<<< 50a5a3256cba9f8cbf563d5fecf6cc698f20a697
...
Blockly.Blocks.makeblockSensors_gyroscope_getSample = {
    init: function () {
        ...
        var a = new Blockly.FieldDropdown([["X", "X"], ["Y", "Y"]]),
            b = new Blockly.FieldDropdown([["Port 1", "1"], ["Port 2", "2"], ["Port 3", "3"], ["Port 4", "4"]]);
        this.appendDummyInput().appendField(Blockly.Msg.SENSOR_GET_SAMPLE).appendField(a, "MODE").appendField(Blockly.Msg.SENSOR_GYRO).appendField(b, "SENSORPORT");
        this.setOutput(!0, "Number");
        this.setTooltip(Blockly.Msg.GYRO_TOOLTIP)
    }
};
Blockly.Blocks.makeblockSensors_accelerometer_getSample = {
    init: function () {
        ...
        var a = new Blockly.FieldDropdown([["X", "X"], ["Y", "Y"], ["Z", "Z"]]),
            b = new Blockly.FieldDropdown([["Port 1", "1"], ["Port 2", "2"], ["Port 3", "3"], ["Port 4", "4"]]);
        this.appendDummyInput().appendField(Blockly.Msg.SENSOR_GET_SAMPLE).appendField(a, "COORDINATE").appendField(Blockly.Msg.NAO_ACCELEROMETER).appendField(b, "SENSORPORT");
        this.setOutput(!0, "Number");
        this.setTooltip(Blockly.Msg.GYRO_TOOLTIP)
    }
};
Blockly.Blocks.makeblockSensors_ambientlight = {
    init: function () {
        this.setColour(Blockly.CAT_SENSOR_RGB);
        var a = new Blockly.FieldDropdown([["Port internal", "0"], ["Port 1", "1"], ["Port 2", "2"], ["Port 3", "3"], ["Port 4", "4"]]);
...
Blockly.Blocks.makeblockColours = {};
...
this.hasReturnValue_=!1):"robProcedures_defreturn"!=b.type||this.hasReturnValue_||(this.removeInput("VALUE"),this.appendValueInput("VALUE").appendField(Blockly.Msg.PROCEDURES_DEFRETURN_RETURN),this.hasReturnValue_=!0),"robProcedures_defreturn"==b.type&&(this.returnType_=b.getReturnType(),this.getInput("VALUE").setCheck(this.returnType_),this.render()),this.setWarningText(null)):(this.returnType_=null,this.hasReturnValue&&this.getInput("VALUE").setCheck(this.returnType_),this.setWarningText(Blockly.Msg.PROCEDURES_IFRETURN_WARNING))}};Blockly.Blocks.naoSensors={};
...
this.getInputTargetBlock("VAR");a&&"variables_get"!==a.type&&(a.unplug(),a.bumpNeighbours_())}}};Blockly.Blocks.mbedControls={};
...
Blockly.Blocks.naoActions_rasta={init:function(){this.setColour(Blockly.CAT_ACTION_RGB);this.appendValueInput("DURATION").appendField(Blockly.Msg.NAO_RASTA+" "+Blockly.Msg.PLAY_DURATION).setCheck("Number");this.setPreviousStatement(!0);this.setNextStatement(!0);this.setTooltip(Blockly.Msg.NAO_RASTA_TOOLTIP)}};Blockly.Blocks.robControls={};
...
this.listType_);Blockly.Variables.updateType(this.getFieldValue("VAR"),a)},customContextMenu:Blockly.Blocks.robControls_for.customContextMenu};Blockly.Blocks.lists={};Blockly.Blocks.lists.HUE=260;Blockly.Blocks.lists_create_empty={init:function(){this.jsonInit({message0:Blockly.Msg.LISTS_CREATE_EMPTY_TITLE,output:"Array",colour:Blockly.CAT_LIST_RGB,tooltip:Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP,helpUrl:Blockly.Msg.LISTS_CREATE_EMPTY_HELPURL})}};
...
this.appendValueInput("P2").appendField("2").setAlign(Blockly.ALIGN_RIGHT).setCheck("Port");this.setTooltip(Blockly.Msg.MICROBITBRICK_TOOLTIP)}};Blockly.Blocks.naoControls={};
...
this.waitCount_);this.waitCount_--;0==this.waitCount_&&this.removeInput("DO0")}1<=this.waitCount_?1==this.waitCount_&&(this.setMutatorMinus(new Blockly.MutatorMinus(this)),this.render()):(this.mutatorMinus.dispose(),this.mutatorMinus=null,this.render())}};Blockly.Blocks.colour={};Blockly.Blocks.colour.HUE=20;Blockly.Blocks.colour_picker={init:function(){this.jsonInit({message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",colour:Blockly.Blocks.colour.HUE,helpUrl:Blockly.Msg.COLOUR_PICKER_HELPURL});var a=this;this.setTooltip(function(){var b=a.getParent();return b&&b.getInputsInline()&&b.tooltip||Blockly.Msg.COLOUR_PICKER_TOOLTIP})}};
...
this.setOutput(!0,"Colour");this.setTooltip(Blockly.Msg.COLOUR_BLEND_TOOLTIP)}};Blockly.Blocks.robBrick={};
...
Blockly.Blocks.robBrick_actor={init:function(){this.setColour(Blockly.CAT_ACTION_RGB);this.appendDummyInput("ACTOR").appendField(Blockly.Msg.MOTOR_OTHER);this.setOutput(!0,"Actor");this.setTooltip(Blockly.Msg.ACTOR_TOOLTIP)}};Blockly.Blocks.texts={};Blockly.Blocks.texts.HUE=160;
...
this.setPreviousStatement(!0);this.setNextStatement(!0);var a=this;this.setTooltip(function(){return Blockly.Msg.TEXT_APPEND_TOOLTIP.replace("%1",a.getFieldValue("VAR"))})}};Blockly.Blocks.mbedImage={};
...
this.elseIfCount_?1==this.elseIfCount_&&(this.setMutatorMinus(new Blockly.MutatorMinus(this)),this.render()):(this.mutatorMinus.dispose(),this.mutatorMinus=null)}};Blockly.Blocks.mbedCommunication={};
...
this.setInputsInline(!1)},mutationToDom:function(){if(void 0===this.dataType_)return!1;var a=document.createElement("mutation");a.setAttribute("datatype",this.dataType_);return a},domToMutation:function(a){(this.dataType_=a.getAttribute("datatype"))&&this.setOutput(!0,this.dataType_)},updateType_:function(a){this.dataType_=a;this.setOutput(!0,this.dataType_)}};Blockly.Blocks.naoColour={};Blockly.Blocks.naoColour_picker={init:function(){this.jsonInit({message0:"%1",args0:[{type:"field_colour",name:"COLOUR",colour:"#ff0000"}],output:"Colour",colour:Blockly.CAT_COLOUR_RGB,helpUrl:Blockly.Msg.mbedColour_PICKER_HELPURL});var a=this;this.setTooltip(function(){var b=a.getParent();return b&&b.getInputsInline()&&b.tooltip||Blockly.Msg.mbedColour_PICKER_TOOLTIP})}};
...
"Colour");this.setTooltip(Blockly.Msg.COLOUR_RGB_TOOLTIP)}};Blockly.Blocks.robActions={};
...
Blockly.Procedures.updateCallers(this.getFieldValue("VAR"),a,Blockly.mainWorkspace,0)},contextMenuType_:"variables_get",customContextMenu:Blockly.Blocks.variables_get.customContextMenu};Blockly.Blocks.robColour={};
...
"COLOUR");this.setOutput(!0,"Colour");this.setTooltip(Blockly.Msg.COLOUR_PICKER_TOOLTIP)}};Blockly.Blocks.mbedSensors={};
...
" 3","3"],[Blockly.Msg.SENSOR_GROVE+" A0","4"],[Blockly.Msg.SENSOR_GROVE+" A1","5"]],a=this.getField("PIN"),a.menuGenerator_=b,a.setValue("0"),a.setText(Blockly.Msg.SENSOR_PIN+" 0"))}};
>>>>>>> #504 client side implementation for account activation
