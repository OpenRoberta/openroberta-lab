...
Blockly.Blocks['procedures_defnoreturn'] = {
    ...
    init : function() {
        ...
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE).appendField(new Blockly.FieldTextInput(name, Blockly.Procedures.rename),
...
Blockly.Blocks['procedures_defreturn'] = {
    ...
    init : function() {
        ...
        this.appendDummyInput().appendField(Blockly.Msg.PROCEDURES_DEFRETURN_TITLE).appendField(new Blockly.FieldTextInput(name, Blockly.Procedures.rename),
                'NAME').appendField('', 'PARAMS');
...
Blockly.Blocks['procedures_mutatorarg'] = {
    ...
    /**
     * Obtain a valid name for the procedure. Merge runs of whitespace. Strip
     * leading and trailing whitespace. Beyond this, all names are legal.
     * 
     * @param {string}
     *            newVar User-supplied name.
...
Blockly.Blocks['procedures_callnoreturn'] = {
    ...
    setProcedureParameters : function(paramNames, paramIds) {
        ...
        this.quarkArguments_ = paramIds;
        for (var x = 0; x < this.arguments_.length; x++) {
            var input = this.appendValueInput('ARG' + x).setAlign(Blockly.ALIGN_RIGHT).appendField(this.arguments_[x]);
            if (this.quarkArguments_) {
