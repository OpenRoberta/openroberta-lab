...
Blockly.Blocks['robActions_motor_on'] = {
  ...
  init : function() {
    ...
    this.appendValueInput('POWER').appendField(motorPort, 'MOTORPORT')
        .appendField(Blockly.Msg.ON).appendField(Blockly.Msg.MOTOR_SPEED)
        .setCheck('Number');
...
Blockly.Blocks['robActions_motor_on_for'] = {
  ...
  init : function() {
    ...
    this.appendValueInput('POWER').appendField(motorPort, 'MOTORPORT')
        .appendField(Blockly.Msg.ON).appendField(Blockly.Msg.MOTOR_SPEED)
        .setCheck('Number');
    this.appendValueInput('VALUE').setAlign(Blockly.ALIGN_RIGHT).appendField(
        Blockly.Msg.FOR).appendField(motorRotation, 'MOTORROTATION').setCheck(
        'Number');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Blocks['robActions_motor_setPower'] = {
  ...
  init : function() {
    ...
    var motorPort = new Blockly.FieldDropdown([
        ...
        [ Blockly.Msg.MOTOR_PORT + ' C', 'C' ],
        [ Blockly.Msg.MOTOR_PORT + ' D', 'D' ] ]);
    this.appendValueInput('POWER').appendField(Blockly.Msg.SET).appendField(
...
Blockly.Blocks['robActions_motor_stop'] = {
  ...
  init : function() {
    ...
    this.appendDummyInput().appendField(Blockly.Msg.MOTOR_STOP).appendField(
...
Blockly.Blocks['robActions_motorDiff_turn_for'] = {
  ...
  init : function() {
    ...
    this.appendValueInput('POWER').appendField(Blockly.Msg.MOTOR_TURN)
        .appendField(dropdown, 'DIRECTION')
        .appendField(Blockly.Msg.MOTOR_SPEED).setCheck('Number');
    this.appendValueInput('DEGREE').setAlign(Blockly.ALIGN_RIGHT).appendField(
...
Blockly.Blocks['robActions_brickLight_on'] = {
  ...
  init : function() {
    ...
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(
        Blockly.Msg.BRICKLIGHT_COLOR)
        .appendField(dropdownColor, 'SWITCH_COLOR');
    this.appendDummyInput().setAlign(Blockly.ALIGN_RIGHT).appendField(
...
Blockly.Blocks['robActions_brickLight_off'] = {
  ...
  init : function() {
    this.setColourRGB(Blockly.CAT_ROBACTIONS_RGB);
    // this.setInputsInline(true);
    this.appendDummyInput().appendField(Blockly.Msg.BRICKLIGHT).appendField(
        Blockly.Msg.OFF);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
