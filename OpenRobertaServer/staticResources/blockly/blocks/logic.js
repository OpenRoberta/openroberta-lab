...
Blockly.Blocks['controls_if'] = {
    ...
    domToMutation : function(xmlElement) {
        ...
        for (var x = 1; x <= this.elseifCount_; x++) {
            this.appendValueInput('IF' + x).setCheck('Boolean').appendField(Blockly.Msg.CONTROLS_IF_MSG_ELSEIF);
...
Blockly.Blocks['logic_boolean'] = {
     ...
     */
    init : function() {
        var BOOLEANS = [ [ Blockly.Msg.LOGIC_BOOLEAN_TRUE, 'TRUE' ], [ Blockly.Msg.LOGIC_BOOLEAN_FALSE, 'FALSE' ] ];
        this.setHelpUrl(Blockly.Msg.LOGIC_BOOLEAN_HELPURL);
        this.setColourRGB(Blockly.CAT_LOGIC_RGB);
        this.setOutput(true, 'Boolean');
        this.appendDummyInput().appendField(new Blockly.FieldDropdown(BOOLEANS), 'BOOL');
