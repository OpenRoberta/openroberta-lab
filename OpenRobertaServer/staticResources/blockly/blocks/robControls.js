...
Blockly.Blocks['robControls_start'] = {
   ...
   * should not be available in any toolbox. For new task see
  ...
  init : function() {
    ...
    this.appendDummyInput().appendField(
        Blockly.Msg.START + ' ' + Blockly.Msg.START_PROGRAM);
...
Blockly.Blocks['robControls_activity'] = {
  ...
  init : function() {
    this.setColourRGB(Blockly.CAT_ROBACTIVITY_RGB);
    this.appendValueInput('ACTIVITY').appendField(Blockly.Msg.START_ACTIVITY)
        .setCheck('String');
    this.setInputsInline(true);
    this.setPreviousStatement(false);
    this.setNextStatement(true);
...
Blockly.Blocks['robControls_start_activity'] = {
  ...
  init : function() {
    this.setColourRGB(Blockly.CAT_ROBACTIVITY_RGB);
    this.appendValueInput('ACTIVITY').appendField(
        Blockly.Msg.START + ' ' + Blockly.Msg.START_ACTIVITY)
        .setCheck('String');
    this.setInputsInline(true);
...
Blockly.Blocks['robControls_wait'] = {
  ...
  init : function() {
    ...
    // this.setInputsInline(true);
    this.appendValueInput('WAIT0').appendField(Blockly.Msg.WAIT).setCheck(
        'Boolean');
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.waitCount_ = 0;
  ...
  domToMutation : function(xmlElement) {
    ...
    for (var x = 1; x <= this.waitCount_; x++) {
      ...
      this.appendValueInput('WAIT' + x).appendField(
          Blockly.Msg.CONTROLS_WAIT_OR).setCheck('Boolean');
...
Blockly.Blocks['robControls_wait_for'] = {
  ...
  domToMutation : function(xmlElement) {
    ...
    for (var x = 1; x <= this.waitCount_; x++) {
      ...
      this.appendValueInput('WAIT' + x).appendField(Blockly.Msg.WAIT).setCheck(
          'Boolean');
      this.appendStatementInput('DO' + x).appendField(
          Blockly.Msg.CONTROLS_REPEAT_INPUT_DO);
    }
    ...
    if (num == 1) {
      ...
      if (this.waitCount_ == 1)
        this.appendStatementInput('DO0').appendField(
            Blockly.Msg.CONTROLS_REPEAT_INPUT_DO);
      this.appendValueInput('WAIT' + this.waitCount_).appendField(
          Blockly.Msg.WAIT_OR).setCheck('Boolean');
      this.appendStatementInput('DO' + this.waitCount_).appendField(
          Blockly.Msg.CONTROLS_REPEAT_INPUT_DO);
