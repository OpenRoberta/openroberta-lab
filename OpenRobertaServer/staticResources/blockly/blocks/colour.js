...
Blockly.Blocks['colour_rgb'] = {
    ...
    init : function() {
        ...
        this.setColour(20);
        this.appendValueInput('RED').setCheck('Number').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOUR_RGB_TITLE).appendField(
...
Blockly.Blocks['colour_blend'] = {
    ...
    init : function() {
        ...
        this.setColour(20);
        this.appendValueInput('COLOUR1').setCheck('Colour').setAlign(Blockly.ALIGN_RIGHT).appendField(Blockly.Msg.COLOUR_BLEND_TITLE).appendField(
