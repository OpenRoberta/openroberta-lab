...
Blockly.Flyout.prototype.position_ = function() {
    ...
    path.push('a', this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, Blockly.RTL ? 0 : 1, Blockly.RTL ? -this.CORNER_RADIUS : this.CORNER_RADIUS,
            this.CORNER_RADIUS);
...
Blockly.Flyout.prototype.show = function(xmlList, opt_color) {
    ...
    if (opt_color) {
        ...
        this.svgBackground_.setAttribute('fill', '#bbbbbb');
        this.svgBackground_.setAttribute('class', 'blocklyFlyoutBackgroundSelected');
    }
