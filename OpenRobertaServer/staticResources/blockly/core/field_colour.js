 ...
 * 
 * @param {string}
 *            colour The initial colour in '#rrggbb' format.
 * @param {Function}
 *            opt_changeHandler A function that is executed when a new colour is
 *            selected. Its sole argument is the new colour value. Its return
 *            value becomes the selected colour, unless it is undefined, in
 *            which case the new colour stands, or it is null, in which case the
 *            change is aborted.
 ...
 * 
 * @param {string}
 *            colour The new colour in '#rrggbb' format.
 */
...
/**
 * An array of colour strings for the palette. See bottom of this page for the
 * default:
