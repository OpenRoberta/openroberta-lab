 ...
 *            e Mouse event.
 * @param {!Array.
 *            <!Object>} options Array of menu options.
 */
Blockly.ContextMenu.show = function(e, options) {
    ...
    /*
     * Here's what one option object looks like: {text: 'Make It So', enabled:
     * true, callback: Blockly.MakeItSo}
     */
...
/**
 * Create a callback function that creates and configures a block, then places
 * the new block next to the original.
 * 
 * @param {!Blockly.Block}
 *            block Original block.
 * @param {!Element}
 *            xml XML representation of new block.
