...
/**
 * @fileoverview Utility methods. These methods are not specific to Blockly, and
 *               could be factored out if a JavaScript framework such as Closure
 *               were used.
...
/**
 * Add a CSS class to a element. Similar to Closure's goog.dom.classes.add,
 * except it handles SVG elements.
 * 
 * @param {!Element}
...
/**
 * Remove a CSS class from a element. Similar to Closure's
 * goog.dom.classes.remove, except it handles SVG elements.
 * 
 * @param {!Element}
 *            element DOM element to remove class from.
 * @param {string}
 ...
 * 
 * @param {!Node}
 *            node Node upon which to listen.
 * @param {string}
 *            name Event name to listen to (e.g. 'mousedown').
 * @param {Object}
 *            thisObject The value of 'this' in the function.
 * @param {!Function}
 *            func Function to call when event is triggered.
...
/**
 * The TOUCH_MAP lookup dictionary specifies additional touch events to fire, in
 * conjunction with mouse events.
 * 
 * @type {Object}
 */
 ...
 * 
 * @param {!Array.
 *            <!Array>} bindData Opaque data from bindEvent_. This list is
 ...
 * 
 * @param {!EventTarget}
 *            node The event's target node.
 * @param {string}
 *            eventName Name of event (e.g. 'click').
 */
...
/**
 * Return the coordinates of the top-left corner of this element relative to its
 * parent.
 * 
 * @param {!Element}
 *            element Element to find the coordinates of.
...
/**
 * Return the absolute coordinates of the top-left corner of this element. The
 * origin (0,0) is the top-left corner of the Blockly svg.
 * 
 * @param {!Element}
 *            element Element to find the coordinates of.
 * @return {!Object} Object with .x and .y properties.
...
/**
 * Return the absolute coordinates of the top-left corner of this element. The
 * origin (0,0) is the top-left corner of the page body.
 * 
 * @param {!Element}
 *            element Element to find the coordinates of.
 * @return {!Object} Object with .x and .y properties.
 ...
 * @param {Element=}
 *            opt_parent Optional parent on which to append the element.
 ...
 * @param {boolean}
 *            toSvg True to convert to SVG coordinates. False to convert to
 *            mouse/HTML coordinates.
...
/**
 * Return the converted coordinates of the given mouse event. The origin (0,0)
 * is the top-left corner of the Blockly svg.
 * 
 * @param {!Event}
 *            e Mouse event.
 * @return {!Object} Object with .x and .y properties.
...
/**
 * Given an array of strings, return the length of the common prefix. Words may
 * not be split. Any space after a word is included in the length.
 * 
 * @param {!Array.
 *            <string>} array Array of strings.
 * @param {?number}
 *            opt_shortest Length of shortest string.
...
/**
 * Given an array of strings, return the length of the common suffix. Words may
 * not be split. Any space after a word is included in the length.
 * 
 * @param {!Array.
 *            <string>} array Array of strings.
