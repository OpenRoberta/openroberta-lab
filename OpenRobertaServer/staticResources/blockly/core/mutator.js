...
/**
 * @fileoverview Object representing a mutator dialog. A mutator allows the user to change the shape of a block using a nested blocks editor.
...
Blockly.Mutator.prototype.createEditor_ = function() {
    /*
     * Create the editor. Here's the markup that will be generated: <svg> <rect class="blocklyMutatorBackground" /> [Flyout] [Workspace] </svg>
     */
...
/**
 * Callback function triggered when the bubble has resized. Resize the workspace accordingly.
 * 
 * @private
 */
...
/**
 * Update the source block when the mutator's blocks are changed. Delete or bump any block that's out of bounds. Fired whenever a change is made to the
 * mutator's workspace.
 * 
 * @private
 */
...
/**
 * Return an object with all the metrics required to size scrollbars for the mutator flyout. The following properties are computed: .viewHeight: Height of the
 * visible rectangle, .absoluteTop: Top-edge of view. .absoluteLeft: Left-edge of view.
 * 
 * @return {!Object} Contains size and position metrics of mutator dialog's workspace.
 * @private
 */
