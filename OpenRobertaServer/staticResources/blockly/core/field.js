...
/**
 * @fileoverview Input field. Used for editable titles, variables, etc. This is
 *               an abstract class that defines the UI on the block. Actual
 *               instances would be Blockly.FieldTextInput,
 *               Blockly.FieldDropdown, etc.
...
/**
 * Clone this Field. This must be implemented by all classes derived from Field.
 * Since this class should not be instantiated, calling this method throws an
 * exception.
 * 
...
/**
 * Gets the group element for this editable field. Used for measuring the size
 * and for positioning.
 * 
...
/**
 * Draws the border with the correct width. Saves the computed width in a
 * property.
 * 
 * @private
 */
...
/**
 * By default there is no difference between the human-readable text and the
 * language-neutral values. Subclasses (such as dropdown) may define this.
 * 
 * @return {string} Current text.
 */
...
Blockly.Field.prototype.onMouseUp_ = function(e) {
    if ((goog.userAgent.IPHONE || goog.userAgent.IPAD) && e.layerX !== 0 && e.layerY !== 0) {
