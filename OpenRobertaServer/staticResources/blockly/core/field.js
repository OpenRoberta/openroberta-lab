...
/**
 * @fileoverview Input field. Used for editable titles, variables, etc. This is an abstract class that defines the UI on the block. Actual instances would be
 *               Blockly.FieldTextInput, Blockly.FieldDropdown, etc.
...
/**
 * Clone this Field. This must be implemented by all classes derived from Field. Since this class should not be instantiated, calling this method throws an
 * exception.
 * 
 ...
 *            newTip Text for tooltip or a parent element to link to for its tooltip.
 */
