...
Blockly.Field.prototype.init = function(block) {
  ...
  this.mouseUpWrapper_ = Blockly.bindEvent_(this.fieldGroup_, 'mouseup', this,
      this.onMouseUp_);
...
Blockly.Field.prototype.render_ = function() {
  ...
  if (this.borderRect_) {
    this.borderRect_
        .setAttribute('width', width + Blockly.BlockSvg.SEP_SPACE_X);
  }
...
Blockly.Field.prototype.onMouseUp_ = function(e) {
  if ((goog.userAgent.IPHONE || goog.userAgent.IPAD) && e.layerX !== 0
      && e.layerY !== 0) {
