...
Blockly.parseOptions_ = function(options) {
    ...
    if (readOnly) {
        ...
        var hasCategories = Boolean(tree && tree.getElementsByTagName('category').length);
...
Blockly.createDom_ = function(container) {
    ...
    /*
     * <defs> ... filters go here ... </defs>
     */
    var defs = Blockly.createSvgElement('defs', {}, svg);
    var filter, feSpecularLighting, feMerge, pattern;
    /*
     * <filter id="blocklyEmboss"> <feGaussianBlur in="SourceAlpha"
     * stdDeviation="1" result="blur"/> <feSpecularLighting in="blur"
     * surfaceScale="1" specularConstant="0.5" specularExponent="10"
     * lighting-color="white" result="specOut"> <fePointLight x="-5000"
     * y="-10000" z="20000"/> </feSpecularLighting> <feComposite in="specOut"
     * in2="SourceAlpha" operator="in" result="specOut"/> <feComposite
     * in="SourceGraphic" in2="specOut" operator="arithmetic" k1="0" k2="1"
     * k3="1" k4="0"/> </filter>
     */
    ...
    /*
     * <filter id="blocklyTrashcanShadowFilter"> <feGaussianBlur
     * in="SourceAlpha" stdDeviation="2" result="blur"/> <feOffset in="blur"
     * dx="1" dy="1" result="offsetBlur"/> <feMerge> <feMergeNode
     * in="offsetBlur"/> <feMergeNode in="SourceGraphic"/> </feMerge> </filter>
     */
    filter = Blockly.createSvgElement('filter', {
    ...
    /*
     * <filter id="blocklyShadowFilter"> <feGaussianBlur stdDeviation="2"/>
     * </filter>
     */
    filter = Blockly.createSvgElement('filter', {
     ...
     * width="10" height="10"> <rect width="10" height="10" fill="#aaa" /> <path
        ...
        if (Blockly.hasCategories) {
            ...
            var workspaceChanged = function() {
                if (Blockly.Block.dragMode_ == 0) {
                    ...
                    if (metrics.contentTop < 0 || metrics.contentTop + metrics.contentHeight > metrics.viewHeight + metrics.viewTop
                        ...
                        for (var b = 0, block; block = blocks[b]; b++) {
                            ...
                            if (block.isDeletable() && (Blockly.RTL ? blockXY.x - metrics.viewWidth : -blockXY.x) > MARGIN * 2) {
