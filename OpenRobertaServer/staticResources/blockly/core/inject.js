...
Blockly.createDom_ = function(container) {
   ...
   * lighting-color="white" result="specOut"> <fePointLight x="-5000" y="-10000"
   * z="20000"/> </feSpecularLighting> <feComposite in="specOut"
  ...
  /*
   * <filter id="blocklyTrashcanShadowFilter"> <feGaussianBlur in="SourceAlpha"
   * stdDeviation="2" result="blur"/> <feOffset in="blur" dx="1" dy="1"
   * result="offsetBlur"/> <feMerge> <feMergeNode in="offsetBlur"/> <feMergeNode
      ...
      var workspaceChanged = function() {
        if (Blockly.Block.dragMode_ == 0) {
          ...
          if (metrics.contentTop < 0
              ...
              || metrics.contentLeft + metrics.contentWidth > (Blockly.RTL ? metrics.viewWidth
            ...
            for (var b = 0, block; block = blocks[b]; b++) {
              ...
              if (block.isDeletable()
                  && (Blockly.RTL ? blockXY.x - metrics.viewWidth : -blockXY.x) > MARGIN * 2) {
...
Blockly.init_ = function() {
  ...
  soundBinds
      .push(Blockly.bindEvent_(document, 'mousemove', null, unbindSounds));
  soundBinds.push(Blockly
  ...
  Blockly.loadAudio_([ 'media/delete.mp3', 'media/delete.ogg',
      'media/delete.wav' ], 'delete');
};
