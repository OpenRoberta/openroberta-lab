...
Blockly.FieldAngle.prototype.showEditor_ = function() {
    ...
    for (var a = 0; a < 360; a += 15) {
        Blockly.createSvgElement('line', {
            ...
            'y1' : Blockly.FieldAngle.HALF,
            'x2' : Blockly.FieldAngle.HALF + Blockly.FieldAngle.RADIUS - (a % 45 == 0 ? 10 : 5),
            'y2' : Blockly.FieldAngle.HALF,
            'class' : 'blocklyAngleMarks',
            'transform' : 'rotate(' + a + ', ' + Blockly.FieldAngle.HALF + ', ' + Blockly.FieldAngle.HALF + ')'
        }, svg);
    }
...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
    ...
    if (isNaN(angleRadians)) {
        ...
        this.gauge_.setAttribute('d', 'M ' + Blockly.FieldAngle.HALF + ', ' + Blockly.FieldAngle.HALF + ' h ' + Blockly.FieldAngle.RADIUS + ' A '
                + Blockly.FieldAngle.RADIUS + ',' + Blockly.FieldAngle.RADIUS + ' 0 ' + largeFlag + ' 0 ' + x + ',' + y + ' z');
