 ...
 * @param {Function}
 *          opt_changeHandler An optional function that is called to validate
 *          any constraints on what the user entered. Takes the new text as an
 *          argument and returns the accepted text or null to abort the change.
...
/**
 * Round angles to the nearest 15 degrees when using mouse. Set to 0 to disable
 * rounding.
 */
...
Blockly.FieldAngle.prototype.showEditor_ = function() {
  var noFocus = goog.userAgent.MOBILE || goog.userAgent.ANDROID
      || goog.userAgent.IPAD;
  ...
  for (var a = 0; a < 360; a += 15) {
    Blockly.createSvgElement('line', {
      ...
      'transform' : 'rotate(' + a + ', ' + Blockly.FieldAngle.HALF + ', '
  ...
  this.moveWrapper1_ = Blockly.bindEvent_(circle, 'mousemove', this,
      this.onMouseMove);
  this.moveWrapper2_ = Blockly.bindEvent_(this.gauge_, 'mousemove', this,
      this.onMouseMove);
  this.updateGraph_();
};
...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
  ...
  if (isNaN(angleRadians)) {
    ...
    this.gauge_.setAttribute('d', 'M ' + Blockly.FieldAngle.HALF + ', '
        + Blockly.FieldAngle.HALF + ' h ' + Blockly.FieldAngle.RADIUS + ' A '
        + Blockly.FieldAngle.RADIUS + ',' + Blockly.FieldAngle.RADIUS + ' 0 '
        + largeFlag + ' 0 ' + x + ',' + y + ' z');
