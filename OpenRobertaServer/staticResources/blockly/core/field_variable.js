 ...
 * 
 * @param {?string}
 *            varname The default name for the variable. If null, a unique
 *            variable name will be generated.
 * @param {Function}
 *            opt_changeHandler A function that is executed when a new option is
 *            selected. Its sole argument is the new option value. Its return
 *            value is ignored.
...
/**
 * Return a sorted list of variable names for variable dropdown menus. Include a
 * special option at the end for creating a new variable name.
 * 
...
/**
 * Event handler for a change in variable name. Special case the 'New
 * variable...' and 'Rename variable...' options. In both of these special
 * cases, prompt the user for a new name.
 * 
 * @param {string}
 *            text The selected dropdown menu option.
