 ...
 *               temporary HTML UI widgets that the user is currently
 *               interacting with. E.g. text input areas, colour pickers,
 *               context menus.
 ...
 * 
 * @param {!Object}
 *            newOwner The object that will be using this container.
 * @param {Function}
 *            dispose Optional cleanup function to be run when the widget is
 *            closed.
 */
 ...
 * 
 * @param {!Object}
 *            oldOwner The object that was using this container.
 */
 ...
 * 
 * @param {number}
 *            anchorX Horizontal location (window coorditates, not body).
 * @param {number}
 *            anchorY Vertical location (window coorditates, not body).
 * @param {!goog.math.Size}
 *            windowSize Height/width of window.
 * @param {!goog.math.Coordinate}
 *            scrollOffset X/y of window scrollbars.
 */
