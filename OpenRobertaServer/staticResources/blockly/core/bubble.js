 ...
 *            workspace The workspace on which to draw the bubble.
 * @param {!Element}
 *            content SVG content for the bubble.
 * @param {Element}
 *            shape SVG element to avoid eclipsing.
 * @param {number}
 *            anchorX Absolute horizontal position of bubbles anchor point.
 * @param {number}
 *            anchorY Absolute vertical position of bubbles anchor point.
 * @param {?number}
 *            bubbleWidth Width of bubble, or null if not resizable.
 * @param {?number}
 *            bubbleHeight Height of bubble, or null if not resizable.
 * @constructor
 */
 ...
 *            content SVG content for the bubble.
 * @param {boolean}
 *            hasResize Add diagonal resize gripper if true.
...
//    }, this.bubbleGroup_);
    ...
    if (hasResize) {
        ...
        var shield = Blockly.createSvgElement('rect', {
            'x' : -15,
            'y' : -15,
            'width' : 24,
            'height' : 24,
        ...
        var iconMark = Blockly.createSvgElement('path', {
            ...
            'fill' : '#333',
            'd' : 'M19 3h-5.243c-1.302 0-2.401.838-2.815 2h-6.942v7.061l.012.12c-1.167.41-2.012 1.512-2.012 2.819v7h7c1.311 0 2.593-.826 3-2h7'
                    + 'v-7.061l-.012-.12c1.167-.41 2.012-1.512 2.012-2.819v-7h-2zm-2 15h-5c-.553 0-1-.448-1-1s.447-1 1-1h3v-3.061c0-.552.447-1 1-1'
                    + 's1 .448 1 1v5.061zm-11-11h5.061c.553 0 1 .448 1 1s-.447 1-1 1h-3.061v3.061c0 .552-.448 1-1 1-.553 0-1-.448-1-1v-5.061z'
                    + 'm13 3c0 .552-.447 1-1 1s-1-.448-1-1v-1.586l-3.293 3.293c-.195.195-.451.293-.707.293s-.512-.098-.707-.293'
                    + 'c-.391-.391-.391-1.023 0-1.414l3.293-3.293h-1.586c-.553 0-1-.448-1-1s.447-1 1-1h5v5zm-10 10h-5v-5c0-.552.447-1 1-1'
                    + 's1 .448 1 1v1.586l3.293-3.293c.195-.195.451-.293.707-.293s.512.098.707.293c.391.391.391 1.023 0 1.414l-3.293 3.293h1.586'
                    + 'c.553 0 1 .448 1 1s-.448 1-1 1zm2.414-7.414c-.378-.378-.88-.586-1.414-.586-.367 0-.716.105-1.023.289l.023-.228v-2.061'
 ...
 * 
 * @param {Object}
 *            thisObject The value of 'this' in the callback.
 * @param {!Function}
 *            callback The function to call on resize.
 */
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
    ...
    if (Blockly.RTL) {
        if (this.anchorX_ - metrics.viewLeft - relativeLeft - this.width_ < Blockly.Scrollbar.scrollbarThickness) {
            // Slide the bubble right until it is onscreen.
            relativeLeft = this.anchorX_ - metrics.viewLeft - this.width_ - Blockly.Scrollbar.scrollbarThickness;
        } else if (this.anchorX_ - metrics.viewLeft - relativeLeft > metrics.viewWidth) {
