 ...
 * 
 * @return {!Array.<!Array.<!Array>>} Pair of arrays, the first contains
 *         procedures without return variables, the second with. Each procedure
 *         is defined by a three-element list of name, parameter list, and
...
/**
 * Comparison function for case-insensitive sorting of the first element of a
 * tuple.
 * 
 * @param {!Array}
 *            ta First tuple.
 ...
 *            workspace The workspace to scan for collisions.
 * @param {Blockly.Block}
 ...
 * @param {!Blockly.Workspace}
 *            workspace The workspace to find callers in.
 ...
 * 
 * @param {string}
 *            name Name of deleted procedure definition.
 * @param {!Blockly.Workspace}
 *            workspace The workspace to delete callers from.
 */
 ...
 * 
 * @param {string}
 *            name Name of edited procedure definition.
 * @param {!Blockly.Workspace}
 *            workspace The workspace to delete callers from.
 * @param {!Array.
 *            <string>} paramNames Array of new parameter names.
 * @param {!Array.
 *            <string>} paramIds Array of unique parameter IDs.
 */
