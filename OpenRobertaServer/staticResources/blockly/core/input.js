 ...
 *            again.
 * @param {!Blockly.Block}
 *            block The block containing this input.
 * @param {Blockly.Connection}
 *            connection Optional connection for this input.
 * @constructor
 */
 ...
 * 
 * @param {string|!Blockly.Field}
 *            field Something to add as a field.
 * @param {string}
 ...
 * 
 * @param {string|Array.
 *            <string>|null} check Compatible value type or list of value types.
 ...
 * 
 * @param {number}
 *            align One of Blockly.ALIGN_LEFT, ALIGN_CENTRE, ALIGN_RIGHT. In RTL
 *            mode directions are reversed, and ALIGN_RIGHT aligns to the left.
 * @return {!Blockly.Input} The input being modified (to allow chaining).
 */
