 ...
 *            argument and returns either the accepted text, a replacement text,
 ...
 * 
 * @param {boolean=}
 *            opt_quietInput True if editor should be created without focus.
 *            Defaults to false.
 * @private
 */
...
/**
 * Check to see if the contents of the editor validates. Style the editor
 * accordingly.
 * 
 * @private
 */
...
/**
 * Close the editor, save the results, and dispose of the editable text field's
 * elements.
 * 
