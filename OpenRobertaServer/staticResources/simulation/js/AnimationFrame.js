...
// Weird native implementation doesn't work if context is defined.
             ...
             * 
             * Options: - `useNative` use the native animation frame if possible, defaults
             * to true - `frameRate` pass a custom frame rate
             * 
             * @param {Object|Number}
             *            options
             */
            ...
            /**
             * Default frame rate used for shim implementation. Native implementation will
             * use the screen frame rate, but js have no way to detect it.
             * 
            ...
            /**
             * Request animation frame. We will use the native RAF as soon as we know it
             * does works.
             * 
             * @param {Function}
             *            callback
             ...
             * 
             * @param {Number}
             *            timeout id or requested animation frame id
             * 
             * @api public
             */
