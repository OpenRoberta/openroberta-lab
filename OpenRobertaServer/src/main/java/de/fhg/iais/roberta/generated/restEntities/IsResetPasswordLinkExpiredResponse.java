...
/**
 * the response for the /isResetPasswordLinkExpired REST request<br>
 * <br>
 * Version: 1<br>
 * Datum: 2020-06-15
 */
public class IsResetPasswordLinkExpiredResponse extends BaseResponse {
    protected boolean resetPasswordLinkExpired;
    protected boolean resetPasswordLinkExpiredDefined = false;

    /**
     * the response for the /isResetPasswordLinkExpired REST request
     */
    public static IsResetPasswordLinkExpiredResponse make() {
        return new IsResetPasswordLinkExpiredResponse();
    }

    /**
     * the response for the /isResetPasswordLinkExpired REST request
     */
    public static IsResetPasswordLinkExpiredResponse makeFromString(String jsonS) {
        try {
     ...
     * the response for the /isResetPasswordLinkExpired REST request
     */
    public static IsResetPasswordLinkExpiredResponse makeFromProperties(
        String cmd,
        String rc,
        String message,
        String cause,
        ...
        boolean resetPasswordLinkExpired) {
     ...
     * the response for the /isResetPasswordLinkExpired REST request
     */
    public static IsResetPasswordLinkExpiredResponse make(JSONObject jsonO) {
     ...
     */
    @Override
    public IsResetPasswordLinkExpiredResponse merge(JSONObject jsonO) {
        try {
     ...
     */
    @Override
    public IsResetPasswordLinkExpiredResponse immutable() {
        if ( this.immutable ) {
            return this;
        }
        this.immutable = true;
    ...
    private IsResetPasswordLinkExpiredResponse validate() {
        ...
        if ( !this.resetPasswordLinkExpiredDefined ) {
    ...
    /**
     * GET resetPasswordLinkExpired. Object must be immutable. Never return null or an undefined/default value.
     */
    ...
    /**
     * SET resetPasswordLinkExpired. Object must be mutable.
     */
    ...
    public String toString() {
        return "IsResetPasswordLinkExpiredResponse [immutable="
            + this.immutable
            + ", cmd="
            + this.cmd
            + ", rc="
