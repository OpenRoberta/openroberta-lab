...
public class UserGroupMembersRequest extends BaseRequest {
    ...
    private UserGroupMembersRequest validate() {
        ...
        if ( !this.immutable ) {
            _message = "UserGroupMembersRequest-object is already immutable: " + this;
        }
        if ( groupName == null ) {
            _message = "required property groupName of UserGroupMembersRequest-object is not set: " + this;
        }
        if ( groupMemberAccounts == null ) {
            _message = "required property groupMemberAccounts of UserGroupMembersRequest-object is not set: " + this;
        }
        if ( _message != null ) {
    ...
    public List<String> getGroupMemberAccounts() {
        if ( !this.immutable ) {
            throw new RuntimeException("no groupMemberAccounts from an object under construction: " + this);
        }
    ...
    public UserGroupMembersRequest setGroupMemberAccounts(List<String> groupMemberAccounts) {
        if ( this.immutable ) {
            throw new RuntimeException("groupMemberAccounts assigned to an immutable object: " + this);
        }
