...
public class UserGroupRequest extends BaseRequest {
    ...
    /**
     * the request description for the /userGroup/getUserGroup REST request, returns UserGroupResponse
     */
    public static UserGroupRequest make() {
     ...
     * the request description for the /userGroup/getUserGroup REST request, returns UserGroupResponse
     */
    public static UserGroupRequest makeFromString(String jsonS) {
        try {
     ...
     * the request description for the /userGroup/getUserGroup REST request, returns UserGroupResponse
     */
    public static UserGroupRequest makeFromProperties(String cmd,String groupName) {
        UserGroupRequest entity = new UserGroupRequest();
        entity.setCmd(cmd);
     ...
     * the request description for the /userGroup/getUserGroup REST request, returns UserGroupResponse
     */
    public static UserGroupRequest make(JSONObject jsonO) {
    ...
    public String toString() {
        return "UserGroupRequest [immutable=" + this.immutable + ", cmd=" + this.cmd + ", groupName=" + this.groupName + " ]";
    }
    @Override
    public int hashCode() {
