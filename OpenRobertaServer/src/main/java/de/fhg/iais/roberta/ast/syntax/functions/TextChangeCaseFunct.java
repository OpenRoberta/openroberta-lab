...
public class TextChangeCaseFunct<V> extends Function<V> {
    ...
    private TextChangeCaseFunct(FunctionNames name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
     ...
     */
    public static <V> TextChangeCaseFunct<V> make(FunctionNames name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
