...
/**
 * the response for the /setToken REST request<br><br>
 * Version: 1<br>
 * Datum: 2020-06-15
 */
public class SetTokenResponse extends BaseResponse {
    protected int update;
    protected boolean updateDefined = false;
    
    /**
     * the response for the /setToken REST request
     */
    public static SetTokenResponse make() {
     ...
     * the response for the /setToken REST request
     */
    public static SetTokenResponse makeFromString(String jsonS) {
        try {
     ...
     * the response for the /setToken REST request
     */
    public static SetTokenResponse makeFromProperties(String cmd,String rc,String message,String cause,JSONObject parameters,String initToken,long serverTime,String serverVersion,long robotWait,String robotBattery,String robotName,String robotVersion,String robotFirmwareName,JSONObject robotSensorvalues,int robotNepoexitvalue,String robotState,boolean notificationsAvailable,int update) {
        SetTokenResponse entity = new SetTokenResponse();
        entity.setCmd(cmd);
        entity.setRc(rc);
     ...
     * the response for the /setToken REST request
     */
    public static SetTokenResponse make(JSONObject jsonO) {
     ...
     */
    public SetTokenResponse merge(JSONObject jsonO) {
        try {
     ...
     * Throws a runtime exception if inconsistencies are detected.
     */
    public SetTokenResponse immutable() {
        if (this.immutable) {
            return this;
        }
        this.immutable = true;
    ...
    /**
     * GET update. Object must be immutable. Never return null or an undefined/default value.
     */
    ...
    /**
     * SET update. Object must be mutable.
     */
