...
public class MathOnListFunct<V> extends Function<V> {
    ...
    private MathOnListFunct(Functions name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
     ...
     */
    public static <V> MathOnListFunct<V> make(Functions name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
