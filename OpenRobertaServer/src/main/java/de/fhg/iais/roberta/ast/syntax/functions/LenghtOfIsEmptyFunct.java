...
public class LenghtOfIsEmptyFunct<V> extends Function<V> {
    ...
    private LenghtOfIsEmptyFunct(Functions name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
        super(Kind.LENGHT_OF_IS_EMPTY_FUNCT, properties, comment);
     ...
     */
    public static <V> LenghtOfIsEmptyFunct<V> make(Functions name, List<Expr<V>> param, BlocklyBlockProperties properties, BlocklyComment comment) {
