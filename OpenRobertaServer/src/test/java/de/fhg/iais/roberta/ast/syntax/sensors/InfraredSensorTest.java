...
public class InfraredSensorTest {
    ...
    public void setInfrared() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_setInfrared.xml"));
    }
    ...
    public void getInfraredModeName() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_getModeInfrared.xml"));
    }
    ...
    public void getSampleInfrared() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_getSampleInfrared.xml"));
    }
}
