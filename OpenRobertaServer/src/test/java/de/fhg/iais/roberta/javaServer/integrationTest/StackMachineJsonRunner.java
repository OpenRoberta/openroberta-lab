 ...
 * </ul>
 * Then the JavaScript found in <code>TypeScriptSources/jsGenerated/runStackMachineJson.js</code> is executed with <code>node</code> (must be on the path!). This
 ...
 * above!)<br>
 * <br>
 * <i>Note:</i> all sources used for this interpretation are found in project "TypeScriptSources" directory "ts/app/nepostackmachine". They are written in TypeScript, transpiled to
 * JavaScript and saved into the directory "TypeScriptSources/jsGenerated". From this directory they are used by "node".
 */
