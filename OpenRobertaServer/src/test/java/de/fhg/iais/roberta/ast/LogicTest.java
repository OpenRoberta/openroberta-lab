...
public class LogicTest {
    ...
    public void logicCompare() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_compare.xml"));
    }
    ...
    public void logicCompare1() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_compare1.xml"));
    }
    ...
    public void logicCompare2() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_compare2.xml"));
    }
    ...
    public void logicCompare3() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_compare3.xml"));
    }
    ...
    public void logicCompare4() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_compare4.xml"));
    }
    ...
    public void logic_operation() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_operation.xml"));
    }
    ...
    public void logic_negate() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_negate.xml"));
    }
    ...
    public void logic_negate1() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_negate1.xml"));
    }
    ...
    public void logic_null() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_null.xml"));
    }
    ...
    public void logic_ternary() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/logic/logic_ternary.xml"));
    }
}
