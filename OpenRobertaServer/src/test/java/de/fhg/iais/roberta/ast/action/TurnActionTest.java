...
public class TurnActionTest {
    ...
    public void make() throws Exception {
        String a =
            "BlockAST [project=[[TurnAction [direction=RIGHT, param=MotionParam [speed=NumConst [50], duration=MotorDuration [type=DEGREE, value=NumConst [20]]]]]]]";
    ...
    public void motorDiffTurnForMissing() throws Exception {
        String a =
            "BlockAST [project=[[TurnAction [direction=RIGHT, param=MotionParam [speed=EmptyExpr [defVal=class java.lang.Integer], duration=MotorDuration [type=DEGREE, value=EmptyExpr [defVal=class java.lang.Integer]]]], TurnAction [direction=RIGHT, param=MotionParam [speed=EmptyExpr [defVal=class java.lang.Integer], duration=MotorDuration [type=DEGREE, value=NumConst [20]]]], TurnAction [direction=RIGHT, param=MotionParam [speed=NumConst [50], duration=MotorDuration [type=DEGREE, value=EmptyExpr [defVal=class java.lang.Integer]]]]]]]";
