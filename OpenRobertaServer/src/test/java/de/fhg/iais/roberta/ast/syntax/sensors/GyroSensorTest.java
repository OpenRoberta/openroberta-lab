...
public class GyroSensorTest {
    ...
    public void setGyro() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_setGyro.xml"));
    }
    ...
    public void getGyroSensorModeName() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_getModeGyro.xml"));
    }
    ...
    public void getGyroSensorValue() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_getSampleGyro.xml"));
    }
    ...
    public void resetGyroSensor() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateSyntax("/ast/sensors/sensor_resetGyro.xml"));
    }
}
