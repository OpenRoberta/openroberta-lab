...
public class MathTest {
    ...
    public void mathSingle() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_single.xml"));
    }
    ...
    public void mathTrig() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_trig.xml"));
    }
    ...
    public void mathConstant() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_constant.xml"));
    }
    ...
    public void mathNumberProperty() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_number_property.xml"));
    }
    ...
    public void mathNumberProperty1() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_number_property1.xml"));
    }
    ...
    public void mathChange() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_change.xml"));
    }
    ...
    public void mathRound() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_round.xml"));
    }
    ...
    public void math_on_list() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_on_list.xml"));
    }
    ...
    public void math_on_constrain() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_constrain.xml"));
    }
    ...
    public void math_random_float() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_random_float.xml"));
    }
    ...
    public void math_modulo() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_modulo.xml"));
    }
    ...
    public void math_random_integer() throws Exception {
        ...
        Assert.assertEquals(a, Helper.generateASTString("/ast/math/math_random_integer.xml"));
    }
}
