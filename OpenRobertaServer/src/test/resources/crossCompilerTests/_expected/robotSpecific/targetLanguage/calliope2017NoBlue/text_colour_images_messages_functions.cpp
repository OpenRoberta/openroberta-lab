...
void nepo_messages() {
    ...
    _uBit.radio.datagram.send(ManagedString((int)(___numberVar)));
    ...
    _uBit.radio.datagram.send(ManagedString((int)(___numberVar)));
    _uBit.radio.setTransmitPower(0);
    _uBit.radio.datagram.send(ManagedString((int)(___booleanVar)?true:false));
    _uBit.radio.setTransmitPower(1);
    _uBit.radio.datagram.send(ManagedString((int)(___booleanVar)?true:false));
    _uBit.radio.setTransmitPower(2);
    _uBit.radio.datagram.send(ManagedString((int)(___booleanVar)?true:false));
    ...
    _uBit.radio.datagram.send(ManagedString((int)(___booleanVar)?true:false));
    _uBit.radio.setTransmitPower(0);
    _uBit.radio.datagram.send(ManagedString((___stringVar)));
    _uBit.radio.setTransmitPower(1);
    _uBit.radio.datagram.send(ManagedString((___stringVar)));
    _uBit.radio.setTransmitPower(2);
    _uBit.radio.datagram.send(ManagedString((___stringVar)));
    ...
    _uBit.radio.setGroup(___numberVar);
}
