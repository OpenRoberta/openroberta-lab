    ...
    */
    function processOps(fileName) {
        ...
        try {
            ...
            new interpreter_interpreter_1.Interpreter(generatedCode, new interpreter_robotWeDoBehaviourTest_1.RobotWeDoBehaviourTest(showOpLog, showDebug), function () { callbackOnTermination(fileName); }).run(0);
        }
        catch (e) {
