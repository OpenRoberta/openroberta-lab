...
@NepoPhrase(category = "ACTOR", blocklyNames = {"robActions_led_button"}, name = "LED_BUTTON_ON_ACTION")
public final class LedButtonOnAction extends Action {
    ...
    public LedButtonOnAction(BlocklyProperties properties, Expr led1, Expr led2, Expr led3, Expr led4) {
        super(properties);
        this.led1 = led1;
        this.led2 = led2;
        this.led3 = led3;
