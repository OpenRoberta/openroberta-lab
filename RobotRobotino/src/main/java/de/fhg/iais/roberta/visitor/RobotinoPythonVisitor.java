...
public final class RobotinoPythonVisitor extends AbstractPythonVisitor implements IRobotinoVisitor<Void> {
    ...
    private void generateMain() {
        this.src.addNLine(2, "def main(RV):");
        incrIndentation();
    ...
    private void generateStart() {
        this.src.addNLine(2,"def start(RV):");
        incrIndentation();
    ...
    private void appendViewMethods() {
        this.src.addNLine(2,"def step(RV):");
        incrIndentation();
        if ( this.getBean(UsedHardwareBean.class).isActorUsed(RobotinoConstants.OMNIDRIVE) ) {
        ...
        generateMain();
        generateStart();
        this.src.addNLine(2,"def stop(RV):");
        incrIndentation();
        this.src.addLine("pass");
        decrIndentation();
        nlIndent();
        this.src.addNLine(2,"def cleanup(RV):");
        incrIndentation();
        this.src.addLine("pass");
        decrIndentation();
        nlIndent();
