...
public class CalliopeV3ValidatorAndCollectorWorker extends MbedValidatorAndCollectorWorker{
    ...
    public static final List<String> DEFAULT_PROPERTIES = Stream.of("KEY", "RGBLEDs", "BUZZER", "LOGOTOUCH", "ACCELEROMETER", "GYRO", "COMPASS", "TEMPERATURE", "LIGHT", "SOUND", "ROBOT").collect(Collectors.toList());
