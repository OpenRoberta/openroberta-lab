...
public final class MbedTwo2ThreeTransformerHelper {
    ...
    static {
        ...
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "0"), "robConf_rgbled");
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "1"), "robConf_callibot");
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "2"), "robConf_callibot");
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "3"), "robConf_callibot");
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "4"), "robConf_callibot");
        PROG_BLOCK_TO_CONF_BLOCKLY_NAME.put(Triple.of("LIGHT_OFF_ACTION", "OFF", "5"), "robConf_callibot");
        ...
        CALLIBOT.put(Pair.of("LIGHT_OFF_ACTION", "1"), "CalliBot_links_vorne");
        CALLIBOT.put(Pair.of("LIGHT_OFF_ACTION", "4"), "CalliBot_rechts_vorne");
        CALLIBOT.put(Pair.of("LIGHT_OFF_ACTION", "2"), "CalliBot_links_hinten");
        CALLIBOT.put(Pair.of("LIGHT_OFF_ACTION", "3"), "CalliBot_rechts_hinten");
        CALLIBOT.put(Pair.of("LIGHT_OFF_ACTION", "5"), "CalliBot_alle");
