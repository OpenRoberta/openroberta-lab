package de.fhg.iais.roberta.syntax.function.mbed;
...
@NepoExpr(name = "IMAGE_SHIFT", category = "FUNCTION", blocklyNames = {"mbedImage_shift"}, blocklyType = BlocklyType.IMAGE)
public final class ImageShiftFunction extends Function {
    ...
    public ImageShiftFunction(BlocklyProperties properties, Direction shiftDirection, Expr image, Expr positions) {
        super(properties);
