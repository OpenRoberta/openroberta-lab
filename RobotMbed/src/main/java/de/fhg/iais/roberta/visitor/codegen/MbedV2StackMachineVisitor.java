...
public abstract class MbedV2StackMachineVisitor extends MicrobitStackMachineVisitor implements IMicrobitV2Visitor<Void> {

    public MbedV2StackMachineVisitor(ConfigurationAst configuration, List<List<Phrase>> phrases, UsedHardwareBean usedHardwareBean, NNBean nnBean) {
