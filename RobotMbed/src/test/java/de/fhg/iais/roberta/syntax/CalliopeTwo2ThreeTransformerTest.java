    ...
    public void executeTransformer_ShouldReturnTransformedWriteToPin_WhenGivenOldWriteToPin() {
        String expectedProgramAst =
            "BlockAST[project=[[Location[x=512,y=50],MainTask[],"
                ...
                + "PinWriteValueAction[ANALOG,A1,NumConst[value:1]],"
                + "PinWriteValueAction[ANALOG,C04,NumConst[value:1]],"
                + "PinWriteValueAction[ANALOG,C05,NumConst[value:1]],"
                + "PinWriteValueAction[ANALOG,C06,NumConst[value:1]],"
                + "PinWriteValueAction[ANALOG,C16,NumConst[value:1]],"
                + "PinWriteValueAction[ANALOG,C17,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,P0,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,P1_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,P2_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,P3,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,A0,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,A1_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C04_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C05_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C06_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C07,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C08,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C09,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C10,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C11,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C12,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C16_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C17_2,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C18,NumConst[value:1]],"
                + "PinWriteValueAction[DIGITAL,C19,NumConst[value:1]]]]]";
        String[] expectedToBeInConfigAst =
            {
