...
/**
 * Collector for the NXT. Adds the blocks missing from the defaults of {@link ICollectorVisitor}. Defines the specific parent implementation to use (the one of
...
public interface INxtCollectorVisitor extends ICollectorVisitor, INxtVisitor<Void> {
    ...
    default Void visitBluetoothWaitForConnectionAction(BluetoothWaitForConnectionAction<Void> bluetoothWaitForConnection) {
        return ICollectorVisitor.super.visitBluetoothWaitForConnectionAction(bluetoothWaitForConnection);
    }

    @Override
    default Void visitBluetoothConnectAction(BluetoothConnectAction<Void> bluetoothConnectAction) {
        return ICollectorVisitor.super.visitBluetoothConnectAction(bluetoothConnectAction);
    }
}
