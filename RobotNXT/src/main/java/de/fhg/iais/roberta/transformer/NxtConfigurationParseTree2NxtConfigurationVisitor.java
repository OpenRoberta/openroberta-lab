...
public class NxtConfigurationParseTree2NxtConfigurationVisitor extends Ev3ConfigurationBaseVisitor<Void> {
    private static final Logger LOG = LoggerFactory.getLogger(NxtConfigurationParseTree2NxtConfigurationVisitor.class);

    private final Configuration.Builder builder = new NxtConfiguration.Builder();
    ...
    public static Option<Configuration> startWalkForVisiting(String stmt, IRobotFactory factory) {
        NxtConfigurationParseTree2NxtConfigurationVisitor visitor = new NxtConfigurationParseTree2NxtConfigurationVisitor(factory);
    ...
    private NxtConfigurationParseTree2NxtConfigurationVisitor(IRobotFactory factory) {
        ...
        try {
            ...
            parser.addErrorListener(new BaseErrorListener() {
                ...
                public void syntaxError(
                    ...
                    if ( NxtConfigurationParseTree2NxtConfigurationVisitor.this.parseErrorMessage == null ) {
                        NxtConfigurationParseTree2NxtConfigurationVisitor.this.parseErrorMessage =
