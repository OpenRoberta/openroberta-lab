...
@Deprecated
public class NxtTextlyTree2NxtAst extends TextlyBaseVisitor<Phrase<Void>> {
    /**
    ...
    public static Phrase<Void> startWalkForVisiting(String stmt) throws Exception {
        ...
        new NxtTextlyTree2NxtAst().visit(tree);
        NxtTextlyTree2NxtAst visitor = new NxtTextlyTree2NxtAst();
