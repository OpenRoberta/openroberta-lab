...
import de.fhg.iais.roberta.syntax.actor.nao.Animation;
import de.fhg.iais.roberta.syntax.actor.nao.ApplyPosture;
import de.fhg.iais.roberta.syntax.actor.nao.Autonomous;
import de.fhg.iais.roberta.syntax.actor.nao.ForgetFace;
import de.fhg.iais.roberta.syntax.actor.nao.GetLanguage;
import de.fhg.iais.roberta.syntax.actor.nao.GetVolume;
import de.fhg.iais.roberta.syntax.actor.nao.Hand;
import de.fhg.iais.roberta.syntax.actor.nao.LearnFace;
import de.fhg.iais.roberta.syntax.actor.nao.LedOff;
import de.fhg.iais.roberta.syntax.actor.nao.LedReset;
import de.fhg.iais.roberta.syntax.actor.nao.MoveJoint;
import de.fhg.iais.roberta.syntax.actor.nao.PlayFile;
import de.fhg.iais.roberta.syntax.actor.nao.PointLookAt;
import de.fhg.iais.roberta.syntax.actor.nao.RandomEyesDuration;
import de.fhg.iais.roberta.syntax.actor.nao.RastaDuration;
import de.fhg.iais.roberta.syntax.actor.nao.RecordVideo;
import de.fhg.iais.roberta.syntax.actor.nao.SetIntensity;
import de.fhg.iais.roberta.syntax.actor.nao.SetLeds;
import de.fhg.iais.roberta.syntax.actor.nao.SetMode;
import de.fhg.iais.roberta.syntax.actor.nao.SetStiffness;
import de.fhg.iais.roberta.syntax.actor.nao.SetVolume;
import de.fhg.iais.roberta.syntax.actor.nao.Stop;
import de.fhg.iais.roberta.syntax.actor.nao.TakePicture;
import de.fhg.iais.roberta.syntax.actor.nao.TurnDegrees;
import de.fhg.iais.roberta.syntax.actor.nao.WalkAsync;
import de.fhg.iais.roberta.syntax.actor.nao.WalkDistance;
import de.fhg.iais.roberta.syntax.actor.nao.WalkTo;
