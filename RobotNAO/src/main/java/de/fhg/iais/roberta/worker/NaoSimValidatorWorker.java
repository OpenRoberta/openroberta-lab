...
public class NaoSimValidatorWorker extends AbstractValidatorAndCollectorWorker {
    ...
    protected CommonNepoValidatorAndCollectorVisitor getVisitor(
        ...
        return new NaoSimValidatorVisitor(project.getConfigurationAst(), beanBuilders);
    }
}
