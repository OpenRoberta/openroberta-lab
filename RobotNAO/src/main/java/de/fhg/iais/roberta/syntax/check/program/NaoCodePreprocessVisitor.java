 ...
 * @author kcvejoski
 */
public class NaoCodePreprocessVisitor extends PreprocessProgramVisitor implements NaoAstVisitor<Void> {

    public NaoCodePreprocessVisitor(ArrayList<ArrayList<Phrase<Void>>> phrasesSet, Configuration configuration) {
        super(configuration);
        check(phrasesSet);
    }
