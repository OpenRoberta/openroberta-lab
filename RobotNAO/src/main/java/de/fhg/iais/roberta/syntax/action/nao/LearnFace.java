 ...
 * <br>
 */
@NepoBasic(name = "LEARN_FACE", category = "ACTOR", blocklyNames = {"naoActions_learnFace"})
public final class LearnFace<V> extends Action<V> {
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2ProgramAst<V> helper) {
        ...
        return LearnFace.make(Jaxb2Ast.convertPhraseToExpr(msg), Jaxb2Ast.extractBlockProperties(block), Jaxb2Ast.extractComment(block));
    }
