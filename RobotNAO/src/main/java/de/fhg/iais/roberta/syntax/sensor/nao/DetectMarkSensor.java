 ...
 * <br/>
 */
@NepoExpr(sampleValues = {@NepoSampleValue(blocklyFieldName="DETECTMARK_IDONE",sensor="DETECT_MARK",mode="IDONE")}, containerType = "DETECT_MARK", category = "SENSOR", blocklyNames = {"robSensors_detectmark_getSample"})
@NepoExternalSensor
