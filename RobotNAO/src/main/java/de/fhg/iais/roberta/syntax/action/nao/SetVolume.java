...
public final class SetVolume<V> extends Action<V> {
    ...
    protected V accept(AstVisitor<V> visitor) {
        return ((NaoAstVisitor<V>) visitor).visitSetVolume(this);
    }
    ...
    public static <V> Phrase<V> jaxbToAst(Block block, Jaxb2AstTransformer<V> helper) {
        ...
        Phrase<V> volume = helper.extractValue(values, new ExprParam(BlocklyConstants.VOLUME, Integer.class));
    ...
    public Block astToBlock() {
        ...
        JaxbTransformerHelper.addValue(jaxbDestination, BlocklyConstants.VOLUME, this.volume);
