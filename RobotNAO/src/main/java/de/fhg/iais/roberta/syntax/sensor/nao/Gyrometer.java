 ...
 */
public final class Gyrometer<V> extends Action<V> {
     ...
     */
    private static <V> Gyrometer<V> make(Coordinates coordinate, BlocklyBlockProperties properties, BlocklyComment comment) {
