...
public class RecognizeWord<V> extends Action<V> {
    ...
    private RecognizeWord(Expr<V> msg, BlocklyBlockProperties properties, BlocklyComment comment) {
     ...
     */
    private static <V> RecognizeWord<V> make(Expr<V> msg, BlocklyBlockProperties properties, BlocklyComment comment) {
        return new RecognizeWord<>(msg, properties, comment);
    }
    ...
    protected V accept(AstVisitor<V> visitor) {
        return ((NaoAstVisitor<V>) visitor).visitRecognizeWord(this);
    ...
    public Block astToBlock() {
        ...
        JaxbTransformerHelper.addValue(jaxbDestination, BlocklyConstants.WORD, this.msg);
