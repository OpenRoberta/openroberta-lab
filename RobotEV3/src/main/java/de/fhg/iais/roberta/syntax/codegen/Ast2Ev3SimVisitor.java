...
public class Ast2Ev3SimVisitor extends SimulationVisitor<Void> {
    ...
    private static void generateCodeFromPhrases(ArrayList<ArrayList<Phrase<Void>>> phrasesSet, SimulationVisitor<Void> astVisitor) {
    ...
    private static void appendProgramInitialization(SimulationVisitor<Void> astVisitor) {
    ...
    private static void appendStmtsInitialization(SimulationVisitor<Void> astVisitor) {
    ...
    private static void appendMethodsInitialization(SimulationVisitor<Void> astVisitor) {
