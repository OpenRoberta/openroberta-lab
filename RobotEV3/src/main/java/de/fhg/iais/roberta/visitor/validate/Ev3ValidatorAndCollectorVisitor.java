...
//        ConfigurationComponent configurationComponent = this.robotConfiguration.optConfigurationComponent(gyroReset.sensorPort);
//        if ( !configurationComponent.componentType.equals("GYRO") ) {
//            addErrorToPhrase(gyroReset, "CONFIGURATION_ERROR_ACTOR_MISSING");
//        } else {
//            usedHardwareBuilder.addUsedActor(new UsedActor(gyroReset.sensorPort, configurationComponent.componentType));
//        }
        return null;
    }
