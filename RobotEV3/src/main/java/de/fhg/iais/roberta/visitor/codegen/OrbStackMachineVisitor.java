...
public class OrbStackMachineVisitor extends AbstractStackMachineVisitor implements IOrbVisitor<Void> {
    ...
    public Void visitDriveAction(DriveAction driveAction) {
        ...
        if ( speedOnly ) {
            ...
            add(o);
            return add(makeNode(C.STOP_DRIVE).put(C.NAME, "orb"));
        }
    }
    ...
    public Void visitGyroReset(GyroReset gyroReset) {
        ...
        JSONObject o = makeNode(C.GYRO_SENSOR_RESET).put(C.PORT, port).put(C.NAME, "orb");
        return add(o);
    }
    ...
    public Void visitEncoderReset(EncoderReset encoderReset) {
        ...
        JSONObject o = makeNode(C.ENCODER_SENSOR_RESET).put(C.PORT, port).put(C.NAME, "orb");
        return add(o);
    }
