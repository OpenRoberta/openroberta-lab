    ...
    public void methodCall1() throws Exception {
        String a =
            "BlockAST [project=[[Location [x=44, y=104], MethodReturn [Funktionsblock, VarDeclaration [NUMBER, x, EmptyExpr [defVal=NUMBER], true, false], "
                ...
                + "AktionStmt [LightAction [NO_PORT, ON, GREEN, EmptyExpr [defVal=COLOR]]]MethodStmt [MethodIfReturn [Binary [EQ, NumConst [0], NumConst [0]], NUMBER, Var [x2]]], NUMBER, Var [x3]]], [Location [x=75, y=488], MethodCall [Funktionsblock, Var [x], Var [x2], Var [x3], NumConst [0], NumConst [1], NumConst [2], NUMBER]]]]";
