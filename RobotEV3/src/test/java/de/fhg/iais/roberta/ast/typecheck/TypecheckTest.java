...
public class TypecheckTest extends AstTest {
    ...
    public void test0ok() throws Exception {
        Phrase<BlocklyType> ast = UnitTestHelper.generateAst(testFactory, "/ast/expressions/expr_typecorrect0.xml");
    ...
    public void test1ok() throws Exception {
        Phrase<BlocklyType> ast = UnitTestHelper.generateAst(testFactory, "/ast/expressions/expr_typecorrect1.xml");
        TypecheckVisitor typechecker = TypecheckVisitor.makeVisitorAndTypecheck(ast);
    ...
    public void test2ok() throws Exception {
        Phrase<BlocklyType> ast = UnitTestHelper.generateAst(testFactory, "/ast/expressions/expr_typecorrect2.xml");
        TypecheckVisitor typechecker = TypecheckVisitor.makeVisitorAndTypecheck(ast);
        Assert.assertEquals(0, typechecker.getErrorCount());
    }
    ...
    public void test0error() throws Exception {
        Phrase<BlocklyType> ast = UnitTestHelper.generateAst(testFactory, "/ast/expressions/expr_typeerror0.xml");
        TypecheckVisitor typechecker = TypecheckVisitor.makeVisitorAndTypecheck(ast);
    ...
    public void test1error() throws Exception {
        Phrase<BlocklyType> ast = UnitTestHelper.generateAst(testFactory, "/ast/expressions/expr_typeerror1.xml");
        TypecheckVisitor typechecker = TypecheckVisitor.makeVisitorAndTypecheck(ast);
        Assert.assertTrue(typechecker.getErrorCount() > 0);
    }
}
