...
public class Ev3AstTest extends AstTest {
    protected static ConfigurationAst makeStandard() {
        ...
        ConfigurationComponent motorC = new ConfigurationComponent("LARGE", "CONFIGURATION_ACTOR", "C", "C", motorCproperties);

        Map<String, String> touchSensorProperties = Util.createMap();
        ConfigurationComponent touchSensor = new ConfigurationComponent("TOUCH", "CONFIGURATION_SENSOR", "S1", "1", touchSensorProperties);

        Map<String, String> gyroSensorProperties = Util.createMap();
        ConfigurationComponent gyroSensor = new ConfigurationComponent("GYRO", "CONFIGURATION_SENSOR", "S2", "2", gyroSensorProperties);

        Map<String, String> colourSensorProperties = Util.createMap();
        ConfigurationComponent colourSensor = new ConfigurationComponent("COLOR", "CONFIGURATION_SENSOR", "S3", "3", colourSensorProperties);

        Map<String, String> ultrasonicSensorProperties = Util.createMap();
        ConfigurationComponent ultrasonicSensor = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S4", "4", ultrasonicSensorProperties);
    ...
    protected static ConfigurationAst makeLargeLargeMediumTouchGyroColorUltrasonic() {
        ...
        ConfigurationComponent motorD = new ConfigurationComponent("MEDIUM", "CONFIGURATION_SENSOR", "D", "D", motorDproperties);
    ...
    protected static ConfigurationAst makeMediumLargeTouchGyroColorUltrasonic() {
        Map<String, String> motorBproperties = Util.createMap("MOTOR_REGULATION", "TRUE", "MOTOR_REVERSE", "OFF", "MOTOR_DRIVE", "RIGHT");
        ConfigurationComponent motorB = new ConfigurationComponent("MEDIUM", "CONFIGURATION_ACTOR", "B", "B", motorBproperties);
    ...
    protected static ConfigurationAst makeLargeLargeTouchGyroInfraredUltrasonic() {
        ...
        ConfigurationComponent motorB = new ConfigurationComponent("LARGE", "CONFIGURATION_ACTOR", "A", "A", motorBproperties);

        Map<String, String> motorCproperties = Util.createMap("MOTOR_REGULATION", "TRUE", "MOTOR_REVERSE", "OFF", "MOTOR_DRIVE", "RIGHT");
        ConfigurationComponent motorC = new ConfigurationComponent("LARGE", "CONFIGURATION_ACTOR", "B", "B", motorCproperties);
        ...
        ConfigurationComponent colourSensor = new ConfigurationComponent("INFRARED", "CONFIGURATION_SENSOR", "S3", "3", infraredSensorProperties);
    ...
    protected static ConfigurationAst makeMediumLargeTouchUltrasonicColor() {
        ...
        ConfigurationComponent touchSensor = new ConfigurationComponent("TOUCH", "CONFIGURATION_SENSOR", "S1", "1", Collections.emptyMap());
        ConfigurationComponent ultrasonicSensor = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S2", "2", Collections.emptyMap());
        ConfigurationComponent colorSensor = new ConfigurationComponent("COLOR", "CONFIGURATION_SENSOR", "S3", "3", Collections.emptyMap());
        //        ConfigurationComponent ultrasonicSensor4 = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S4", BlocklyConstants.NO_SLOT, "4", Collections.emptyMap());
    ...
    protected static ConfigurationAst makeMediumLargeTouchUltrasonicColorUltrasonic() {
        ...
        ConfigurationComponent ultrasonicSensor = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S2", "2", Collections.emptyMap());
        ConfigurationComponent colorSensor = new ConfigurationComponent("COLOR", "CONFIGURATION_SENSOR", "S3", "3", Collections.emptyMap());
        ConfigurationComponent ultrasonicSensor4 = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S4", "4", Collections.emptyMap());
    ...
    protected static ConfigurationAst makeMediumLargeTouchGyroInfraredUltrasonic() {
        ...
        ConfigurationComponent motorB = new ConfigurationComponent("LARGE", "CONFIGURATION_ACTOR", "B", "B", motorBproperties);
        ConfigurationComponent touchSensor = new ConfigurationComponent("TOUCH", "CONFIGURATION_SENSOR", "S1", "1", Collections.emptyMap());
        ConfigurationComponent gyro = new ConfigurationComponent("GYRO", "CONFIGURATION_SENSOR", "S2", "2", Collections.emptyMap());
        ConfigurationComponent infrared = new ConfigurationComponent("INFRARED", "CONFIGURATION_SENSOR", "S3", "3", Collections.emptyMap());
        ConfigurationComponent ultrasonicSensor4 = new ConfigurationComponent("ULTRASONIC", "CONFIGURATION_SENSOR", "S4", "4", Collections.emptyMap());
    ...
    protected static ConfigurationAst makeRotateRegulatedUnregulatedForwardBackwardMotors() {
        ...
        ConfigurationComponent motorD = new ConfigurationComponent("LARGE", "CONFIGURATION_ACTOR", "D", "D", motorDproperties);

        return build(motorA, motorB, motorC, motorD);
    }

    protected static ConfigurationAst makeHTColor() {
        ConfigurationComponent htColor = new ConfigurationComponent("HT_COLOR", "CONFIGURATION_SENSOR", "S3", "3", Collections.emptyMap());
