...
public class TurnActionTest extends Ev3LejosAstTest {
    ...
    public void turn() throws Exception {
        ...
        UnitTestHelper
            .checkWorkers(testFactory, a, "/syntax/actions/action_MotorDiffTurn.xml", new Ev3UsedHardwareCollectorWorker(), new Ev3JavaGeneratorWorker());
    }
    ...
    public void turnFor() throws Exception {
        ...
        UnitTestHelper
            .checkWorkers(testFactory, a, "/syntax/actions/action_MotorDiffTurnFor.xml", new Ev3UsedHardwareCollectorWorker(), new Ev3JavaGeneratorWorker());
    }
}