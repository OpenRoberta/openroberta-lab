...
(Blockly as any).Extensions.registerMutators("variable_minus_mutator", "mutatorMinus", Variables.VARIABLE_DECLARATION_MIXIN);
(Blockly as any).Extensions.registerMutators("variable_plus_mutator", "mutatorPlus", Variables.VARIABLE_PLUS_MUTATOR_MIXIN);
