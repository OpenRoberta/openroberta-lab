define(["require", "exports", "blockly", "nepo.blockly.hiddenField", "nepo.constants.extensions", "utils/util", "nepo.programConfigSync", "utils/nepo.logger"], function (require, exports, Blockly, nepo_blockly_hiddenField_1, NepoExt, U, sync, nepo_logger_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Sensor = void 0;
    nepo_logger_1.Log;
    var Sensor = /** @class */ (function () {
        function Sensor(sensor, robot, robotGroup) {
            this.init = function () {
                ...
                if (this.sensor.modes[0].name && !this.sensor.modes[0].question) {
                    ...
                    modes = new nepo_blockly_hiddenField_1.HiddenField();
                }
                // do we have ports?
                var ports;
                this.sensorPort_ = 'NO';
                if (typeof this.sensor.ports === 'object') {
                    ...
                    ports = new nepo_blockly_hiddenField_1.HiddenField();
                }
                // do we have a slots?
                var slots;
                if (this.sensor.slots) {
                    ...
                    slots = new nepo_blockly_hiddenField_1.HiddenField();
                }
                    ...
                    this.updatePort_ = function (option) {
                        for (var i = 0; i < this.sensor.ports.length; i++) {
                            if (this.sensor.ports[i].port[1] === option) {
                                var fieldSensorSlot = thisBlock.getField('SLOT');
                                // add new slots
                                var slotList = [];
                                ...
                                var dropDownSlots = new Blockly.FieldDropdown(slotList);
...
//# sourceMappingURL=nepo.sensor.js.map