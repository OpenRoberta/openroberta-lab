...
public class ArduinoActorTest extends ArduinoAstTest {
    ...
    public void relayOnTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(relay);
        UnitTestHelper
    ...
    public void stepperMotorTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(stepperMotor);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void servoMotorTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(servoMotor);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void lcd1602ShowClearTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(screen);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void buzzerTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(buzzer);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void ledTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(led);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(testFactory, "/ast/actions/arduino_led_test.ino", "/ast/actions/arduino_led_test.xml", configuration);
    }
    ...
    public void rgbLedTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(rgbLed);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void analogDigitalPinWriteTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(analogOutput, digitalOutput);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void multiIncludeTest() throws Exception {
        ...
        configuration.setRobotName("nano"); // TODO remove once rfid library is supported for unowifirev2
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
                "/ast/config/arduino_multi_include_test.ino",
                "/ast/config/arduino_multi_include_test.xml",
                configuration);
    }
