...
public class ArduinoSensorTest extends ArduinoAstTest {
    ...
    public void analogDigitalReadTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(analogInput, digitalInput);
        UnitTestHelper
    ...
    public void buttonTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(button);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void presenceTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(motion);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void lightTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(light);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void infraredTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(infrared);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void temperatureTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(temperature);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void humidityTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(humidity);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void dropTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(drop);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(testFactory, "/ast/sensors/arduino_drop_test.ino", "/ast/sensors/arduino_drop_test.xml", configuration);
    }
    ...
    public void pulseTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(pulse);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void potentiometerTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(potentiometer);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void moistureTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(moisture);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void ultrasonicTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(ultrasonic);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(
                testFactory,
    ...
    public void rfidTest() throws Exception {
        ...
        ConfigurationAst configuration = ArduTestHelper.mkConfigurationAst(rfid);
        UnitTestHelper
            .checkGeneratedSourceEqualityWithProgramXml(testFactory, "/ast/sensors/arduino_rfid_test.ino", "/ast/sensors/arduino_rfid_test.xml", configuration);
    }

    @Ignore // TODO: no configuration? incomplete
    @Test
