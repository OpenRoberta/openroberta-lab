...
public class FestoConfigCompTest extends AstTest {
    ...
    public void led_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=LED,isActor=true,userDefinedName=L,portName=null,componentProperties={INPUT=LED_BUILTIN}]]]";
    ...
    public void servo_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=SERVOMOTOR,isActor=true,userDefinedName=S,portName=null,componentProperties={PULSE=1}]]]";
