...
public class Helper {
     ...
     * @throws Exception
     */
    public static String generateString(String pathToProgramXml, ArduConfiguration brickConfiguration) throws Exception {
        final Jaxb2BlocklyProgramTransformer<Void> transformer = generateTransformer(pathToProgramXml);
        final String code = Ast2ArduVisitor.generate(brickConfiguration, transformer.getTree(), true);
