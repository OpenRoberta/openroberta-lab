...
public class MathOnListsTest {
    ...
    public void mathOnListSum() throws Exception {
        final String a = "rob.arrSum(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListMin() throws Exception {
        final String a = "rob.arrMin(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListMax() throws Exception {
        final String a = "rob.arrMax(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListAverage() throws Exception {
        final String a = "rob.arrMean(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListMedian() throws Exception {
        final String a = "rob.arrMedian(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListStandardDeviatioin() throws Exception {
        final String a = "rob.arrStandardDeviatioin(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListRandom() throws Exception {
        final String a = "rob.arrRand(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
    ...
    public void mathOnListMode() throws Exception {
        final String a = "rob.arrMode(sizeof(NUMBER,NumConst[5)/sizeof(NUMBER,NumConst[5[0]),{5,3,2})";
