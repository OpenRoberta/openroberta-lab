...
public class ArduinoConfigCompTest extends AstTest {
    ...
    public void analogin_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=ANALOG_INPUT,isActor=true,userDefinedName=A2,portName=null,componentProperties={INPUT=3}]]]";
    ...
    public void analogout_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=ANALOG_PIN,isActor=true,userDefinedName=S5,portName=null,componentProperties={OUTPUT=A0}]]]";
    ...
    public void buzzer_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=BUZZER,isActor=true,userDefinedName=S3,portName=null,componentProperties={+=5}]]]";
    ...
    public void digitalin_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=DIGITAL_INPUT,isActor=true,userDefinedName=A,portName=null,componentProperties={INPUT=0}]]]";
    ...
    public void digitalout_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=DIGITAL_PIN,isActor=true,userDefinedName=S4,portName=null,componentProperties={OUTPUT=0}]]]";
    ...
    public void gyro_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=GYRO,isActor=true,userDefinedName=K,portName=null,componentProperties={}]]]";
    ...
    public void humidity_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=HUMIDITY,isActor=true,userDefinedName=L5,portName=null,componentProperties={OUTPUT=2}]]]";
    ...
    public void infrared_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=INFRARED,isActor=true,userDefinedName=I,portName=null,componentProperties={OUTPUT=11}]]]";
    ...
    public void lcd_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=LCD,isActor=true,userDefinedName=L2,portName=null,componentProperties={RS=12,E=11,D4=5,D5=4,D6=3,D7=2}]]]";
    ...
    public void lcdi2c_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=LCDI2C,isActor=true,userDefinedName=L3,portName=null,componentProperties={}]]]";
    ...
    public void light_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=LIGHT,isActor=true,userDefinedName=L4,portName=null,componentProperties={OUTPUT=A0}]]]";
    ...
    public void motion_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=MOTION,isActor=true,userDefinedName=B,portName=null,componentProperties={OUTPUT=7}]]]";
    ...
    public void relay_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=RELAY,isActor=true,userDefinedName=R,portName=null,componentProperties={IN=6}]]]";
    ...
    public void rgbled_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=RGBLED,isActor=true,userDefinedName=R2,portName=null,componentProperties={RED=5,GREEN=6,BLUE=3}]]]";
    ...
    public void stepmotor_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=STEPMOTOR,isActor=true,userDefinedName=S2,portName=null,componentProperties={IN1=6,IN2=5,IN3=4,IN4=3}]]]";
    ...
    public void temperature_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult =
            "BlockAST [project=[ConfigurationComponent[componentType=TEMPERATURE,isActor=true,userDefinedName=T2,portName=null,componentProperties={OUTPUT=A0}]]]";
