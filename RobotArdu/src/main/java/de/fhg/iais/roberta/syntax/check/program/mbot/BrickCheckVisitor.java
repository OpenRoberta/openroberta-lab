package de.fhg.iais.roberta.syntax.check.program.mbot;
...
public class BrickCheckVisitor extends RobotBrickCheckVisitor implements MakeblockAstVisitor<Void> {
