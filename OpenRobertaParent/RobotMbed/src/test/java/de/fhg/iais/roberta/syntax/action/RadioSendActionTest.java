...
public class RadioSendActionTest {
    ...
    public void make_ByDefault_ReturnInstanceOfRadioSendActionClass() throws Exception {
        String expectedResult = "BlockAST [project=[[Location [x=63, y=38], " + "MainTask [], " + "RadioSendAction [ StringConst [Hallo], 0 ]]]]";
    ...
    public void make_MissingTextMessage_InstanceOfRadioSendActionMissingMessage() throws Exception {
        String expectedResult = "BlockAST [project=[[Location [x=63, y=38], MainTask [], RadioSendAction [ EmptyExpr [defVal=STRING], 0 ]]]]";
