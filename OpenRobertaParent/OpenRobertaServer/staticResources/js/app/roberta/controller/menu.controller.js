define([ 'exports', 'log', 'util', 'message', 'comm', 'robot.controller', 'socket.controller', 'user.controller', 'user.model', 'guiState.controller',
        ...
        'tour.controller', 'simulation.simulation','progList.model','multSim.controller', 'jquery', 'blocks', 'slick' ], function(exports, LOG, UTIL, MSG, COMM, ROBOT_C, SOCKET_C, USER_C, USER,
        GUISTATE_C, CookieDisclaimer, PROGRAM_C,PROGRAM_M,  RUN_C, CONFIGURATION_C, IMPORT_C, EnjoyHint, TOUR_C,PROGLIST, SIM, MULT_SIM, $, Blockly) { 
