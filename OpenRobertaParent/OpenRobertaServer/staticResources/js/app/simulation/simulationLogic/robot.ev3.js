define([ 'simulation.simulation', 'robertaLogic.constants', 'simulation.robot' ], function(SIM, CONSTANTS, Robot) {
    ...
    Ev3.prototype.encoder = {
        left : 0,
        right : 0
    };
    Ev3.prototype.colorSensor = {
        x : 0,
        y : -15,
        rx : 0,
        ry : 0,
    ...
    Ev3.prototype.gyroSensor = {
        value : 0,
        color : '#000'
    };
    Ev3.prototype.display = {
    ...
    Ev3.prototype.backMiddle = {
        x : 0,
        y : 30,
        rx : 0,
        ry : 0
    };
    Ev3.prototype.svg = '<svg xmlns="http://www.w3.org/2000/svg" width="313" height="482" viewBox="0 0 313 482">'
