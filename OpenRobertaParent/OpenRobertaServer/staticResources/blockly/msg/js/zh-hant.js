...
Blockly.Msg.ACCELEROMETER_ROTATION_TOOLTIP = "獲取傾斜或旋轉角度";
...
Blockly.Msg.BATTERY_GETSAMPLE_TOOLTIP = "獲取當前電池電壓";
...
Blockly.Msg.COLOUR_GETSAMPLE_TOOLTIP = "從顏色感應器獲取當前讀數。";
...
Blockly.Msg.COMPASS_GETSAMPLE_TOOLTIP = "從羅盤感應器獲取當前讀數。";
...
Blockly.Msg.CONFIGURATION_ERROR_SENSOR_WRONG = "已將錯誤感應器連接到給定埠!";
...
Blockly.Msg.DISPLAY_GET_BRIGHTNESS_TOOLTIP = "返回顯示的所有指示燈的亮度。0表示所有指示燈都關閉, 9 是最亮的值。";
Blockly.Msg.DISPLAY_GET_PIXEL_TOOLTIP = "返回此指示燈的亮度。0表示指示燈已關閉, 9 是最亮的值。";
...
Blockly.Msg.DISPLAY_SET_BRIGHTNESS_TOOLTIP = "設置顯示器所有指示燈的亮度。0表示所有指示燈都關閉, 9 是最亮的值。";
Blockly.Msg.DISPLAY_SET_PIXEL_TOOLTIP = "設置此led燈的亮度。0表示led燈已關閉, 9 是最亮的值。使用 x 和 y, 您可以確定要更改的 led 位置。";
...
Blockly.Msg.ENCODER_GETSAMPLE_TOOLTIP = "從電機編碼器獲取當前讀數。";
...
Blockly.Msg.FLAME_GETSAMPLE_TOOLTIP = "獲取來自火焰感應器的當前讀數。";
Blockly.Msg.FLAME_TOOLTIP = "表示火焰感應器。";
Blockly.Msg.FLYOUT_VARIABLE_TEXT = "你需要一個變數？請首先聲明它與點擊 + 在» start« 方塊 標誌。";
Blockly.Msg.FOR = "為";
...
Blockly.Msg.GYRO_GETSAMPLE_TOOLTIP = "從陀螺感應器獲取當前讀數。";
...
Blockly.Msg.INFRARED_DISTANCE_GETSAMPLE_TOOLTIP = "獲取紅外感應器的當前相對距離。值介於1和75釐米之間。";
Blockly.Msg.INFRARED_GETSAMPLE_TOOLTIP = "從紅外線感應器獲取當前讀數。";
Blockly.Msg.INFRARED_PRESENCE_GETSAMPLE_TOOLTIP = "返回一組信標存在的測量。";
...
Blockly.Msg.KEY_ISPRESSED_TOOLTIP = "所選按鈕是否按下？";
...
Blockly.Msg.LED_OFF = "關閉指示燈";
Blockly.Msg.LED_OFF_TOOLTIP = "關閉指示燈。";
Blockly.Msg.LED_ON = "打開指示燈";
Blockly.Msg.LED_ON_TOOLTIP = "打開指示燈並更改顏色。";
Blockly.Msg.LED_ON_WHITE_TOOLTIP = "打開指示燈。小心點, 很亮!";
...
Blockly.Msg.LIGHT_GETSAMPLE_TOOLTIP = "從光感應器獲取當前讀數。";
...
Blockly.Msg.MENU_RIGHT_INFO_TOOLTIP = "打開/關閉資訊視圖";
...
Blockly.Msg.MESSAGE_EDIT_START = "您的程式»$«將運行一會兒!";
...
Blockly.Msg.MICROPHONE_GETSAMPLE_TOOLTIP = "從麥克風中獲取當前讀取百分比 (映射到 0-100)。因為硬體上缺少放大, 如果值始終較低, 則該值必須乘以 10。";
Blockly.Msg.MODE = "模式";
...
Blockly.Msg.MOTOR_OTHER = "其他電源消費者";
...
Blockly.Msg.NAO_APPLYPOSTURE = "應用姿勢";
Blockly.Msg.NAO_APPLYPOSTURE_TOOLTIP = "機器人進入選擇的姿勢。使用下拉式功能表選擇不同的立姿, 坐臥位置。";
Blockly.Msg.NAO_AUTONOMOUS = "自主生命";
Blockly.Msg.NAO_AUTONOMOUS_TOOLTIP = "打開或關閉機器人的自主生命。當它被打開時, 機器人會對聲音作出反應, 並嘗試檢測面孔。如果這種行為打斷了你的程式就關掉它。";
Blockly.Msg.NAO_BLINK = "閃燈";
Blockly.Msg.NAO_CAMERA = "相機";
Blockly.Msg.NAO_CAMERA_BOTTOM = "底部";
Blockly.Msg.NAO_CAMERA_TOP = "頂部";
Blockly.Msg.NAO_FACE_GET_INFORMATION_TOOLTIP = "此塊將在1維陣列的格式中用以下值返回有關給定臉孔識別的其他資訊: [XAngle、YAngle、XSize、YSize、標題], 請注意, 所有值都以相機角度提供。";
...
Blockly.Msg.NAO_LED_TOOLTIP = "設置一組LED燈的顏色。";
Blockly.Msg.NAO_LOOKAT = "看";
Blockly.Msg.NAO_MARK_GET_INFORMATION_TOOLTIP = "此方塊將返回有關1維陣列上格式的給定NAO標記的附加資訊, 其值如下: [XAngle、YAngle、XSize、YSize、標題], 請注意所有值都以相機角度提供。";
...
Blockly.Msg.NAO_RECOGNIZEWORD = "從清單中識別單詞";
...
Blockly.Msg.NAO_SETINTENSITY_TOOLTIP = "將一組LED燈的強度設置為從0到100的範圍。";
...
Blockly.Msg.NAO_TOUCHSENSOR_TOOLTIP = "如果機器人上所選的觸摸感應器被觸碰, 則為 true。";
...
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_COMPILE_FAILED = "程式無法轉換為機器代碼。";
...
Blockly.Msg.ORA_ROBOT_PUSH_RUN = "機器人等待著現在jar被推送到機器人";
...
Blockly.Msg.PIN_ISTOUCHED_TOOLTIP = "所選引腳是否被觸動？";
...
Blockly.Msg.PLAY_TONE_TOOLTIP = "播放音調。";
...
Blockly.Msg.POPUP_ABOUT_TEXT_DEV = "Open Roberta實驗室是一個開放源碼程式設計平臺, 由弗勞恩 IAIS 在主動<a href=\"http://www.roberta-home.de/\" target=\"_blank\">»Roberta-學習機器人«</a>";
...
Blockly.Msg.SENSOR_BATTERY = "電壓 V";
...
Blockly.Msg.SENSOR_GESTURE_UP = "直立";
...
Blockly.Msg.SENSOR_TOUCH = "觸摸感應器";
...
Blockly.Msg.SIM_CONFIGURATION_WARNING_SENSOR_MISSING = "此感應器不在配置中!程式的行為在真正的機器人將是不同的預期!";
Blockly.Msg.SIM_CONFIGURATION_WARNING_WRONG_INFRARED_SENSOR_PORT = "紅外感應器未在配置中連接!該程式的行為在真正的機器人將是不同的預期, 請檢查機器人配置!";
Blockly.Msg.SIM_CONFIGURATION_WARNING_WRONG_SENSOR_PORT = "在這個方塊你使用了一個錯誤的感應器埠!該程式的行為在真正的機器人將是不同的預期, 請檢查機器人配置!";
...
Blockly.Msg.SOUND_GETSAMPLE_TOOLTIP = "從聲音感應器獲取當前讀數。";
...
Blockly.Msg.TEMPERATURE_GETSAMPLE_TOOLTIP = "從溫度感應器獲取當前讀數。";
...
Blockly.Msg.TIMER_GETSAMPLE_TOOLTIP = "從計時器獲取當前讀取。";
Blockly.Msg.TIMER_RESET_TOOLTIP = "重置計時器。";
Blockly.Msg.TODAY = "今天";
Blockly.Msg.TOOLBOX_ACTION = "行動";
...
Blockly.Msg.TOUCH_ISPRESSED_TOOLTIP = "觸控感應器是否按下？";
...
Blockly.Msg.ULTRASONIC_GETSAMPLE_TOOLTIP = "獲取超聲波感應器的當前釐米讀數。最大測量距離為255釐米。";
