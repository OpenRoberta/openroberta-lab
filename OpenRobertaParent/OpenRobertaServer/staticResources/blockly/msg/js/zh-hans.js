...
Blockly.Msg.ACCELEROMETER_ROTATION_TOOLTIP = "获取倾斜或旋转角度";
...
Blockly.Msg.BATTERY_GETSAMPLE_TOOLTIP = "获取当前电池电压";
...
Blockly.Msg.COLOUR_GETSAMPLE_TOOLTIP = "从颜色传感器获取当前读数。";
...
Blockly.Msg.COMPASS_GETSAMPLE_TOOLTIP = "从罗盘传感器获取当前读数。";
...
Blockly.Msg.DISPLAY_GET_BRIGHTNESS_TOOLTIP = "返回显示的所有指示灯的亮度。0表示所有指示灯都关闭, 9 是最亮的值。";
Blockly.Msg.DISPLAY_GET_PIXEL_TOOLTIP = "返回此指示灯的亮度。0表示指示灯已关闭, 9 是最亮的值。";
...
Blockly.Msg.DISPLAY_SET_BRIGHTNESS_TOOLTIP = "设置显示器所有指示灯的亮度。0表示所有指示灯都关闭, 9 是最亮的值。";
Blockly.Msg.DISPLAY_SET_PIXEL_TOOLTIP = "设置此led灯的亮度。0表示led灯已关闭, 9 是最亮的值。使用 x 和 y, 您可以确定要更改的 led 位置。";
...
Blockly.Msg.ENCODER_GETSAMPLE_TOOLTIP = "从电机编码器获取当前读数。";
...
Blockly.Msg.FLAME_GETSAMPLE_TOOLTIP = "获取来自火焰传感器的当前读数。";
Blockly.Msg.FLAME_TOOLTIP = "表示火焰传感器。";
Blockly.Msg.FLYOUT_VARIABLE_TEXT = "你需要一个变量？请首先声明它与点击 + 在» start« 方块 标志。";
Blockly.Msg.FOR = "为";
...
Blockly.Msg.GYRO_GETSAMPLE_TOOLTIP = "从陀螺传感器获取当前读数。";
...
Blockly.Msg.INFRARED_DISTANCE_GETSAMPLE_TOOLTIP = "获取红外传感器的当前相对距离。值介于1和75厘米之间。";
Blockly.Msg.INFRARED_GETSAMPLE_TOOLTIP = "从红外线传感器获取当前读数。";
Blockly.Msg.INFRARED_PRESENCE_GETSAMPLE_TOOLTIP = "返回一组信标存在的测量。";
...
Blockly.Msg.KEY_ISPRESSED_TOOLTIP = "所选按钮是否按下？";
...
Blockly.Msg.LED_OFF = "关闭指示灯";
Blockly.Msg.LED_OFF_TOOLTIP = "关闭指示灯。";
Blockly.Msg.LED_ON = "打开指示灯";
Blockly.Msg.LED_ON_TOOLTIP = "打开指示灯并更改颜色。";
Blockly.Msg.LED_ON_WHITE_TOOLTIP = "打开指示灯。小心点, 很亮!";
...
Blockly.Msg.LIGHT_GETSAMPLE_TOOLTIP = "从光传感器获取当前读数。";
...
Blockly.Msg.MESSAGE_EDIT_START = "您的程序»$«将运行一会儿!";
...
Blockly.Msg.MICROPHONE_GETSAMPLE_TOOLTIP = "从麦克风中获取当前读取百分比 (映射到 0-100)。因为硬件上缺少放大, 如果值始终较低, 则该值必须乘以 10。";
Blockly.Msg.MODE = "模式";
...
Blockly.Msg.NAO_APPLYPOSTURE = "应用姿势";
Blockly.Msg.NAO_APPLYPOSTURE_TOOLTIP = "机器人进入选择的姿势。使用下拉菜单选择不同的立姿, 坐卧位置。";
Blockly.Msg.NAO_AUTONOMOUS = "自主生命";
Blockly.Msg.NAO_AUTONOMOUS_TOOLTIP = "打开或关闭机器人的自主生命。当它被打开时, 机器人会对声音作出反应, 并尝试检测面孔。如果这种行为打断了你的程序就关掉它。";
Blockly.Msg.NAO_BLINK = "閃燈";
Blockly.Msg.NAO_CAMERA = "相机";
Blockly.Msg.NAO_CAMERA_BOTTOM = "底部";
Blockly.Msg.NAO_CAMERA_TOP = "顶部";
Blockly.Msg.NAO_FACE_GET_INFORMATION_TOOLTIP = "此方块将在1维数组的格式中用以下值返回有关给定面孔识别的其他信息: [XAngle、YAngle、XSize、YSize、标题], 请注意, 所有值都以相机角度提供。";
...
Blockly.Msg.NAO_LED_TOOLTIP = "设置一组LED灯的颜色。";
Blockly.Msg.NAO_LOOKAT = "看";
Blockly.Msg.NAO_MARK_GET_INFORMATION_TOOLTIP = "此方块将返回有关1维阵列上格式的给定NAO标记的附加信息, 其值如下: [XAngle、YAngle、XSize、YSize、标题], 请注意所有值都以相机角度提供。";
...
Blockly.Msg.NAO_RECOGNIZEWORD = "从列表中识别单词";
...
Blockly.Msg.NAO_SETINTENSITY_TOOLTIP = "将一组LED灯的强度设置为从0到100的范围。";
...
Blockly.Msg.ORA_COMPILERWORKFLOW_ERROR_PROGRAM_COMPILE_FAILED = "程序无法转换为机器代码。";
...
Blockly.Msg.ORA_ROBOT_PUSH_RUN = "机器人等待着现在jar被送推到机器人";
...
Blockly.Msg.PIN_ISTOUCHED_TOOLTIP = "所选引脚是否被触摸？";
...
Blockly.Msg.PLAY_TONE_TOOLTIP = "播放音调。";
...
Blockly.Msg.POPUP_ABOUT_TEXT_DEV = "Open Roberta实验室是一个开源的编程平台, 由Fraunhofer IAIS开发<a href=\"http://www.roberta-home.de/\" target=\"_blank\">»Roberta-学习机器人«</a>";
...
Blockly.Msg.SENSOR_BATTERY = "电压 V";
...
Blockly.Msg.SENSOR_GESTURE_DOWN = "颠倒";
...
Blockly.Msg.SENSOR_GESTURE_FACE_UP = "在后面";
...
Blockly.Msg.SENSOR_GESTURE_SHAKE = "摇晃";
...
Blockly.Msg.SIM_CONFIGURATION_WARNING_SENSOR_MISSING = "这个传感器没有配置!程序的行为在真正的机器人将和预期的不同!";
Blockly.Msg.SIM_CONFIGURATION_WARNING_WRONG_INFRARED_SENSOR_PORT = "红外传感器未在配置中连接!该程序的行为在真正的机器人将是不同的预期, 请检查机器人配置!";
Blockly.Msg.SIM_CONFIGURATION_WARNING_WRONG_SENSOR_PORT = "在这个方块你使用了一个错误的传感器端口!该程序的行为在真正的机器人将是不同的预期, 请检查机器人配置!";
...
Blockly.Msg.SOUND_GETSAMPLE_TOOLTIP = "从声音传感器获取数据。";
...
Blockly.Msg.TEMPERATURE_GETSAMPLE_TOOLTIP = "从温度传感器获取当前读数。";
...
Blockly.Msg.TIMER_GETSAMPLE_TOOLTIP = "从计时器获取当前读取。";
Blockly.Msg.TIMER_RESET_TOOLTIP = "重置计时器。";
Blockly.Msg.TODAY = "今天";
Blockly.Msg.TOOLBOX_ACTION = "行动";
...
Blockly.Msg.TOUCH_ISPRESSED_TOOLTIP = "触摸传感器是否按下？";
...
Blockly.Msg.ULTRASONIC_GETSAMPLE_TOOLTIP = "获取超声波传感器的当前厘米读数。最大测量距离为255厘米。";
