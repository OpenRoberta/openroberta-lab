...
/**
 * This class represents the <b>naoSensors_getFaceInformation</b> blocks from Blockly into the AST (abstract syntax tree).
...
public final class DetectedFaceInformation<V> extends Sensor<V> {
    ...
    static <V> DetectedFaceInformation<V> make(Expr<V> savedFace, BlocklyBlockProperties properties, BlocklyComment comment) {
        return new DetectedFaceInformation<V>(savedFace, properties, comment);
    }
