...
public abstract class AbstractArduinoVisitor extends AbstractCppVisitor {
    ...
    protected AbstractArduinoVisitor(ArrayList<ArrayList<Phrase<Void>>> programPhrases, int indentation) {
