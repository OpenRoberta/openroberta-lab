...
public class MathTest {
    ...
    public void reverseTransformatinArithmetic() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_arithmetic.xml");
    }
    ...
    public void mathSingle() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_single.xml"));
    }

    @Test
    public void reverseTransformatinSingle() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_single.xml");
    }
    ...
    public void reverseTransformatinSingle1() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_single1.xml");
    }
    ...
    public void mathSingle2() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_single2.xml"));
    }

    @Test
    public void reverseTransformatinSingle2() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_single2.xml");
    }
    ...
    public void mathSingle3() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_single3.xml"));
    }

    @Test
    public void reverseTransformatinSingle3() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_single3.xml");
    }
    ...
    public void mathTrig() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_trig.xml"));
    }

    @Test
    public void reverseTransformatinTrig() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_trig.xml");
    }
    ...
    public void mathTrig1() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_trig1.xml"));
    }

    @Test
    public void reverseTransformatinTrig1() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_trig1.xml");
    }
    ...
    public void mathConstant() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_constant.xml"));
    }
    ...
    public void mathConstant4() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_constant4.xml"));
    }

    @Test
    public void reverseTransformatinConstant4() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_constant4.xml");
    }
    ...
    public void mathNumberProperty() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_number_property.xml"));
    }

    @Test
    public void reverseTransformatinNumberProperty() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_number_property.xml");
    }
    ...
    public void mathNumberProperty1() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_number_property1.xml"));
    }

    @Test
    public void reverseTransformatinNumberProperty1() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_number_property1.xml");
    }
    ...
    public void mathNumberProperty2() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_number_property2.xml"));
    }

    @Test
    public void reverseTransformatinNumberProperty2() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_number_property2.xml");
    }
    ...
    public void mathChange() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_change.xml"));
    }

    @Ignore
    public void reverseTransformationMathChange() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_change.xml");
    }
    ...
    public void mathRound() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_round.xml"));
    }

    @Test
    public void reverseTransformationMathRound() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_round.xml");
    }
    ...
    public void mathRound1() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_round1.xml"));
    }

    @Test
    public void reverseTransformationMathRound1() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_round1.xml");
    }
    ...
    public void math_on_list() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_on_list.xml"));
    }

    @Test
    public void reverseTransformationMathOnList() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_on_list.xml");
    }
    ...
    public void math_on_constrain() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_constrain.xml"));
    }

    @Test
    public void reverseTransformationMathOnConstrain() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_constrain.xml");
    }
    ...
    public void math_random_float() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_random_float.xml"));
    }

    @Test
    public void reverseTransformationMathRandomFloat() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_random_float.xml");
    }
    ...
    public void math_modulo() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_modulo.xml"));
    }

    @Test
    public void reverseTransformationMathModulo() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_modulo.xml");
    }
    ...
    public void math_random_integer() throws Exception {
        ...
        Assert.assertEquals(a, this.h.generateTransformerString("/ast/math/math_random_integer.xml"));
    }

    @Test
    public void reverseTransformationRandomInteger() throws Exception {
        this.h.assertTransformationIsOk("/ast/math/math_random_integer.xml");
    }
}
