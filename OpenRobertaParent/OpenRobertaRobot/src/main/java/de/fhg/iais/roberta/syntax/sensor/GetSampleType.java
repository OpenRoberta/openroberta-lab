...
public enum GetSampleType {
    ...
    GYRO_X( "SENSORPORT", "GYRO", "X", "SLOT" ),
    GYRO_Y( "SENSORPORT", "GYRO", "Y", "SLOT" ),
    ...
    INFRARED_LINE( "SENSORPORT", "INFRARED", "LINE", "SLOT" ),
    COMPASS_ANGLE( "SENSORPORT", "COMPASS", "ANGLE", "SLOT" ),
    COMPASS_COMPASS( "SENSORPORT", "COMPASS", "COMPASS", "SLOT" ),
    INFRARED_SEEK( "SENSORPORT", "INFRARED", "SEEK", "SLOT" ),
    IRSEEKER_MODULATED( "SENSORPORT", "IRSEEKER", "MODULATED", "SLOT" ),
    IRSEEKER_UNMODULATED( "SENSORPORT", "IRSEEKER", "UNMODULATED", "SLOT" ),
    ...
    PIN_PULSELOW( "SENSORPORT", "PIN_PULSELOW", "PULSELOW", "SLOT" ),
    TEMPERATURE_VALUE( "SENSORPORT", "TEMPERATURE", "TEMPERATURE", "SLOT" ),
    ACCELEROMETER_VALUE( "SENSORPORT", "ACCELERATION", "DEFAULT", "SLOT" ),
    ACCELEROMETER_X( "SENSORPORT", "ACCELERATION", "X", "SLOT" ),
    ACCELEROMETER_Y( "SENSORPORT", "ACCELERATION", "Y", "SLOT" ),
    ACCELEROMETER_Z( "SENSORPORT", "ACCELERATION", "Z", "SLOT" ),
    ...
    INFRARED_REFLEXION( "SENSORPORT", "LIGHT", "REFLEXION", "SLOT" ),
