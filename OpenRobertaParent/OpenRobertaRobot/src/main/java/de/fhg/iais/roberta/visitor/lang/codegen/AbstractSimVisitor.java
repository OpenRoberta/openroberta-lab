...
public abstract class AbstractSimVisitor<V> implements ILanguageVisitor<V> {
    ...
    protected AbstractSimVisitor(Configuration brickConfiguration) {
    ...
    private void appendStmtsInitialization(AbstractSimVisitor<V> astVisitor) {
    ...
    private void appendMethodsInitialization(AbstractSimVisitor<V> astVisitor) {
    ...
    private void appendProgramInitialization(AbstractSimVisitor<V> astVisitor) {
