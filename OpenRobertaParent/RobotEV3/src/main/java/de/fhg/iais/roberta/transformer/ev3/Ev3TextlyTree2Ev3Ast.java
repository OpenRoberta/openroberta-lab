...
@Deprecated
public class Ev3TextlyTree2Ev3Ast extends TextlyBaseVisitor<Phrase<Void>> {
    /**
    ...
    public static Phrase<Void> startWalkForVisiting(String stmt) throws Exception {
        ...
        new Ev3TextlyTree2Ev3Ast().visit(tree);
        Ev3TextlyTree2Ev3Ast visitor = new Ev3TextlyTree2Ev3Ast();
