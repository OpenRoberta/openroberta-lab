...
public class BrickCheckVisitor extends RobotBrickCheckVisitor {
    ...
    public Void visitCompassSensor(CompassSensor<Void> compassSensor) {
        ...
        if ( this.brickConfiguration.getRobotName().equals("wedo") && compassSensor.getMode() == CompassSensorMode.CALIBRATE ) {
    ...
    public Void visitSayTextAction(SayTextAction<Void> sayTextAction) {
        ...
        if ( this.brickConfiguration.getRobotName().equals("wedo") ) {
