...
public class WeDoConfiguration extends Configuration {
    ...
    public WeDoConfiguration(Map<IActorPort, Actor> actors, Map<ISensorPort, Sensor> sensors, double wheelDiameterCM, double trackWidthCM) {
    ...
    public String generateText(String name) {
        ...
        sb.append("robot wedo ").append(name).append(" {\n");
    ...
    public static class Builder extends Configuration.Builder<Builder> {
        ...
        public Configuration build() {
            return new WeDoConfiguration(this.actorMapping, this.sensorMapping, this.wheelDiameter, this.trackWidth);
        }
