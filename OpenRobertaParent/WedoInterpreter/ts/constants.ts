...
export const ARRAY_BOOLEAN: string = "Array_Boolean";
export const ARRAY_COLOR: string = "Array_Colour";
export const ARRAY_IMAGE: string = "Array_Image";
export const ARRAY_NUMBER: string = "Array_Number";
export const ARRAY_STRING: string = "Array_String";
...
export const BOOL_CONST: string = "BoolConst";
