...
public abstract class Aktion extends Phrase {
    /**
     * returns the aktion if and only if it is an object of the class given as parameter. Otherwise an exception is thrown. The type of the returned
     * aktion is
    ...
    /**
     * @return the kind of the aktion. See enum {@link Kind} for all kinds possible<br>
     */
    abstract public Kind getKind();

    /**
     * append a nice, dense and human-readable representation of an aktion for <b>debugging and testing purposes</b>
     * 
    ...
    /**
     * define the different kinds of aktions. If a new subclass of {@link #Aktion} is created, this enum has to be extended. The new enum value has be
     * the return value of the method {@link Aktion#getKind()} of the new class.
     */
    public static enum Kind {
        TurnAktion( TurnAktion.class ), DriveAktion( DriveAktion.class ), ShowAktion( ShowAktion.class ), ToneAktion( ToneAktion.class ), LightAktion(
            LightAktion.class );
