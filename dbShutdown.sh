...
echo 'If not, you have to supply the full uri of the database:'
echo '  - server mode (probably never needed, because this is the default: "jdbc:hsqldb:hsql://localhost/openroberta-db"'
