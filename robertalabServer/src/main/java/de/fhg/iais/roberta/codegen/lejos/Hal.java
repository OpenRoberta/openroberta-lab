...
//     *        in cm
//     */
//    public void driveDistance(ActorPort actorPort1, ActorPort actorPort2, DriveAction.Direction direction, int speedPercent, int distance) {
//        DifferentialPilot dPilot =
//            new DifferentialPilot(
//                this.brickConfiguration.getWheelDiameter(),
//                this.brickConfiguration.getTrackWidth(),
...
//     * @param speedPercent
//     */
//    public void rotateDirection(ActorPort actorPort1, ActorPort actorPort2, TurnAction.Direction direction, int speedPercent) {
//        if ( isRegulated(actorPort1) && isRegulated(actorPort2) ) {
//            DifferentialPilot dPilot =
//                new DifferentialPilot(
//                    this.brickConfiguration.getWheelDiameter(),
...
//     * @param distance
//     */
//    public void rotateDirectionDistance(ActorPort actorPort1, ActorPort actorPort2, TurnAction.Direction direction, int speedPercent, int distance) {
//        // TODO
...
//     * @param angle
//     */
//    public void rotateDirectionAngle(ActorPort actorPort1, ActorPort actorPort2, TurnAction.Direction direction, int speedPercent, int angle) {
//        DifferentialPilot dPilot =
//            new DifferentialPilot(
//                this.brickConfiguration.getWheelDiameter(),
//                this.brickConfiguration.getTrackWidth(),
...
//     * @return
//     */
//    public int getTimerValue(TimerSensor.Mode timer) {
//        return 0;
//    }
//
//    /**
