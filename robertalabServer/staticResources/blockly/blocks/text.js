...
Blockly.Blocks['text_join'] = {
  ...
  domToMutation: function(xmlElement) {
    ...
    if (this.itemCount_ == 0) {
      this.appendDummyInput('EMPTY').appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'media/quote0.png', 12, 12, '"'))
          .appendField(new Blockly.FieldImage(Blockly.pathToBlockly + 'media/quote1.png', 12, 12, '"'));
    }
  },
  /**
...
Blockly.Blocks['text_append'] = {
  ...
  /**
   * Notification that a variable is renaming. If the name matches one of this block's variables, rename it.
   * 
...
Blockly.Blocks['text_getSubstring'] = {
   ...
   */
  init: function() {
    this.WHERE_OPTIONS_1 = [ [ Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START, 'FROM_START' ], [ Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END, 'FROM_END' ],
