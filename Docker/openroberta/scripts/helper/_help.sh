...
echo "       show-resources <server> [<file> [<lower> [<upper> [ <url> [<hours> [<pid>]]]]]"
echo "                                                                     show resource usage. Parameter description is in file helper/_showResources.sh"
...
echo "       gen-base <arch> <ccbin-version> <oraccrsc-tag> <base-version> <ora-cc-rsc>"
echo "                                                                     generate a new base image. <arch> should be 'x64',"
