...
public class DBusDaemon extends Thread
{
   ...
   {
      public NativeDomainSocket usock;
      public Socket tsock;
      public MessageReader min;
      public MessageWriter mout;
      public String unique;
      public Connstruct(NativeDomainSocket sock)
      {
         this.usock = sock;
   ...
   public void addSock(NativeDomainSocket us)
   {
      if (Debug.debug) Debug.print(Debug.DEBUG, "enter");
   ...
   {
      if (Debug.debug) Debug.print(Debug.DEBUG, "enter");
      NativeDomainSocket uss;
      if (null != address. getParameter("abstract"))
         uss = new NativeDomainSocket(new NativeDomainSocket.SockAddr(address.getParameter("abstract"), true)); 
      else
         uss = new NativeDomainSocket(new NativeDomainSocket.SockAddr(address.getParameter("path"), false)); 
      ...
      while (d._run) {
    	  NativeDomainSocket s = uss.accept();
