...
public enum HardwareComponentOld {
    ...
    private HardwareComponentOld(Category category, String... attributes) {
    ...
    public static HardwareComponentOld attributesMatch(String... attributes) {
        for ( HardwareComponentOld hardwareComponent : HardwareComponentOld.values() ) {
