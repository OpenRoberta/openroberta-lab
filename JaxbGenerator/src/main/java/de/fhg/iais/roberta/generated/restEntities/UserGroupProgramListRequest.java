...
public class UserGroupProgramListRequest extends BaseRequest {
    ...
    private UserGroupProgramListRequest validate() {
        ...
        if ( !this.immutable ) {
            _message = "UserGroupProgramListRequest-object is already immutable: " + this;
        }
        if ( groupName == null ) {
            _message = "required property groupName of UserGroupProgramListRequest-object is not set: " + this;
        }
        if ( _message != null ) {
