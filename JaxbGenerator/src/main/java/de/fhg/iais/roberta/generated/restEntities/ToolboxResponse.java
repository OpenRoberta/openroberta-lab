...
/**
 * the response for the /toolbox REST request<br><br>
 * Version: 1<br>
 * Datum: 2020-06-15
 */
public class ToolboxResponse extends BaseResponse {
    protected String data;
    
    /**
     * the response for the /toolbox REST request
     */
    public static ToolboxResponse make() {
        return new ToolboxResponse();
    }
    
    /**
     * the response for the /toolbox REST request
     */
    public static ToolboxResponse makeFromString(String jsonS) {
        try {
     ...
     * the response for the /toolbox REST request
     */
    public static ToolboxResponse makeFromProperties(String cmd,String rc,String message,String cause,JSONObject parameters,String initToken,long serverTime,String serverVersion,long robotWait,String robotBattery,String robotName,String robotVersion,String robotFirmwareName,JSONObject robotSensorvalues,int robotNepoexitvalue,String robotState,String data) {
        ToolboxResponse entity = new ToolboxResponse();
        entity.setCmd(cmd);
        entity.setRc(rc);
     ...
     * the response for the /toolbox REST request
     */
    public static ToolboxResponse make(JSONObject jsonO) {
     ...
     */
    public ToolboxResponse merge(JSONObject jsonO) {
        try {
     ...
     * Throws a runtime exception if inconsistencies are detected.
     */
    public ToolboxResponse immutable() {
        if (this.immutable) {
            return this;
        }
        this.immutable = true;
     ...
     * Throws a runtime exception if inconsistencies are detected.
     */
    private ToolboxResponse validate() {
        String _message = null;
        if ( !this.immutable ) {
            _message = "ToolboxResponse-object is already immutable: " + toString();
        }
        if ( rc == null) {
            _message = "required property rc of ToolboxResponse-object is not set: " + toString();
        }
        if ( initToken == null) {
            _message = "required property initToken of ToolboxResponse-object is not set: " + toString();
        }
        if ( !serverTimeDefined) {
            _message = "required property serverTime of ToolboxResponse-object is not set: " + toString();
        }
        if ( serverVersion == null) {
            _message = "required property serverVersion of ToolboxResponse-object is not set: " + toString();
        }
        if ( data == null) {
            _message = "required property data of ToolboxResponse-object is not set: " + toString();
        }
        if ( _message != null ) {
     ...
     */
    public ToolboxResponse setData(String data) {
        if (this.immutable) {
