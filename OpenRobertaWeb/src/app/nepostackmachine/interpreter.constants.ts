...
export const BUTTON_LED_ACTION: string = "buttonLedAction";
...
export const CLOSING: string = "closing";
...
export const INDUCTIVE: string = "inductive";
...
export const LED_ACTION: string = "ledAction";
export const RGBLED_ON_ACTION: string = "rgbLedOnAction";
export const RGBLED_OFF_ACTION: string = "rgbLedOffAction";
...
export const NEURAL_NETWORK: string = "neuralNetwork";
export const NN_INPUT_NEURONS: string = "inputs";
export const NN_OUTPUT_NEURONS: string = "outputs";
export const NN_WEIGHTS: string = "weights";
export const NN_BIASES: string = "biases";
export const NN_NETWORK_SHAPE: string = "networkShape";
export const NN_LEARNING_RATE: string = "learningRate";
export const NN_REGULARIZATION_RATE: string = "regularizationRate";
export const NN_NOISE: string = "noise";
export const NN_BATCH_SIZE: string = "batchSize";
export const NN_DISCRETIZE: string = "discretize";
export const NN_PERCENT_TRAIN_DATA: string = "percTrainData";
export const NN_ACTIVATION_KEY: string = "activationKey";
export const NN_NUMBER_HIDDEN_LAYERS: string = "numHiddenLayers";
export const NN_STEP_STMT: string = "nnStepStmt";
export const NN_SETINPUTNEURON_STMT: string = "nnSetInputNeuronStmt";
export const NN_GETOUTPUTNEURON_VAL: string = "nnGetOutputNeuronVal";
export const NN_SETWEIGHT_STMT: string = "nnSetWeightStmt";
export const NN_SETBIAS_STMT: string = "nnSetBiasStmt";
export const NN_GETWEIGHT: string = "nnGetWeight";
export const NN_GETBIAS: string = "nnGetBias";
...
export const OPENING: string = "opening";
...
export const ODOMETRY: string = "odometry";
export const ODOMETRY_SENSOR_RESET: string = "createOdometryReset";
export const OMNI_DRIVE: string = "omniDrive";
export const OMNI_DRIVE_DIST: string = "omniDriveDist";
export const OMNI_DRIVE_STOP: string = "omniDriveStop";
export const OMNI_DRIVE_TURN: string = "omniDriveTurn";
export const OMNI_DRIVE_POSITION: string = "omniDrivePosition";
export const OPCODE: string = "opc";
export const OPTICAL: string = "optical";
...
export const PROXH_LED_ACTION: string = "proxHLedAction";
...
export const RETURN_ADDRESS: string = "returnAddress";
...
export const SOUND_LED_ACTION: string = "soundLedAction";
...
export const TEMPERATURE_LED_ACTION: string = "temperatureLedAction";
export const TERNARY: string = "ternary";
...
export const THETA: string = "theta";
