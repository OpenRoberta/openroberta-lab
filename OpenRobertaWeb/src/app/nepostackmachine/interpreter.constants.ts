...
export const ENC: number = 360.0 / (3.0 * Math.PI * 12);
...
export const MAXPOWER: number = 0.7037167544 * 3;

export const MAX_HEIGHT: number = 1000;
export const MAX_ROTATION: number = 1;
...
export const TURN_RATIO: number = (120 / 3.) / 12.;
...
export const WHEEL_DIAMETER: number = 12;
