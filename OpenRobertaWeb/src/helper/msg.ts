 ...
 */
function displayMessage(messageId: string | undefined, output: string, replaceWith: string | object, opt_cancel?: boolean, opt_robot?: string): void {
    let cancel: boolean = opt_cancel || false;
    let robot: string = '';
    if (opt_robot) {
