 ...
 */
function displayMessage(messageId: string | undefined, output: string, replaceWith: string | object, opt_cancel?: boolean | string, opt_robot?: string): void {
 ...
 */
function displayInformation(result: any, successMessage: string, messageParam: string | object, errorMessage?: string, opt_robot?: string): void {
    if (result.rc === 'ok') {
