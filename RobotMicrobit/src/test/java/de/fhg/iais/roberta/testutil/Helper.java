...
public class Helper {
    ...
    public static String generateStringWithoutWrapping(String pathToProgramXml) throws Exception {
        ...
        Configuration brickConfiguration = new MicrobitConfiguration.Builder().build();
    ...
    public static Configuration generateConfiguration(String blocklyXml) throws Exception {
        ...
        MicrobitFactory robotModeFactory = new MicrobitFactory(null);
        Jaxb2MicrobitConfigurationTransformer transformer = new Jaxb2MicrobitConfigurationTransformer(robotModeFactory);
