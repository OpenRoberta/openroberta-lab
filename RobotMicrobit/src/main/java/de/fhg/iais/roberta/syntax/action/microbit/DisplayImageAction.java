package de.fhg.iais.roberta.syntax.action.microbit;
...
import de.fhg.iais.roberta.mode.action.microbit.DisplayImageMode;
...
public class DisplayImageAction<V> extends Action<V> {
    ...
    protected V accept(AstVisitor<V> visitor) {
        return ((MicrobitAstVisitor<V>) visitor).visitDisplayImageAction(this);
    }
