...
public class RCJStackMachineVisitor extends AbstractStackMachineVisitor implements IRCJVisitor<Void> {
    ...
    public Void visitDisplayTextAction(DisplayTextAction displayTextAction) {
        //TODO displayTextAction.y.accept(this);
        //TODO displayTextAction.x.accept(this);
    ...
    public Void visitGyroSensor(GyroSensor gyroSensor) {
        ...
        JSONObject o;
        o = makeNode(C.GET_SAMPLE).put(C.GET_SAMPLE, C.GYRO).put(C.MODE, mode).put(C.PORT, port);
        return add(o);
    }
