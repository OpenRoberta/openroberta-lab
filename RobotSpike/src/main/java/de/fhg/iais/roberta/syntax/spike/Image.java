...
/**
 * This class represents the <b>image_image</b> block from Blockly into the AST (abstract syntax tree). Object from this class will generate an image.<br/>
 * The client must provide the value for every pixel of the display (5x5). <br>
 */
@NepoBasic(name = "IMAGE", category = "EXPR", blocklyNames = {"image_image"})
