...
then
  ...
  echo '-db-name <db-name>  the database name; default (ok for embedded db): openroberta-db; with a database server use openroberta-db-<server-name>'
