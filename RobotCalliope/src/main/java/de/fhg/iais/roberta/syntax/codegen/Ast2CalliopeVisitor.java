 ...
 */
public class Ast2CalliopeVisitor implements CalliopeAstVisitor<Void> {
    ...
    public Ast2CalliopeVisitor(CalliopeConfiguration brickConfiguration, int indentation) {
    ...
    public static String generate(CalliopeConfiguration brickConfiguration, ArrayList<ArrayList<Phrase<Void>>> phrasesSet, boolean withWrapping) //
    {
        ...
        final Ast2CalliopeVisitor astVisitor = new Ast2CalliopeVisitor(brickConfiguration, withWrapping ? 1 : 0);
        astVisitor.generatePrefix(withWrapping, phrasesSet);
        generateCodeFromPhrases(phrasesSet, withWrapping, astVisitor);
        return astVisitor.sb.toString();
    }

    private static void generateCodeFromPhrases(ArrayList<ArrayList<Phrase<Void>>> phrasesSet, boolean withWrapping, Ast2CalliopeVisitor astVisitor) {
    ...
    private static boolean handleMainBlocks(Ast2CalliopeVisitor astVisitor, boolean mainBlock, Phrase<Void> phrase) {
