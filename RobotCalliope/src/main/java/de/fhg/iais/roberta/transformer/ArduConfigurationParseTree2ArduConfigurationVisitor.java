...
public class ArduConfigurationParseTree2ArduConfigurationVisitor extends Ev3ConfigurationBaseVisitor<Void> {
    ...
    private final Configuration.Builder builder = new CalliopeConfiguration.Builder();
    ...
    public static Option<Configuration> startWalkForVisiting(String stmt, IRobotFactory factory) {
        ArduConfigurationParseTree2ArduConfigurationVisitor visitor = new ArduConfigurationParseTree2ArduConfigurationVisitor(factory);
    ...
    private ArduConfigurationParseTree2ArduConfigurationVisitor(IRobotFactory factory) {
        ...
        try {
            ...
            parser.addErrorListener(new BaseErrorListener() {
                ...
                public void syntaxError(
                    ...
                    if ( ArduConfigurationParseTree2ArduConfigurationVisitor.this.parseErrorMessage == null ) {
                        ArduConfigurationParseTree2ArduConfigurationVisitor.this.parseErrorMessage =
