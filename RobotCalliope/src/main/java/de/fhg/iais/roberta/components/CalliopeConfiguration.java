...
public class CalliopeConfiguration extends Configuration {
    ...
    public CalliopeConfiguration(Map<IActorPort, Actor> actors, Map<ISensorPort, Sensor> sensors, double wheelDiameterCM, double trackWidthCM) {
    ...
    public static class Builder extends Configuration.Builder<Builder> {
        ...
        public Configuration build() {
            return new CalliopeConfiguration(this.actorMapping, this.sensorMapping, this.wheelDiameter, this.trackWidth);
        }
