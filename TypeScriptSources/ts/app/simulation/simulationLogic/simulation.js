...
export { setBackground, getBackground, getObstacleList, getColorAreaList, initMicrophone, getDt, setPause, setStep, setInfo, resetPose, deleteSelectedObject, addObstacle, addColorArea, toggleColorPicker, stopProgram, init, run, getRobotIndex, getSelectedRobot, cancel, getScale, getGround, getInfo, importConfigData, exportConfigData, resetScene, importImage, getWebAudio, getDebugMode, updateDebugMode, interpreterAddEvent, endDebugging, getSimVariables };
