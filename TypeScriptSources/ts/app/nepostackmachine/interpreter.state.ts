...
export class State {
    ...
    private currentBlocks: string[]; //hash map current blocks being executed
    ...
    public evalTerminations(stmt) {
        stmt[C.HIGHTLIGHT_MINUS]
            ...
            .forEach(block => {
                ...
                this.currentBlocks = this.currentBlocks.filter(currentBlock => currentBlock !== block.id);
            });
    }
