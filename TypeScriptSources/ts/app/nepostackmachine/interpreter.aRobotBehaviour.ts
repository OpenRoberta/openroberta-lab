...
export abstract class ARobotBehaviour {
    ...
    abstract driveAction(name: string, direction: string, speed: number, distance: number): number;
    abstract curveAction(name: string, direction: string, speedL: number, speedR: number, distance: number): number;
