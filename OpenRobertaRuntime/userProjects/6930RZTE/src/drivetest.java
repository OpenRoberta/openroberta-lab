...
public class drivetest {
    ...
    public void run() {
        ...
        hal.driveDistance(ActorPort.B, ActorPort.C, false, DriveDirection.FOREWARD, 300, 50);
        hal.driveDistance(ActorPort.B, ActorPort.C, false, DriveDirection.FOREWARD, 200, 50);
        hal.driveDistance(ActorPort.B, ActorPort.C, false, DriveDirection.FOREWARD, 100, 50);
        try {
            Thread.sleep(2000);
