...
public class DrehSensor {
    ...
    public void run() {
        ...
        hal.driveDistance(ActorPort.A, ActorPort.B, false, DriveDirection.FOREWARD, 50, 205);
        hal.setMotorTachoMode(ActorPort.A, MotorTachoMode.ROTATION);
        hal.drawText(String.valueOf(hal.getMotorTachoMode(ActorPort.A)), 0, 0);
        hal.drawText(String.valueOf(hal.getRegulatedMotorTachoValue(ActorPort.A)), 0, 5);
        try {
            Thread.sleep(2000);
